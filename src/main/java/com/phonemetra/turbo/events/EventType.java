...
import com.phonemetra.turbo.spi.eventstorage.memory.MemoryEventStorageSpi;
 ...
 * {@link TurboSQLEvents#localListen(TurboSQLPredicate, int...)} method:
 * <ul>
 ...
 * by using either {@link TurboSQLConfiguration#getIncludeEventTypes()} method in TurboSQL configuration.
 * Note that certain events are required for TurboSQL's internal operations and such events will still be
 * generated but not stored by event storage SPI if they are disabled in TurboSQL configuration.
 */
public interface EventType {
     ...
     * a number of warnings in the log. In certain situations TurboSQL
     ...
     * <br>
     * TurboSQL detected that node has presumably crashed and is considered failed.
     * <p>
     * NOTE: all types in range <b>from 1 to 1000 are reserved</b> for
     * internal TurboSQL events and should not be used by user-defined events.
     *
     ...
     * {@link com.phonemetra.turbo.compute.ComputeTask#map(List, Object)} method.
     * <p>
     * NOTE: all types in range <b>from 1 to 1000 are reserved</b> for
     * internal TurboSQL events and should not be used by user-defined events.
     *
     ...
     * {@link com.phonemetra.turbo.compute.ComputeTask#result(com.phonemetra.turbo.compute.ComputeJobResult, List)} method.
     * <p>
     * NOTE: all types in range <b>from 1 to 1000 are reserved</b> for
     * internal TurboSQL events and should not be used by user-defined events.
     *
     ...
     * {@link TurboSQLEvents#localListen(TurboSQLPredicate, int...)} method to
    ...
    /**
     * All TurboSQL events (<b>including</b> metric update event).
     */
    public static final int[] EVTS_ALL = U.gridEvents();

    /**
     * All TurboSQL events (<b>excluding</b> metric update event).
     */
