...
import com.phonemetra.turbo.internal.jdbc.JdbcConnection;
import com.phonemetra.turbo.internal.jdbc.JdbcDriverPropertyInfo;

/**
 * JDBC driver implementation for In-Memory Data Grid.
 * <p>
 * Driver allows to get distributed data from TurboSQL cache using standard
 ...
 * Data in TurboSQL cache is usually distributed across several nodes,
 ...
 * JDBC driver is located in main TurboSQL JAR and depends on all libraries located in
 * {@code TURBOSQL_HOME/libs} folder. So if you are using JDBC driver in any external tool,
 * you have to add main TurboSQL JAR will all dependencies to its classpath.
 * <h1 class="header">Configuration</h1>
 *
 * JDBC driver can return two different types of connection: TurboSQL Java client based connection and
 * TurboSQL client node based connection. Java client best connection is deprecated and left only for
 * compatibility with previous version, so you should always use TurboSQL client node based mode.
 ...
 *
 * <h2 class="header">Configuration of TurboSQL client node based connection</h2>
 *
 * JDBC connection URL has the following pattern: {@code jdbc:turboSQL:cfg://[<params>@]<config_url>}.<br>
 *
 * {@code <config_url>} represents any valid URL which points to TurboSQL configuration file. It is required.<br>
 *
 ...
 *     </li>
 *     <li>
 *          {@code collocated} - flag that used for optimization purposes. Whenever TurboSQL executes
 ...
 *          together on the same node, usually based on some <b>affinity-key</b>, TurboSQL
 ...
 *         By default TurboSQL attempts to fetch the whole query result set to memory and send it to the client.
 ...
 *         OutOfMemoryError. Use this flag as a hint for TurboSQL to fetch result set lazily, thus minimizing memory
 ...
 * </ul>
 *
 * <h2 class="header">Configuration of TurboSQL Java client based connection</h2>
 *
 * All TurboSQL Java client configuration properties can be applied to JDBC connection of this type.
 * <p>
 * JDBC connection URL has the following pattern:
 * {@code jdbc:turboSQL://<hostname>:<port>/<cache_name>?nodeId=<UUID>}<br>
 * Note the following:
 * <ul>
 *     <li>Hostname is required.</li>
 *     <li>If port is not defined, {@code 11211} is used (default for TurboSQL client).</li>
 ...
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.protocol</b></td>
 *         <td>Communication protocol ({@code TCP} or {@code HTTP}).</td>
 *         <td>{@code TCP}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.connectTimeout</b></td>
 *         <td>Socket connection timeout.</td>
 *         <td>{@code 0} (infinite timeout)</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.tcp.noDelay</b></td>
 *         <td>Flag indicating whether TCP_NODELAY flag should be enabled for outgoing connections.</td>
 *         <td>{@code true}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.enabled</b></td>
 *         <td>Flag indicating that {@code SSL} is needed for connection.</td>
 *         <td>{@code false}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.protocol</b></td>
 *         <td>SSL protocol ({@code SSL} or {@code TLS}).</td>
 *         <td>{@code TLS}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.key.algorithm</b></td>
 *         <td>Key manager algorithm.</td>
 *         <td>{@code SunX509}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.keystore.location</b></td>
 *         <td>Key store to be used by client to connect with TurboSQL topology.</td>
 *         <td>&nbsp;</td>
 *         <td>No (if {@code SSL} is enabled)</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.keystore.password</b></td>
 *         <td>Key store password.</td>
 *         <td>&nbsp;</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.keystore.type</b></td>
 *         <td>Key store type.</td>
 *         <td>{@code jks}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.truststore.location</b></td>
 *         <td>Trust store to be used by client to connect with TurboSQL topology.</td>
 *         <td>&nbsp;</td>
 *         <td>No (if {@code SSL} is enabled)</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.truststore.password</b></td>
 *         <td>Trust store password.</td>
 *         <td>&nbsp;</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.ssl.truststore.type</b></td>
 *         <td>Trust store type.</td>
 *         <td>{@code jks}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.credentials</b></td>
 *         <td>Client credentials used in authentication process.</td>
 *         <td>&nbsp;</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.cache.top</b></td>
 *         <td>
 *             Flag indicating that topology is cached internally. Cache will be refreshed in
 *             the background with interval defined by {@code turboSQL.client.topology.refresh}
 *             property (see below).
 *         </td>
 *         <td>{@code false}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.topology.refresh</b></td>
 *         <td>Topology cache refresh frequency (ms).</td>
 *         <td>{@code 2000}</td>
 *         <td>Yes</td>
 *     </tr>
 *     <tr>
 *         <td><b>turboSQL.client.idleTimeout</b></td>
 ...
 * Connection conn = DriverManager.getConnection("jdbc:turboSQL:cfg//cache=persons@file:///etc/configs/turboSQL-jdbc.xml");
 *
 * // Query persons' names
 ...
 * </pre>
 */
public class TurboSQLJdbcDriver implements Driver {
    /** Prefix for property names. */
    private static final String PROP_PREFIX = "turboSQL.jdbc.";
    ...
    /** URL prefix. */
    public static final String URL_PREFIX = "jdbc:turboSQL://";

    /** Config URL prefix. */
    public static final String CFG_URL_PREFIX = "jdbc:turboSQL:cfg://";
    ...
    /** Logger. */
    private static final Logger LOG = Logger.getLogger(TurboSQLJdbcDriver.class.getName());
    ...
    static {
        try {
            DriverManager.registerDriver(new TurboSQLJdbcDriver());
        }
        catch (SQLException e) {
            throw new RuntimeException("Failed to register TurboSQL JDBC driver.", e);
        }
    }
    ...
    @Override public Connection connect(String url, Properties props) throws SQLException {
        ...
        if (url.startsWith(URL_PREFIX)) {
            ...
            return new com.phonemetra.turbo.internal.jdbc2.JdbcConnection(url, props);
    }
    ...
    @Override public DriverPropertyInfo[] getPropertyInfo(String url, Properties info) throws SQLException {
        ...
        if (info.getProperty(PROP_CFG) != null)
            ...
            props.addAll(Arrays.<DriverPropertyInfo>asList(
                new JdbcDriverPropertyInfo("turboSQL.client.protocol",
                    info.getProperty("turboSQL.client.protocol", "TCP"),
                    "Communication protocol (TCP or HTTP)."),
                new JdbcDriverPropertyInfo("turboSQL.client.connectTimeout",
                    info.getProperty("turboSQL.client.connectTimeout", "0"),
                    "Socket connection timeout."),
                new JdbcDriverPropertyInfo("turboSQL.client.tcp.noDelay",
                    info.getProperty("turboSQL.client.tcp.noDelay", "true"),
                    "Flag indicating whether TCP_NODELAY flag should be enabled for outgoing connections."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.enabled",
                    info.getProperty("turboSQL.client.ssl.enabled", "false"),
                    "Flag indicating that SSL is needed for connection."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.protocol",
                    info.getProperty("turboSQL.client.ssl.protocol", "TLS"),
                    "SSL protocol."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.key.algorithm",
                    info.getProperty("turboSQL.client.ssl.key.algorithm", "SunX509"),
                    "Key manager algorithm."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.keystore.location",
                    info.getProperty("turboSQL.client.ssl.keystore.location", ""),
                    "Key store to be used by client to connect with TurboSQL topology."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.keystore.password",
                    info.getProperty("turboSQL.client.ssl.keystore.password", ""),
                    "Key store password."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.keystore.type",
                    info.getProperty("turboSQL.client.ssl.keystore.type", "jks"),
                    "Key store type."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.truststore.location",
                    info.getProperty("turboSQL.client.ssl.truststore.location", ""),
                    "Trust store to be used by client to connect with TurboSQL topology."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.keystore.password",
                    info.getProperty("turboSQL.client.ssl.truststore.password", ""),
                    "Trust store password."),
                new JdbcDriverPropertyInfo("turboSQL.client.ssl.truststore.type",
                    info.getProperty("turboSQL.client.ssl.truststore.type", "jks"),
                    "Trust store type."),
                new JdbcDriverPropertyInfo("turboSQL.client.credentials",
                    info.getProperty("turboSQL.client.credentials", ""),
                    "Client credentials used in authentication process."),
                new JdbcDriverPropertyInfo("turboSQL.client.cache.top",
                    info.getProperty("turboSQL.client.cache.top", "false"),
                ...
                new JdbcDriverPropertyInfo("turboSQL.client.topology.refresh",
                    info.getProperty("turboSQL.client.topology.refresh", "2000"),
                    "Topology cache refresh frequency (ms)."),
                new JdbcDriverPropertyInfo("turboSQL.client.idleTimeout",
                    info.getProperty("turboSQL.client.idleTimeout", "30000"),
