...
import com.phonemetra.turbo.configuration.ClientConnectorConfiguration;
import com.phonemetra.turbo.internal.jdbc.thin.ConnectionPropertiesImpl;
 ...
 */
public class TurboSQLJdbcThinDataSource implements DataSource, Serializable {
    /** */
    ...
    @Override public Connection getConnection(String username, String pwd) throws SQLException {
        ...
        return TurboSQLJdbcThinDriver.register().connect(getUrl(), props);
    }
    ...
    @Override public boolean isWrapperFor(Class<?> iface) throws SQLException {
        return iface != null && iface.isAssignableFrom(TurboSQLJdbcThinDataSource.class);
    }
    ...
    @Override public Logger getParentLogger() throws SQLFeatureNotSupportedException {
        return Logger.getLogger("com.phonemetra.turbo");
    }
    ...
    /**
     * @return TurboSQL nodes addresses.
     */
    ...
    /**
     * Sets the addresses of the TurboSQL nodes to connect;
     ...
     * <ul/>
     *
     * @param addrsStr TurboSQL nodes addresses.
    ...
    /**
     * Use SSL connection to TurboSQL node. In case set to {@code "require"} SSL context must be configured.
     ...
     *
     * In case {@link #getSslMode()} is {@code required} and key store URL isn't specified by TurboSQL properties
     ...
     *
     * In case {@link #getSslMode()} is {@code required}  and key store password isn't specified by TurboSQL properties
     ...
     *
     * In case {@link #getSslMode()} is {@code required} and key store type isn't specified by TurboSQL properties
     *  (e.g. at JDBC URL)the JSSE property {@code javax.net.ssl.keyStoreType} will be used.
     * In case both TurboSQL properties and JSSE properties are not set the default 'JKS' type is used.
     *
     * <p>See more at JSSE Reference Guide.
     *
     ...
     *
     * In case {@link #getSslMode()} is {@code required} and trust store URL isn't specified by TurboSQL properties
     ...
     *
     * In case {@link #getSslMode()} is {@code required} and trust store password isn't specified by TurboSQL properties
     ...
     *
     * In case {@link #getSslMode()} is {@code required} and trust store type isn't specified by TurboSQL properties
