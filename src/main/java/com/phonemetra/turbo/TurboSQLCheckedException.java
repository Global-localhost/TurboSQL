 ...
 * within Grid.
 */
public class TurboSQLCheckedException extends Exception {
    /** */
     ...
     */
    public TurboSQLCheckedException() {
        // No-op.
    }
     ...
     */
    public TurboSQLCheckedException(String msg) {
        super(msg);
    }
     ...
     */
    public TurboSQLCheckedException(Throwable cause) {
     ...
     *                           be writable
     */
    public TurboSQLCheckedException(String msg, @Nullable Throwable cause, boolean writableStackTrace) {
     ...
     * @param cause Optional nested exception (can be {@code null}).
     */
    public TurboSQLCheckedException(String msg, @Nullable Throwable cause) {
        super(msg, cause);
    }
