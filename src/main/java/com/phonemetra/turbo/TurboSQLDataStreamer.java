...
import com.phonemetra.turbo.stream.StreamReceiver;
 ...
 * the streamer.
 * <p>
 * Also note that {@code TurboSQLDataStreamer} is not the only way to add data into cache.
 * Alternatively you can use {@link TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)}
 ...
 * <p>
 * {@code TurboSQLDataStreamer} supports the following configuration properties:
 * <ul>
 *  <li>
 ...
 *      TurboSQL will make the best effort to detect the most suitable class-loader
 ...
 * </ul>
 */
public interface TurboSQLDataStreamer<K, V> extends AutoCloseable {
    /**
     ...
     *
     * @see TurboSQLConfiguration#getDataStreamerThreadPoolSize()
     ...
     */
    public TurboSQLFuture<?> future();

    /**
     * Optional deploy class for peer deployment. All classes added by a data streamer
     * must be class-loadable from the same class-loader. TurboSQL will make the best
     ...
     * @throws TurboSQLInterruptedException If thread has been interrupted.
     ...
     */
    public TurboSQLFuture<?> removeData(K key) throws CacheException, TurboSQLInterruptedException, IllegalStateException;
     ...
     * <p>
     * Note: if {@link TurboSQLDataStreamer#allowOverwrite()} set to {@code false} (by default)
     * then data streamer will not overwrite existing cache entries for better performance
     * (to change, set {@link TurboSQLDataStreamer#allowOverwrite(boolean)} to {@code true})
     *
     * @param key Key.
     ...
     * @throws IllegalStateException If grid has been concurrently stopped or
     *      {@link #close(boolean)} has already been called on streamer.
     * @throws TurboSQLDataStreamerTimeoutException If {@code timeout} is exceeded.
     * @see #allowOverwrite()
     */
    public TurboSQLFuture<?> addData(K key, @Nullable V val) throws CacheException, TurboSQLInterruptedException,
        IllegalStateException, TurboSQLDataStreamerTimeoutException;
     ...
     * @see #allowOverwrite()
     */
    public TurboSQLFuture<?> addData(Map.Entry<K, V> entry) throws CacheException, TurboSQLInterruptedException,
        IllegalStateException, TurboSQLDataStreamerTimeoutException;
     ...
     * @see #allowOverwrite()
     */
    public TurboSQLFuture<?> addData(Collection<? extends Map.Entry<K, V>> entries) throws IllegalStateException,
        TurboSQLDataStreamerTimeoutException;
     ...
     * @see #allowOverwrite()
     */
    public TurboSQLFuture<?> addData(Map<K, V> entries) throws IllegalStateException,
        TurboSQLDataStreamerTimeoutException;
     ...
     * @see #tryFlush()
     */
    public void flush() throws CacheException, TurboSQLInterruptedException, IllegalStateException,
        TurboSQLDataStreamerTimeoutException;
     ...
     * @see #flush()
     */
    public void tryFlush() throws CacheException, TurboSQLInterruptedException, IllegalStateException;
     ...
     * @throws TurboSQLInterruptedException If thread has been interrupted.
     * @throws TurboSQLDataStreamerTimeoutException If {@code timeout} is exceeded, only if cancel is {@code false}.
     */
    public void close(boolean cancel) throws CacheException, TurboSQLInterruptedException,
        TurboSQLDataStreamerTimeoutException;
     ...
     * @throws TurboSQLDataStreamerTimeoutException If {@code timeout} is exceeded.
     */
    @Override public void close() throws CacheException, TurboSQLInterruptedException,
        TurboSQLDataStreamerTimeoutException;
}
