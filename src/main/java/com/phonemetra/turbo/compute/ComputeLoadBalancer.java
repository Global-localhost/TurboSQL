 ...
 * query the {@link com.phonemetra.turbo.spi.loadbalancing.LoadBalancingSpi}
 ...
 *     &#64;Override
 *     protected Collection&lt;? extends ComputeJob> split(int gridSize, String arg) throws TurboSQLCheckedException {
...
public interface ComputeLoadBalancer {
     ...
     * @throws TurboSQLException If any error occurred when finding next balanced node.
     */
