 ...
 * For example, if you need to cancel an actively running job from {@link com.phonemetra.turbo.spi.collision.CollisionSpi}
 ...
 * also be assigned in {@link com.phonemetra.turbo.spi.failover.FailoverSpi} prior to failing over a job.
 * <p>
 ...
 * <p>
 * Job context can be injected into {@link ComputeJob} via {@link com.phonemetra.turbo.resources.JobContextResource}
 * annotation. Refer to the {@link com.phonemetra.turbo.resources.JobContextResource}
 * documentation for coding examples on how to inject job context.
 * <p>
 * Attribute names that start with {@code "apache.turboSQL:"} are reserved for internal system use.
 */
