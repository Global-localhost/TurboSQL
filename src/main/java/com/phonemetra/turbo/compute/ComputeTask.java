 ...
 *      (see {@link com.phonemetra.turbo.TurboSQLCompute#localDeployTask(Class, ClassLoader)} method), however if task does not specify
 ...
 *      See {@link com.phonemetra.turbo.resources} package for the list of injectable resources.
 * </li>
 * <li>
 ...
 *      (see {@link com.phonemetra.turbo.spi.collision.CollisionSpi}) which will determine how a job will be executed
 ...
 *          failed over is decided by {@link com.phonemetra.turbo.spi.failover.FailoverSpi} SPI implementation.
 ...
 *              method will return an instance of {@link com.phonemetra.turbo.cluster.ClusterTopologyException} exception.
 *          </li>
 *          <li>
 ...
 * When TurboSQL sees this annotation it will disable tracking of job results and
 ...
 * turboSQL resources. Both, field and method based injection are supported.
 * The following turboSQL resources can be injected:
 * <ul>
 * <li>{@link com.phonemetra.turbo.resources.TaskSessionResource}</li>
 * <li>{@link com.phonemetra.turbo.resources.TurboSQLInstanceResource}</li>
 ...
 * due to node crash (detected by {@link com.phonemetra.turbo.cluster.ClusterTopologyException} exception) or due to job
...
public interface ComputeTask<T, R> extends Serializable {
     ...
     * @throws TurboSQLException If mapping could not complete successfully. This exception will be
     *      thrown out of {@link ComputeTaskFuture#get()} method.
     */
    @Nullable public Map<? extends ComputeJob, ClusterNode> map(List<ClusterNode> subgrid, @Nullable T arg) throws TurboSQLException;
     ...
     *       job results.
     * @throws TurboSQLException If handling a job result caused an error. This exception will
     *      be thrown out of {@link ComputeTaskFuture#get()} method.
     */
    public ComputeJobResultPolicy result(ComputeJobResult res, List<ComputeJobResult> rcvd) throws TurboSQLException;
     ...
     * @throws TurboSQLException If reduction or results caused an error. This exception will
     *      be thrown out of {@link ComputeTaskFuture#get()} method.
     */
    @Nullable public R reduce(List<ComputeJobResult> results) throws TurboSQLException;
}