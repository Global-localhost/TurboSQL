 ...
 * rejects execution.
 * @see com.phonemetra.turbo.configuration.TurboSQLConfiguration#getPublicThreadPoolSize()
 */
public class ComputeExecutionRejectedException extends TurboSQLException {
    /** */
