 ...
 * injection) by attaching {@link com.phonemetra.turbo.resources.TaskContinuousMapperResource}
...
public interface ComputeTaskContinuousMapper {
     ...
     * @throws TurboSQLException If job can not be processed.
     */
    public void send(ComputeJob job, ClusterNode node) throws TurboSQLException;
     ...
     * @throws TurboSQLException If job can not be processed.
     */
    public void send(Map<? extends ComputeJob, ClusterNode> mappedJobs) throws TurboSQLException;
     ...
     * @throws TurboSQLException If job can not be processed.
     */
    public void send(ComputeJob job) throws TurboSQLException;
     ...
     * @throws TurboSQLException If job can not be processed.
     */
    public void send(Collection<? extends ComputeJob> jobs) throws TurboSQLException;
}