...
public class GridifySetToValueAbstractAspect {
     ...
     */
    protected void checkIsSplitToJobsAllowed(GridifyRangeArgument arg, GridifySetToValue ann) throws TurboSQLCheckedException {
     ...
     */
    protected Object execute(Method mtd, TurboSQLCompute compute, Class<?> cls, GridifyRangeArgument arg,
        ...
        while (true) {
            ...
            if (taskArg == null)
                ...
                try {
                    ...
                    throw new TurboSQLCheckedException("Failed to execute method locally.", e);
                }
            }
            else {
