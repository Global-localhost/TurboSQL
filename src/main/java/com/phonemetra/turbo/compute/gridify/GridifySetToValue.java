...
package com.phonemetra.turbo.compute.gridify;
 ...
 * the user has to write {@link com.phonemetra.turbo.compute.ComputeTask} to provide ForkJoin behavior.
 ...
 * initialization. In either case, TurboSQL must be able to serialize the state passed to remote node.
 * <p>
 ...
 * weaving. Note that TurboSQL is not shipped with JBoss and necessary
 ...
 *      <li>{@code -Djboss.aop.class.path=[path to turboSQL.jar]}</li>
 *      <li>{@code -Djboss.aop.exclude=org,com -Djboss.aop.include=com.phonemetra.turbo.examples}</li>
 *      </ul>
 * </li>
 * <li>
 ...
 *      {@code -javaagent:${TURBOSQL_HOME}/libs/aspectjweaver-1.7.2.jar}
 * </li>
 * <li>
 ...
 * {@turboSQLlink com.phonemetra.turbo.compute.gridify.aop.spring.GridifySpringEnhancer#enhance(java.lang.Object)} for the object
...
public @interface GridifySetToValue {
   ...
   int threshold() default 0;
     ...
     * as a deficiency but TurboSQL will properly handle this case by giving more than one sub-collection
     ...
     * For example, if input collection size is 100, number of nodes 10 and split size is set to 5 - TurboSQL
     * will submit 2 sub-collections of 5 elements each to each node (provided in order by load
     * balancing SPI).
     * <p>
     * By default (when split size is zero) - TurboSQL will automatically determine the split size based on
     ...
     * Refer to {@link com.phonemetra.turbo.Ignition} for information about named grids.
     *
     * @deprecated Use {@link #turboSQLInstanceName()}. Nonempty {@link #turboSQLInstanceName()} takes precedence.
     */
    @Deprecated
    String gridName() default "";

    /**
     * Name of the TurboSQL instance to use. By default, no-name default TurboSQL instance is used.
     * Refer to {@link com.phonemetra.turbo.Ignition} for information about named TurboSQL instances.
     */
    String turboSQLInstanceName() default "";
}