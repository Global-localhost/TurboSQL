 ...
 *
 *     &#64;Override
 *     protected Collection&lt;? extends ComputeJob&gt; split(int gridSize, final String arg) throws TurboSQLCheckedException {
 *         List&lt;ComputeJobAdapter&lt;String&gt;&gt; jobs = new ArrayList&lt;ComputeJobAdapter&lt;String&gt;&gt;(gridSize);
 *
 *         for (int i = 0; i < gridSize; i++) {
 *             jobs.add(new ComputeJobAdapter() {
 *                 // Job execution logic.
 *                 public Object execute() throws TurboSQLCheckedException {
...
public abstract class ComputeJobContinuationAdapter extends ComputeJobAdapter implements
     ...
     * backward compatibility with internal TurboSQL 2.x code.
     *
