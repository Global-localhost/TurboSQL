 ...
 * injection) by attaching {@link com.phonemetra.turbo.resources.TaskSessionResource @TaskSessionResource}
...
public interface ComputeTaskSession {
     ...
     * @throws TurboSQLException If job siblings can not be received from task node.
     */
    public Collection<ComputeJobSibling> getJobSiblings() throws TurboSQLException;
     ...
     * @throws TurboSQLException If refresh failed.
     */
    public Collection<ComputeJobSibling> refreshJobSiblings() throws TurboSQLException;
     ...
     * @throws TurboSQLException If job sibling can not be received from task node.
     */
    @Nullable public ComputeJobSibling getJobSibling(TurboSQLUuid jobId) throws TurboSQLException;
     ...
     * @throws TurboSQLException If sending of attribute message failed.
     */
    public void setAttribute(Object key, @Nullable Object val) throws TurboSQLException;
     ...
     * @throws TurboSQLException If sending of attribute message failed.
     */
    public void setAttributes(Map<?, ?> attrs) throws TurboSQLException;
     ...
     * by {@link com.phonemetra.turbo.spi.checkpoint.CheckpointSpi} implementation used.
     * <p>
     ...
     * @throws TurboSQLException If failed to save intermediate job state.
     * @see #loadCheckpoint(String)
     * @see #removeCheckpoint(String)
     * @see com.phonemetra.turbo.spi.checkpoint.CheckpointSpi
     */
    public void saveCheckpoint(String key, Object state) throws TurboSQLException;
     ...
     * its session, and can only be removed by calling {@link com.phonemetra.turbo.spi.checkpoint.CheckpointSpi#removeCheckpoint(String)}
     * from {@link com.phonemetra.turbo.TurboSQL} or another task or job.
     *
     * @param key Key to be used to load this checkpoint in future.
     * @param state Intermediate job state to save.
     ...
     */
    public void saveCheckpoint(String key, Object state, ComputeTaskSessionScope scope, long timeout,
        boolean overwrite) throws TurboSQLException;
     ...
     * {@link com.phonemetra.turbo.spi.checkpoint.CheckpointSpi} implementation used.
     * <p>
     * Long running jobs may decide to store intermediate state to protect themselves from failures.
     ...
     * @throws TurboSQLException If failed to load job state.
     * @see #removeCheckpoint(String)
     * @see com.phonemetra.turbo.spi.checkpoint.CheckpointSpi
     */
    @Nullable public <T> T loadCheckpoint(String key) throws TurboSQLException;

    /**
     * Removes previously saved job's state for a given {@code key} from an underlying storage.
     * The storage implementation is defined by {@link com.phonemetra.turbo.spi.checkpoint.CheckpointSpi} implementation used.
     * <p>
     * Long running jobs may decide to store intermediate state to protect themselves from failures.
     * This way whenever a job starts, it can load its previously saved state and continue
     * with execution.
     ...
     * @throws TurboSQLException If failed to remove job state.
     * @see #loadCheckpoint(String)
     * @see com.phonemetra.turbo.spi.checkpoint.CheckpointSpi
     */
    public boolean removeCheckpoint(String key) throws TurboSQLException;
     ...
     */
    public TurboSQLFuture<?> mapFuture();
}