 ...
 *      {@link com.phonemetra.turbo.spi.collision.CollisionSpi} SPI. Otherwise job will be submitted to the executor
 ...
 *          of the task adapters shipped with TurboSQL, then job will be failed
 ...
 * <li>{@link com.phonemetra.turbo.resources.JobContextResource}</li>
 ...
 * TurboSQL comes with convenience {@link ComputeJobAdapter} adapter that provides
 ...
 * using {@link com.phonemetra.turbo.resources.TaskSessionResource @TaskSessionResource} annotation.
...
public interface ComputeJob extends Serializable {
     ...
     * @throws TurboSQLException If job execution caused an exception. This exception will be
     ...
     *      it will be wrapped into {@link TurboSQLCheckedException}.
     */
    public Object execute() throws TurboSQLException;
}