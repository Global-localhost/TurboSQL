 ...
 */
public interface TurboSQLCluster extends ClusterGroup, TurboSQLAsyncSupport {
    /**
     ...
     * (see {@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}) topology versions
     ...
     *      topology history. Currently only {@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}
    ...
    public Collection<ClusterStartNodeResult> startNodes(File file, boolean restart, int timeout,
        int maxConn) throws TurboSQLException;
     ...
     * @throws TurboSQLException In case of error.
     */
    public TurboSQLFuture<Collection<ClusterStartNodeResult>> startNodesAsync(File file, boolean restart, int timeout,
        int maxConn) throws TurboSQLException;
     ...
     *         </tr>
     *         <tr>
     *             <td><b>turboSQLHome</b></td>
     *             <td>String</td>
     *             <td>
     *                 Path to TurboSQL installation folder. If not defined, TURBOSQL_HOME
     ...
     *             <td><b>cfg</b></td>
     *             <td>String</td>
     *             <td>Path to configuration file (relative to {@code turboSQLHome}).</td>
     *         </tr>
     *         <tr>
     *             <td><b>script</b></td>
     *             <td>String</td>
     *             <td>
     *                 Custom startup script file name and path (relative to {@code turboSQLHome}).
    ...
    public Collection<ClusterStartNodeResult> startNodes(Collection<Map<String, Object>> hosts,
        @Nullable Map<String, Object> dflts, boolean restart, int timeout, int maxConn) throws TurboSQLException;
     ...
     * @throws TurboSQLException In case of error.
     */
    public TurboSQLFuture<Collection<ClusterStartNodeResult>> startNodesAsync(Collection<Map<String, Object>> hosts,
        @Nullable Map<String, Object> dflts, boolean restart, int timeout, int maxConn) throws TurboSQLException;
     ...
     * @throws TurboSQLException In case of error.
     */
    public void stopNodes() throws TurboSQLException;
     ...
     * @throws TurboSQLException In case of error.
     */
    public void stopNodes(Collection<UUID> ids) throws TurboSQLException;
     ...
     * {@code turboSQL.sh} or {@code turboSQL.bat} scripts.
     *
     * @throws TurboSQLException In case of error.
     */
    public void restartNodes() throws TurboSQLException;
     ...
     * @throws TurboSQLException In case of error.
     */
    public void restartNodes(Collection<UUID> ids) throws TurboSQLException;
     ...
     */
    @Nullable public TurboSQLFuture<?> clientReconnectFuture();
     ...
     * @throws TurboSQLException If error occurs.
     * @see #enableWal(String)
     * @see #isWalEnabled(String)
     */
    public boolean disableWal(String cacheName) throws TurboSQLException;
     ...
     * @see #isWalEnabled(String)
     */
    public boolean enableWal(String cacheName) throws TurboSQLException;
     ...
     */
    public void baselineAutoAdjustEnabled(boolean baselineAutoAdjustEnabled) throws TurboSQLException;
     ...
     */
    public void baselineAutoAdjustTimeout(long baselineAutoAdjustTimeout) throws TurboSQLException;
}
