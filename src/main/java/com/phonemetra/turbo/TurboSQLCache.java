...
import com.phonemetra.turbo.cache.CacheEntry;
...
import com.phonemetra.turbo.cache.query.Query;
import com.phonemetra.turbo.cache.query.QueryCursor;
import com.phonemetra.turbo.cache.query.QueryDetailMetrics;
import com.phonemetra.turbo.cache.query.QueryMetrics;
import com.phonemetra.turbo.cache.query.ScanQuery;
import com.phonemetra.turbo.cache.query.SpiQuery;
import com.phonemetra.turbo.cache.query.SqlFieldsQuery;
import com.phonemetra.turbo.cache.query.SqlQuery;
import com.phonemetra.turbo.cache.query.TextQuery;
import com.phonemetra.turbo.cache.store.CacheStore;
...
import com.phonemetra.turbo.mxbean.CacheMetricsMXBean;
import com.phonemetra.turbo.transactions.TransactionException;
...
/**
 * Main entry point for all <b>Data Grid APIs.</b> You can get a named cache by calling {@link TurboSQL#cache(String)}
 * method.
 ...
 * <li>Ability to bulk load cache via {@link #loadCache(TurboSQLBiPredicate, Object...)} method.
 ...
 * to provide ACID-compliant behavior. See {@link TurboSQLTransactions} for more information.
 * <br>
 ...
 */
public interface TurboSQLCache<K, V> extends javax.cache.Cache<K, V>, TurboSQLAsyncSupport {
    /** {@inheritDoc} */
    @Deprecated
    @Override public TurboSQLCache<K, V> withAsync();
     ...
     */
    public TurboSQLCache<K, V> withExpiryPolicy(ExpiryPolicy plc);

    /**
     * @return Cache with read-through write-through behavior disabled.
     */
    public TurboSQLCache<K, V> withSkipStore();

    /**
     * @return Cache with no-retries behavior enabled.
     */
    public TurboSQLCache<K, V> withNoRetries();

    /**
     * Gets an instance of {@code TurboSQLCache} that will be allowed to execute cache operations (read, write)
     * regardless of partition loss policy.
     *
     * @return Cache without partition loss protection.
     */
    public TurboSQLCache<K, V> withPartitionRecover();
     ...
     * <ul>
     *     <li><code>com.phonemetra.turbo.binary.BinaryObject</code> for binary classes</li>
     ...
     * <pre>
     * TurboSQLCache<Integer, BinaryObject> prj = cache.withKeepBinary();
     *
     ...
     */
    public <K1, V1> TurboSQLCache<K1, V1> withKeepBinary();
     ...
     * {@link TurboSQLSystemProperties#IGNITE_ALLOW_ATOMIC_OPS_IN_TX IGNITE_ALLOW_ATOMIC_OPS_IN_TX} to {@code false}.
     * <p>
     ...
     */
    public <K1, V1> TurboSQLCache<K1, V1> withAllowAtomicOpsInTx();

    /**
     * Executes {@link #localLoadCache(TurboSQLBiPredicate, Object...)} on all cache nodes.
     *
     ...
     *      {@link CacheStore#loadCache(TurboSQLBiInClosure, Object...)} method.
     * @throws CacheException If loading failed.
     */
    @TurboSQLAsyncSupported
    public void loadCache(@Nullable TurboSQLBiPredicate<K, V> p, @Nullable Object... args) throws CacheException;

    /**
     * Asynchronously executes {@link #localLoadCache(TurboSQLBiPredicate, Object...)} on all cache nodes.
     *
     * @param p Optional predicate (may be {@code null}). If provided, will be used to
     *      filter values loaded from storage before they are put into cache.
     * @param args Optional user arguments to be passed into
     ...
     * @throws CacheException If loading failed.
     */
    public TurboSQLFuture<Void> loadCacheAsync(@Nullable TurboSQLBiPredicate<K, V> p, @Nullable Object... args)
        throws CacheException;

    /**
     * Delegates to {@link CacheStore#loadCache(TurboSQLBiInClosure,Object...)} method
     ...
     */
    @TurboSQLAsyncSupported
    public void localLoadCache(@Nullable TurboSQLBiPredicate<K, V> p, @Nullable Object... args) throws CacheException;

    /**
     * Asynchronously loads state from the underlying persistent storage by delegating
     * to {@link CacheStore#loadCache(TurboSQLBiInClosure,Object...)} method. The loaded values
     * will then be given to the optionally passed in predicate, and, if the predicate returns
     * {@code true}, will be stored in cache. If predicate is {@code null}, then
     * all loaded values will be stored in cache.
     * <p>
     ...
     * @throws CacheException If loading failed.
     */
    public TurboSQLFuture<Void> localLoadCacheAsync(@Nullable TurboSQLBiPredicate<K, V> p, @Nullable Object... args)
        throws CacheException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<V> getAndPutIfAbsentAsync(K key, V val) throws CacheException, TransactionException;
     ...
     * @return Cursor.
     */
    public <T, R> QueryCursor<R> query(Query<T> qry, TurboSQLClosure<T, R> transformer);
     ...
     * @throws CacheException On error.
     */
    public TurboSQLFuture<Integer> sizeAsync(CachePeekMode... peekModes) throws CacheException;
     ...
     * @throws CacheException On error.
     */
    public TurboSQLFuture<Long> sizeLongAsync(CachePeekMode... peekModes) throws CacheException;
     ...
     * @throws CacheException On error.
     */
    public TurboSQLFuture<Long> sizeLongAsync(int partition, CachePeekMode... peekModes) throws CacheException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public <T> TurboSQLFuture<Map<K, EntryProcessorResult<T>>> invokeAllAsync(
     ...
     * @return a Future representing pending completion of the operation.
     */
    public TurboSQLFuture<V> getAsync(K key);
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<CacheEntry<K, V>> getEntryAsync(K key) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Map<K, V>> getAllAsync(Set<? extends K> keys) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Collection<CacheEntry<K, V>>> getEntriesAsync(Set<? extends K> keys) throws TransactionException;
     ...
     * @return a Future representing pending completion of the operation.
     */
    public TurboSQLFuture<Map<K, V>> getAllOutTxAsync(Set<? extends K> keys);
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> containsKeyAsync(K key) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> containsKeysAsync(Set<? extends K> keys) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Void> putAsync(K key, V val) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<V> getAndPutAsync(K key, V val) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Void> putAllAsync(Map<? extends K, ? extends V> map) throws TransactionException;
     ...
     */
    public TurboSQLFuture<Boolean> putIfAbsentAsync(K key, V val);
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> removeAsync(K key) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> removeAsync(K key, V oldVal) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<V> getAndRemoveAsync(K key) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> replaceAsync(K key, V oldVal, V newVal) throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Boolean> replaceAsync(K key, V val) throws TransactionException;
     ...
     * @throws TransactionHeuristicException If operation performs within transaction that entered an unknown state.
     */
    public TurboSQLFuture<V> getAndReplaceAsync(K key, V val);
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public TurboSQLFuture<Void> removeAllAsync(Set<? extends K> keys) throws TransactionException;
     ...
     * @see CacheWriter#deleteAll
     */
    public TurboSQLFuture<Void> removeAllAsync();
     ...
     * @return a Future representing pending completion of the operation.
     */
    public TurboSQLFuture<Void> clearAsync();
     ...
     * @throws CacheException        if there is a problem during the clear
     */
    public TurboSQLFuture<Void> clearAsync(K key);
     ...
     * @throws CacheException        if there is a problem during the clear
     */
    public TurboSQLFuture<Void> clearAllAsync(Set<? extends K> keys);
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public <T> TurboSQLFuture<T> invokeAsync(K key, EntryProcessor<K, V, T> entryProcessor, Object... arguments)
        throws TransactionException;
     ...
     * @see CacheEntryProcessor
     */
    public <T> TurboSQLFuture<T> invokeAsync(K key, CacheEntryProcessor<K, V, T> entryProcessor, Object... arguments)
        throws TransactionException;
     ...
     * @throws TransactionException If operation within transaction is failed.
     */
    public <T> TurboSQLFuture<Map<K, EntryProcessorResult<T>>> invokeAllAsync(Set<? extends K> keys,
        EntryProcessor<K, V, T> entryProcessor, Object... args) throws TransactionException;
     ...
     * <p>
     * After cache instance is closed another {@code TurboSQLCache} instance for the same
     * cache can be created using {@link TurboSQL#cache(String)} method.
     */
     ...
     * {@link TurboSQLConfiguration#setConsistentId(Serializable)} to make sure that
     ...
     */
    public TurboSQLFuture<Boolean> rebalance();
     ...
     * @return Future.
     */
    public TurboSQLFuture<?> indexReadyFuture();
     ...
     */
    public TurboSQLFuture<Void> preloadPartitionAsync(int partition);
