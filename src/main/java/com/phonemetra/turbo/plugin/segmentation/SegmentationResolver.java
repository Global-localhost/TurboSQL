 ...
 * resolvers.
 * <p>
 * Note that TurboSQL support a logical segmentation and not limited to network
 ...
 * @see TurboSQLConfiguration#getSegmentationResolvers()
 * @see TurboSQLConfiguration#getSegmentationPolicy()
 * @see TurboSQLConfiguration#getSegmentCheckFrequency()
 * @see TurboSQLConfiguration#isAllSegmentationResolversPassRequired()
 * @see TurboSQLConfiguration#isWaitForSegmentOnStart()
...
public interface SegmentationResolver extends Serializable {
     ...
     * @throws TurboSQLCheckedException If an error occurred.
     */
    public abstract boolean isValidSegment() throws TurboSQLCheckedException;
}