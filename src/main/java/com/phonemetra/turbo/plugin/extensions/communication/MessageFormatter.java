...
package com.phonemetra.turbo.plugin.extensions.communication;

import java.util.UUID;
import com.phonemetra.turbo.TurboSQLCheckedException;
import com.phonemetra.turbo.plugin.Extension;
...
public interface MessageFormatter extends Extension {
     ...
     */
    public MessageWriter writer(UUID rmtNodeId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException In case of error.
     */
    public MessageReader reader(UUID rmtNodeId, MessageFactory msgFactory) throws TurboSQLCheckedException;
}
