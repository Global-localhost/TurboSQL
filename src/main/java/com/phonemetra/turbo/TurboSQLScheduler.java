 ...
 * GridScheduler s = Ignition.turboSQL().scheduler();
 * </pre>
 * <p>
 ...
 * <pre name="code" class="java">
 * Ignition.turboSQL().scheduler().scheduleLocal(
 *     GridSchedulerFuture&lt;?&gt; = Ignition.turboSQL().scheduler().scheduleLocal(new Callable&lt;Object&gt;() {
 *         &#64;Override public Object call() throws TurboSQLCheckedException {
 ...
 * </pre>
 */
public interface TurboSQLScheduler {
    /**
     * Executes given closure on internal system thread pool asynchronously.
     * <p>
     * Note that class {@link TurboSQLRunnable} implements {@link Runnable} and class {@link TurboSQLOutClosure}
     ...
     * @see com.phonemetra.turbo.lang.TurboSQLClosure
     */
    public TurboSQLFuture<?> runLocal(@Nullable Runnable r);

    /**
     * Executes given closure after the delay.
     * <p>
     * Note that class {@link TurboSQLRunnable} implements {@link Runnable}
     ...
     * @see TurboSQLOutClosure
     */
    public <R> TurboSQLFuture<R> callLocal(@Nullable Callable<R> c);
