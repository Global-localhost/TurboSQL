...
/**
 * This exception indicates the turboSQL access in invalid state.
 */
public class TurboSQLIllegalStateException extends IllegalStateException {
    /** */
     ...
     */
    public TurboSQLIllegalStateException(String msg, @Nullable Throwable cause) {
        super(msg, cause);
    }
     ...
     */
    public TurboSQLIllegalStateException(Throwable cause) {
     ...
     * @param msg Exception message.
     */
    public TurboSQLIllegalStateException(String msg) {
        super(msg);
    }
