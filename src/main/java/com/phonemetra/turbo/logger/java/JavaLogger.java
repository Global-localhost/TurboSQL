...
package com.phonemetra.turbo.logger.java;
...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_CONSOLE_APPENDER;
 ...
 * <p>
 * Here is an example of configuring Java logger in TurboSQL configuration Spring
 * file to work over log4j implementation. Note that we use the same configuration file
 * as we provide by default:
 * <pre name="code" class="xml">
 *      ...
 *      &lt;property name="gridLogger"&gt;
 *          &lt;bean class="com.phonemetra.turbo.logger.java.JavaLogger"&gt;
 ...
 *      ...
 * </pre>
 * And the same configuration if you'd like to configure TurboSQL in your code:
 * <pre name="code" class="java">
 *      TurboSQLConfiguration cfg = new TurboSQLConfiguration();
 *      ...
 *      TurboSQLLogger log = new JavaLogger(Logger.global);
 *      ...
 ...
 *      TurboSQLConfiguration cfg = new TurboSQLConfiguration();
 *      ...
 *      TurboSQLLogger log = new JavaLogger();
 *      ...
 *      cfg.setGridLogger(log);
 * </pre>
 ...
 * <p>
 * It's recommended to use TurboSQL logger injection instead of using/instantiating
 * logger in your task/job code. See {@link com.phonemetra.turbo.resources.LoggerResource} annotation about logger
 * injection.
 */
public class JavaLogger implements TurboSQLLogger, LoggerNodeIdAware {
    /** */
    ...
    private void defaultConfiguration() {
        final URL cfgUrl = U.resolveTurboSQLUrl(DFLT_CONFIG_PATH);
