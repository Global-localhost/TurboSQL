...
public final class JavaLoggerFileHandler extends StreamHandler {
     ...
     */
    public void nodeId(UUID nodeId, String workDir) throws TurboSQLCheckedException, IOException {
        if (delegate != null)
            return;
     ...
     */
    private static File logDirectory(String workDir) throws TurboSQLCheckedException {
