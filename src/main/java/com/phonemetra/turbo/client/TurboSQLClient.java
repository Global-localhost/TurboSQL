...
/**
 * TurboSQL thin client.
 * <p>
 * Unlike TurboSQL client nodes, thin clients do not start TurboSQL infrastructure and communicate with TurboSQL cluster
 * over a fast and lightweight protocol.
 * </p>
 */
public interface TurboSQLClient extends AutoCloseable {
    /**
