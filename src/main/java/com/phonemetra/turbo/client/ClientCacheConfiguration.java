...
package com.phonemetra.turbo.client;
...
public final class ClientCacheConfiguration implements Serializable {
     ...
     * If there is at least one cache configured with this flag set to {@code true}, TurboSQL
     ...
     *
     * @return Flag indicating whether TurboSQL will eagerly remove expired entries.
     */
    ...
    /**
     * @param eagerTtl {@code True} if TurboSQL should eagerly remove expired cache entries.
     */
    ...
    /**
     * Gets partition loss policy. This policy defines how TurboSQL will react to a situation when all nodes for
