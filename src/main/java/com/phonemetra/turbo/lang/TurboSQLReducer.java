 ...
 * to be reduced into one, e.g. {@link com.phonemetra.turbo.TurboSQLCompute#call(Collection, TurboSQLReducer)} method.
 *
 * @param <E> Type of collected values.
 * @param <R> Type of reduced value.
 */
public interface TurboSQLReducer<E, R> extends Serializable {
    /**
