 ...
 */
public class TurboSQLBiTuple<V1, V2> implements Map<V1, V2>, Map.Entry<V1, V2>,
     ...
     */
    public TurboSQLBiTuple(@Nullable V1 val1, @Nullable V2 val2) {
        this.val1 = val1;
        this.val2 = val2;
    }
     ...
     */
    public TurboSQLBiTuple<V2, V1> swap() {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TurboSQLBiTuple))
            return false;

        TurboSQLBiTuple<?, ?> t = (TurboSQLBiTuple<?, ?>)o;
    ...
    @Override public String toString() {
        return S.toString(TurboSQLBiTuple.class, this);
    }
}
