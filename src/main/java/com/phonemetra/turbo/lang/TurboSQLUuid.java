...
import com.phonemetra.turbo.binary.BinaryWriter;
import com.phonemetra.turbo.binary.Binarylizable;
import com.phonemetra.turbo.internal.util.lang.GridIterator;
 ...
 * internal UUID.
 */
public final class TurboSQLUuid implements Comparable<TurboSQLUuid>, Iterable<TurboSQLUuid>, Cloneable, Externalizable, Binarylizable {
    /** */
     ...
     * @param locId Counter.
     */
    public TurboSQLUuid(UUID gid, long locId) {
        assert gid != null;
     ...
     */
    public static TurboSQLUuid randomUuid() {
        return new TurboSQLUuid(VM_ID, cntGen.incrementAndGet());
    }
     ...
     * @return Newly created pseudo-random ID.
     */
    public static TurboSQLUuid fromUuid(UUID id) {
        A.notNull(id, "id");

        return new TurboSQLUuid(id, cntGen.getAndIncrement());
    }
     ...
     */
    public static TurboSQLUuid fromString(String s) {
        int firstDash = s.indexOf('-');

        return new TurboSQLUuid(
    ...
    /** {@inheritDoc} */
    @Override public int compareTo(TurboSQLUuid o) {
        if (o == this)
            return 0;
    ...
    /** {@inheritDoc} */
    @Override public GridIterator<TurboSQLUuid> iterator() {
        return F.iterator(Collections.singleton(this), F.<TurboSQLUuid>identity(), true);
    }
    ...
    @Override public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TurboSQLUuid))
            return false;

        TurboSQLUuid that = (TurboSQLUuid)obj;
