...
/**
 * Allows to enable asynchronous mode on TurboSQL APIs, e.g.
 * <pre>
 *     TurboSQLFuture f = cache.getAsync();
 * </pre>
 * instead of old-style async API:
 * <pre>
 *     TurboSQLCache asyncCache = cache.withAsync();
 *     asyncCache.get(key);
 *     TurboSQLFuture fut = asyncCache.future();
 * </pre>
 * @deprecated since 2.0. Please use specialized asynchronous methods.
 */
@Deprecated
public interface TurboSQLAsyncSupport {
    /**
     ...
     */
    @Deprecated
    public TurboSQLAsyncSupport withAsync();
     ...
     */
    @Deprecated
    public <R> TurboSQLFuture<R> future();
}