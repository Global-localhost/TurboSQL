 ...
 * <p>
 * Node version can be acquired via {@link com.phonemetra.turbo.cluster.ClusterNode#version()} method.
 * <p>
 * Two versions are compared in the following order: major number,
 * minor number, maintenance number, revision timestamp.
 */
public class TurboSQLProductVersion implements Comparable<TurboSQLProductVersion>, Externalizable {
    /** */
     ...
     */
    public TurboSQLProductVersion(byte major, byte minor, byte maintenance, long revTs, byte[] revHash) {
     ...
     * @param revHash Revision hash.
     */
    public TurboSQLProductVersion(byte major, byte minor, byte maintenance, String stage, long revTs, byte[] revHash) {
    ...
    /** {@inheritDoc} */
    @Override public int compareTo(@NotNull TurboSQLProductVersion o) {
        // NOTE: Unknown version is less than any other version.
     ...
     */
    public int compareToIgnoreTimestamp(@NotNull TurboSQLProductVersion o) {
        int res = Integer.compare(major, o.major);
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TurboSQLProductVersion))
            return false;

        TurboSQLProductVersion that = (TurboSQLProductVersion)o;
     ...
     */
    public static TurboSQLProductVersion fromString(String verStr) {
        assert verStr != null;
        ...
        if (match.matches()) {
            try {
                ...
                return new TurboSQLProductVersion(major, minor, maintenance, stage, revTs, revHash);
            }
            catch (IllegalStateException | IndexOutOfBoundsException | NumberFormatException | TurboSQLCheckedException e) {
