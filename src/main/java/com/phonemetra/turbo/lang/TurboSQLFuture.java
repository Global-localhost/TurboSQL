...
package com.phonemetra.turbo.lang;
 ...
 */
public interface TurboSQLFuture<V> {
    /**
     * Synchronously waits for completion of the computation and
     * returns computation result.
     *
     * @return Computation result.
     * @throws TurboSQLInterruptedException Subclass of {@link TurboSQLException} thrown if the wait was interrupted.
     * @throws TurboSQLFutureCancelledException Subclass of {@link TurboSQLException} thrown if computation was cancelled.
     * @throws TurboSQLException If computation failed.
     */
    public V get() throws TurboSQLException;
     ...
     * @throws TurboSQLInterruptedException Subclass of {@link TurboSQLException} thrown if the wait was interrupted.
     * @throws TurboSQLFutureCancelledException Subclass of {@link TurboSQLException} thrown if computation was cancelled.
     * @throws TurboSQLFutureTimeoutException Subclass of {@link TurboSQLException} thrown if the wait was timed out.
     * @throws TurboSQLException If computation failed.
     */
    public V get(long timeout) throws TurboSQLException;
     ...
     * @throws TurboSQLException If computation failed.
     */
    public V get(long timeout, TimeUnit unit) throws TurboSQLException;

    /**
     * Cancels this future.
     *
     * @return {@code True} if future was canceled (i.e. was not finished prior to this call).
     * @throws TurboSQLException If cancellation failed.
     */
    public boolean cancel() throws TurboSQLException;
     ...
     */
    public void listen(TurboSQLInClosure<? super TurboSQLFuture<V>> lsnr);
     ...
     */
    public void listenAsync(TurboSQLInClosure<? super TurboSQLFuture<V>> lsnr, Executor exec);
     ...
     */
    public <T> TurboSQLFuture<T> chain(TurboSQLClosure<? super TurboSQLFuture<V>, T> doneCb);
     ...
     * @return Chained future that finishes after this future completes and done callback is called.
     */
    public <T> TurboSQLFuture<T> chainAsync(TurboSQLClosure<? super TurboSQLFuture<V>, T> doneCb, Executor exec);
}