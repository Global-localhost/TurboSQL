 ...
 *      (objects are stored in {@link com.phonemetra.turbo.binary.BinaryObject} format).
 * </li>
 ...
 * TurboSQL will always store it in memory in the binary (i.e. binary) format.
 ...
 * using TurboSQLCache.withKeepBinary() method and then retrieve individual fields as needed:
 * <pre name=code class=java>
 * TurboSQLCache&lt;BinaryObject, BinaryObject&gt; prj = cache.withKeepBinary();
 *
 ...
 * <pre name=code class=java>
 * TurboSQLCache&lt;MyKey.class, MyValue.class&gt; cache = grid.cache(null);
 *
 ...
 * as follows:
 * <pre name=code class=java>
 * TurboSQLCache&lt;Integer.class, BinaryObject&gt; prj = cache.withKeepBinary();
 * </pre>
 * <h1 class="header">Automatic Binary Types</h1>
 * Note that only binary classes are converted to {@link com.phonemetra.turbo.binary.BinaryObject} format. Following
 ...
 * with different platforms, e.g. C++ or .NET, TurboSQL will automatically pick the most
 ...
 * TurboSQL comes with {@link com.phonemetra.turbo.binary.BinaryObjectBuilder} which allows to build binary objects dynamically:
 * <pre name=code class=java>
 * BinaryBuilder builder = Ignition.turboSQL().binary().builder();
 *
 ...
 * obj.setFieldB(123);
 *
 * BinaryObject binaryObj = Ignition.turboSQL().binary().toBinary(obj);
 * </pre>
 * NOTE: you don't need to convert typed objects to binary format before storing
 * them in cache, TurboSQL will do that automatically.
 * <h1 class="header">Binary Metadata</h1>
 * Even though TurboSQL binary protocol only works with hash codes for type and field names
 * to achieve better performance, TurboSQL provides metadata for all binary types which
 * can be queried ar runtime via any of the {@link TurboSQLBinary#type(Class)}
 ...
 * The only requirement TurboSQL imposes is that your object has an empty
 ...
 *     &lt;bean class="com.phonemetra.turbo.marshaller.binary.BinaryMarshaller"&gt;
 *         &lt;property name="classNames"&gt;
 *             &lt;list&gt;
 *                 &lt;value&gt;my.package.for.binary.objects.*&lt;/value&gt;
 *                 &lt;value&gt;com.phonemetra.turbo.examples.client.binary.Employee&lt;/value&gt;
 *             &lt;/list&gt;
 *         &lt;/property&gt;
 *     &lt;/bean&gt;
 * &lt;/property&gt;
 ...
 * </pre>
 * You can also specify class name for a binary object via {@link com.phonemetra.turbo.binary.BinaryTypeConfiguration}.
 ...
 *             &lt;list&gt;
 *                 &lt;bean class="com.phonemetra.turbo.binary.BinaryTypeConfiguration"&gt;
 *                     &lt;property name="className" value="com.phonemetra.turbo.examples.client.binary.EmployeeKey"/&gt;
 ...
 * Serialization and deserialization works out-of-the-box in TurboSQL. However, you can provide your own custom
 * serialization logic by optionally implementing {@link com.phonemetra.turbo.binary.Binarylizable} interface, like so:
 * <pre name=code class=java>
 ...
 * logic in {@link com.phonemetra.turbo.binary.BinarySerializer} either globally in
 * {@link com.phonemetra.turbo.configuration.BinaryConfiguration} or
 * for a specific type via {@link com.phonemetra.turbo.binary.BinaryTypeConfiguration} instance.
 * <p>
 ...
 * TurboSQL implementation uses name hash codes to generate IDs for class names or field names
 * internally. However, in cases when you want to provide your own ID mapping schema,
 * you can provide your own {@link com.phonemetra.turbo.binary.BinaryIdMapper} implementation.
 * <p>
 * ID-mapper may be provided either globally in {@link com.phonemetra.turbo.configuration.BinaryConfiguration},
 * or for a specific type via {@link com.phonemetra.turbo.binary.BinaryTypeConfiguration} instance.
 * <h1 class="header">Query Indexing</h1>
 * Binary objects can be indexed for querying by specifying index fields in
 * {@link com.phonemetra.turbo.cache.QueryEntity} inside of specific
 * {@link com.phonemetra.turbo.configuration.CacheConfiguration} instance,
 * like so:
 * <pre name=code class=xml>
 * ...
 ...
 *                 &lt;list&gt;
 *                 &lt;bean class="com.phonemetra.turbo.cache.QueryIndex"&gt;
 *                     &lt;property name="fields"&gt;
 *                          &lt;map&gt;
 ...
 * </pre>
 */
public interface TurboSQLBinary {
    /**
    ...
    /**
     * Converts provided object to instance of {@link com.phonemetra.turbo.binary.BinaryObject}.
     *
     * @param obj Object to convert.
     * @return Converted object.
     * @throws com.phonemetra.turbo.binary.BinaryObjectException In case of error.
     */
