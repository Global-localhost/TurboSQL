 ...
 */
public class ClusterTopologyException extends TurboSQLException {
    /** */
    private static final long serialVersionUID = 0L;

    /** Retry ready future. */
    private transient TurboSQLFuture<?> readyFut;
     ...
     */
    public TurboSQLFuture<?> retryReadyFuture() {
        return readyFut;
    }
     ...
     */
    public void retryReadyFuture(TurboSQLFuture<?> readyFut) {
