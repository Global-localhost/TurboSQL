 ...
 * metrics on local node {@link TurboSQLCluster#localNode() TurboSQLCluster.localNode().getMetrics()}
...
public interface ClusterMetrics {
     ...
     * <ul>
     * <li>{@link TurboSQLConfiguration#getMetricsExpireTime()}</li>
     * <li>{@link TurboSQLConfiguration#getMetricsHistorySize()}</li>
     * </ul>
     *
