 ...
 * The {@link TurboSQLCluster} interface itself also extends {@code ClusterGroup} which makes
 * an instance of {@link TurboSQLCluster} into a cluster group containing all cluster nodes.
 ...
 *
 * TurboSQLCluster cluster = turboSQL.cluster();
 *
...
public interface ClusterGroup {
     ...
     */
    public ClusterGroup forPredicate(TurboSQLPredicate<ClusterNode> p);
     ...
     * grid node configuration. See {@link TurboSQLConfiguration#getUserAttributes()}
     ...
     * @see TurboSQLConfiguration#setClientMode(boolean)
     ...
     * is build on TurboSQL and needs to participate in the topology, but also needs to be
     ...
     */
    public TurboSQLPredicate<ClusterNode> predicate();

    /**
     * Gets a metrics snapshot for this cluster group.
     *
     * @return Metrics snapshot.
     * @throws TurboSQLException If this cluster group is empty.
     */
    public ClusterMetrics metrics() throws TurboSQLException;
}