 ...
 * within Grid.
 */
public class TurboSQLException extends RuntimeException {
    /** */
     ...
     */
    public TurboSQLException(String msg) {
        super(msg);
    }
     ...
     */
    public TurboSQLException(Throwable cause) {
     ...
     */
    public TurboSQLException(String msg, @Nullable Throwable cause) {
        super(msg, cause);
    }
