 ...
 *
 *     &lt;bean id="turboSQL.cfg" class="com.phonemetra.turbo.configuration.TurboSQLConfiguration"&gt;
 *          ...
 *          &lt;property name="cacheConfiguration"&gt;
 *               &lt;list&gt;
 *                  &lt;bean class="com.phonemetra.turbo.configuration.CacheConfiguration"&gt;
 *                      &lt;property name="name" value="myCache" /&gt;
 *                      ...
 *                      &lt;property name="cacheStoreFactory"&gt;
 *                          &lt;bean class="com.phonemetra.turbo.cache.store.jdbc.CacheJdbcPojoStoreFactory"&gt;
 *                              &lt;property name="dataSourceBean" value="myDataSource" /&gt;
 *                              &lt;property name="types"&gt;
 *                                  &lt;list&gt;
 *                                      &lt;bean class="com.phonemetra.turbo.cache.store.jdbc.JdbcType"&gt;
 ...
 *                                              &lt;list&gt;
 *                                                  &lt;bean class="com.phonemetra.turbo.cache.store.jdbc.JdbcTypeField"&gt;
...
public class CacheJdbcPojoStoreFactory<K, V> implements Factory<CacheAbstractJdbcStore<K, V>> {
    ...
    @Override public CacheJdbcPojoStore<K, V> create() {
        ...
        if (dataSrc != null)
            ...
            if (appCtx == null)
                throw new TurboSQLException("Spring application context resource is not injected.");

            TurboSQLSpringHelper spring;

            try {
                spring = TurboSQLComponentType.SPRING.create(false);
                ...
                throw new TurboSQLException("Failed to load bean in application context [beanName=" + dataSrcBean +
                    ", turboSQLConfig=" + appCtx + ']', e);
            }
        }
