...
public abstract class CacheLoadOnlyStoreAdapter<K, V, I> implements CacheStore<K, V> {
     ...
     *
     * @param args Arguments passes into {@link TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)} method.
     ...
     * @param args Arguments passed into {@link TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)} method.
     * @return Cache entry to be saved in cache or {@code null} if no entry could be produced from this record.
     */
    @Nullable protected abstract TurboSQLBiTuple<K, V> parse(I rec, @Nullable Object... args);

    /** {@inheritDoc} */
    @Override public void loadCache(TurboSQLBiInClosure<K, V> c, @Nullable Object... args) {
    ...
    private class Worker implements Runnable {
        /** */
        private final TurboSQLBiInClosure<K, V> c;
         ...
         * @param args Arguments passed into {@link TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)} method.
         */
        Worker(TurboSQLBiInClosure<K, V> c, Collection<I> buf, Object[] args) {
            this.c = c;
            this.buf = buf;
            this.args = args;
        }
        ...
        @Override public void run() {
            for (I rec : buf) {
                TurboSQLBiTuple<K, V> entry = parse(rec, args);
