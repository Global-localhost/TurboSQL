...
import com.phonemetra.turbo.cache.store.jdbc.CacheJdbcStoreSessionListener;
 ...
 * TurboSQL provides several out-of-the-box implementations
 ...
 *     </li>
 *     <li>
 *         {@turboSQLlink com.phonemetra.turbo.cache.store.spring.CacheSpringStoreSessionListener} -
 ...
 *     </li>
 *     <li>
 *         {@turboSQLlink com.phonemetra.turbo.cache.store.hibernate.CacheHibernateStoreSessionListener} -
 *         Hibernate-based session listener. It creates a new Hibernate
 *         session for each TurboSQL session. If there is an ongoing cache
 ...
 *         {@link TurboSQLConfiguration#setCacheStoreSessionListenerFactories(Factory[])}
 ...
 *                 &lt;constructor-arg&gt;
 *                     &lt;bean class="com.phonemetra.turbo.cache.store.jdbc.CacheJdbcStoreSessionListener"&gt;
