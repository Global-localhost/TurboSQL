...
package com.phonemetra.turbo.cache.store;
...
import com.phonemetra.turbo.cache.store.jdbc.CacheJdbcBlobStore;
 ...
 * Persistent store is configured via {@link com.phonemetra.turbo.configuration.CacheConfiguration#getCacheStoreFactory()}
 ...
 * <ul>
 *     <li>{@turboSQLlink com.phonemetra.turbo.cache.store.hibernate.CacheHibernateBlobStore}</li>
...
public interface CacheStore<K, V> extends CacheLoader<K, V>, CacheWriter<K, V> {
     ...
     * is called whenever {@link com.phonemetra.turbo.TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)}
     ...
     * <p>
     * For every loaded value method {@link com.phonemetra.turbo.lang.TurboSQLBiInClosure#apply(Object, Object)}
     ...
     *      {@link com.phonemetra.turbo.TurboSQLCache#loadCache(TurboSQLBiPredicate, Object...)} method.
     * @throws CacheLoaderException If loading failed.
     */
    public void loadCache(TurboSQLBiInClosure<K, V> clo, @Nullable Object... args) throws CacheLoaderException;
