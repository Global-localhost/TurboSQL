...
package com.phonemetra.turbo.cache.eviction;

import com.phonemetra.turbo.cache.eviction.fifo.FifoEvictionPolicy;
import com.phonemetra.turbo.cache.eviction.lru.LruEvictionPolicy;
import com.phonemetra.turbo.cache.eviction.sorted.SortedEvictionPolicy;
 ...
 * <p>
 * TurboSQL comes with following eviction policies out-of-the-box:
 * <ul>
 ...
 * <p>
 * Note that implementations of all eviction policies provided by TurboSQL are very
