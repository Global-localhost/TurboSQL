...
import com.phonemetra.turbo.cache.eviction.AbstractEvictionPolicy;
import com.phonemetra.turbo.cache.eviction.EvictableEntry;
import com.phonemetra.turbo.internal.util.GridConcurrentSkipListSet;
...
import static com.phonemetra.turbo.configuration.CacheConfiguration.DFLT_CACHE_SIZE;
 ...
 */
public class SortedEvictionPolicy<K, V> extends AbstractEvictionPolicy<K, V> implements TurboSQLMBeanAware {
    /** */
