 ...
 * interface by calling {@code TurboSQL.affinity(cacheName)} method.
 * <p>
...
public interface Affinity<K> {
     ...
     * @throws TurboSQLException If there are no alive nodes for this cache.
     * @see AffinityFunction
     * @see com.phonemetra.turbo.configuration.CacheConfiguration#getAffinity()
     * @see com.phonemetra.turbo.configuration.CacheConfiguration#setAffinity(AffinityFunction)
     */
