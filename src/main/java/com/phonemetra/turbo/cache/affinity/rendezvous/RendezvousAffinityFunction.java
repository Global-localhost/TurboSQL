...
package com.phonemetra.turbo.cache.affinity.rendezvous;
...
import com.phonemetra.turbo.cache.affinity.AffinityFunction;
import com.phonemetra.turbo.cache.affinity.AffinityFunctionContext;
...
public class RendezvousAffinityFunction implements AffinityFunction, Serializable {
    ...
    /** Comparator. */
    private static final Comparator<TurboSQLBiTuple<Long, ClusterNode>> COMPARATOR = new HashComparator();
    ...
    private TurboSQLBiPredicate<ClusterNode, ClusterNode> backupFilter;
     ...
     *  is primary). */
    private TurboSQLBiPredicate<ClusterNode, List<ClusterNode>> affinityBackupFilter;
     ...
     * Note that {@code backupFilter} is ignored if {@code excludeNeighbors} is set to {@code true}.
     */
    public RendezvousAffinityFunction(int parts, @Nullable TurboSQLBiPredicate<ClusterNode, ClusterNode> backupFilter) {
    ...
    private RendezvousAffinityFunction(boolean exclNeighbors, int parts,
        TurboSQLBiPredicate<ClusterNode, ClusterNode> backupFilter) {
     ...
     */
    @Nullable public TurboSQLBiPredicate<ClusterNode, ClusterNode> getBackupFilter() {
        return backupFilter;
    }
    ...
    public RendezvousAffinityFunction setBackupFilter(
        @Nullable TurboSQLBiPredicate<ClusterNode, ClusterNode> backupFilter) {
        this.backupFilter = backupFilter;
     ...
     * @return Optional backup filter.
     */
    @Nullable public TurboSQLBiPredicate<ClusterNode, List<ClusterNode>> getAffinityBackupFilter() {
    ...
    public RendezvousAffinityFunction setAffinityBackupFilter(
        @Nullable TurboSQLBiPredicate<ClusterNode, List<ClusterNode>> affinityBackupFilter) {
    ...
    public List<ClusterNode> assignPartition(int part,
        ...
        TurboSQLBiTuple<Long, ClusterNode> [] hashArr =
            (TurboSQLBiTuple<Long, ClusterNode> [])new TurboSQLBiTuple[nodes.size()];
     ...
     *
     */
    private static class HashComparator implements Comparator<TurboSQLBiTuple<Long, ClusterNode>>, Serializable {
        /** */
        private static final long serialVersionUID = 0L;

        /** {@inheritDoc} */
        @Override public int compare(TurboSQLBiTuple<Long, ClusterNode> o1, TurboSQLBiTuple<Long, ClusterNode> o2) {
    ...
    private static class LazyLinearSortedContainer implements Iterable<ClusterNode> {
        ...
        private final TurboSQLBiTuple<Long, ClusterNode>[] arr;
         ...
         */
        LazyLinearSortedContainer(TurboSQLBiTuple<Long, ClusterNode>[] arr, int needFirstSortedCnt) {
            this.arr = arr;
        ...
        private class SortIterator implements Iterator<ClusterNode> {
            ...
            @Override public ClusterNode next() {
                ...
                TurboSQLBiTuple<Long, ClusterNode> min = arr[cur];
