 ...
 * each node via some means external to TurboSQL.  On AWS, some nodes might have AVAILABILTY_ZONE=us-east-1a and others
 * AVAILABILTY_ZONE=us-east-1b.
 * <pre name="code" class="xml">
 * &lt;property name="cacheConfiguration"&gt;
 *     &lt;list&gt;
 *         &lt;bean id="cache-template-bean" abstract="true" class="com.phonemetra.turbo.configuration.CacheConfiguration"&gt;
 *             &lt;property name="name" value="JobcaseDefaultCacheConfig*"/&gt;
 *             &lt;property name="cacheMode" value="PARTITIONED" /&gt;
 *             &lt;property name="backups" value="1" /&gt;
 *             &lt;property name="affinity"&gt;
 *                 &lt;bean class="com.phonemetra.turbo.cache.affinity.rendezvous.RendezvousAffinityFunction"&gt;
 *                     &lt;property name="affinityBackupFilter"&gt;
 *                         &lt;bean class="com.phonemetra.turbo.cache.affinity.rendezvous.ClusterNodeAttributeAffinityBackupFilter"&gt;
 *                             &lt;constructor-arg&gt;
 ...
 */
public class ClusterNodeAttributeAffinityBackupFilter implements TurboSQLBiPredicate<ClusterNode, List<ClusterNode>> {
    /** */
