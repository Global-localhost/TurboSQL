 ...
 * {@link com.phonemetra.turbo.compute.ComputeJob} or any other grid computation, such as {@link Runnable},
 * {@link Callable}, or {@link com.phonemetra.turbo.lang.TurboSQLClosure}. It should be attached to a field
 * that provides affinity key for the computation. Only one annotation per class is allowed.
 * Whenever such annotation is detected, then {@link com.phonemetra.turbo.spi.loadbalancing.LoadBalancingSpi}
