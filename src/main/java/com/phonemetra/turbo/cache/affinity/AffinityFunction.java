...
package com.phonemetra.turbo.cache.affinity;
 ...
 * for individual caches via {@link com.phonemetra.turbo.configuration.CacheConfiguration#getAffinity()} method.
 * <p>
 ...
 * This collection of nodes is used for node affinity. In {@link com.phonemetra.turbo.cache.CacheMode#REPLICATED REPLICATED}
 * cache mode the key will be cached on all returned nodes; generally, all caching nodes
 * participate in caching every key in replicated mode. In {@link com.phonemetra.turbo.cache.CacheMode#PARTITIONED PARTITIONED}
 ...
 * @see TurboSQLConfiguration#isLateAffinityAssignment()
 */
