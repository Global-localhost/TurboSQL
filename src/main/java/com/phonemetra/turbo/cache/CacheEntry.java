 ...
 * <li>invoke and invokeAll methods of {@link TurboSQLCache}</li>
 * </ul>
 * <p>
 * To get an instance of {@code CacheEntry} directly use {@link TurboSQLCache#getEntry(Object)} or
 * {@link TurboSQLCache#getEntries(Set)} methods.
 * <p>
 ...
 * TurboSQLCache<Integer, String> cache = grid(0).cache(null);
 *
