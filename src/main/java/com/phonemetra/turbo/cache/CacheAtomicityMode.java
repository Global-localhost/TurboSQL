 ...
 * <p>
 * Cache atomicity may be set via {@link com.phonemetra.turbo.configuration.CacheConfiguration#getAtomicityMode()}
...
public enum CacheAtomicityMode {
     ...
     *         to disable retries with {@link TurboSQLCache#withNoRetries()} and manually restore primary-backup
     ...
     *
     * @see TurboSQLCache#withNoRetries()
     */
    ATOMIC,
