...
package com.phonemetra.turbo.cache.query.annotations;
...
import com.phonemetra.turbo.internal.processors.cache.query.CacheQuery;
...
public @interface QuerySqlField {
     ...
     * of type {@code org.locationtech.jts.geom.Geometry} (or any subclass of this class) then TurboSQL will
     ...
     * </ul>
     * When set to {@code -1}, TurboSQL will try to detect inline size automatically. It will be no more than
