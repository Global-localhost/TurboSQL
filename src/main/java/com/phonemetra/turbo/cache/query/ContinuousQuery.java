...
import com.phonemetra.turbo.cache.query.ContinuousQueryWithTransformer.EventListener;
...
public final class ContinuousQuery<K, V> extends AbstractContinuousQuery<K, V> {
     ...
     * <p>
     * If remote filter are annotated with {@link TurboSQLAsyncCallback} then it is executed in async callback
     * pool (see {@link TurboSQLConfiguration#getAsyncCallbackPoolSize()}) that allow to perform a cache operations.
     *
