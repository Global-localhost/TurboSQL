 ...
 * <p>
 * Any grid resource from {@code com.phonemetra.turbo.resources} package can be injected
 * into implementation of this interface.
 */
public interface CacheInterceptor<K, V> extends Serializable {
    /**
     * This method is called within {@link TurboSQLCache#get(Object)}
    ...
    /**
     * This method is called within {@link TurboSQLCache#put(Object, Object)}
     ...
     * @see TurboSQLCache#put(Object, Object)
     */
    ...
    /**
     * This method is called within {@link TurboSQLCache#remove(Object)}
     * and similar operations to provide control over returned value.
     * <p>
     * Implementations should not execute any complex logic,
     * including locking, networking or cache operations,
     ...
     *      may be {@code null}.
     * @see TurboSQLCache#remove(Object)
     */
    @Nullable public TurboSQLBiTuple<Boolean, V> onBeforeRemove(Cache.Entry<K, V> entry);
