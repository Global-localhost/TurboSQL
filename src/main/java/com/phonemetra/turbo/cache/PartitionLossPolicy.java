 ...
 * {@link TurboSQL#resetLostPartitions(Collection)} method is called. <code>*_ALL</code> policies allow working with
 ...
 *
 * @see TurboSQL#resetLostPartitions(Collection)
 * @see TurboSQLCache#lostPartitions()
 */
