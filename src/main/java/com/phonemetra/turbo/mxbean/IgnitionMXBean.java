...
/**
 * This interface defines JMX view on {@link com.phonemetra.turbo.Ignition}.
 */
...
public interface IgnitionMXBean {
     ...
     * @see com.phonemetra.turbo.Ignition#state()
     */
     ...
     * @see com.phonemetra.turbo.Ignition#state(String)
     */
     ...
     * @see com.phonemetra.turbo.Ignition#stop(boolean)
     */
     ...
     * @return {@code true} if named TurboSQL instance instance was indeed found and stopped,
     *      {@code false} otherwise (the instance with given {@code name} was
     *      not found).
     * @see com.phonemetra.turbo.Ignition#stop(String, boolean)
     */
    @MXBeanDescription("Stops TurboSQL instance by name. Cancels running jobs if cancel is true. Returns true if named " +
        "TurboSQL instance was indeed found and stopped, false otherwise.")
    @MXBeanParametersNames(
        {
            "name",
            "cancel"
     ...
     *      method. Note that just like with {@link Thread#interrupt()}, it is
     *      up to the actual job to exit from execution
     * @see com.phonemetra.turbo.Ignition#stopAll(boolean)
     */
