...
package com.phonemetra.turbo.mxbean;
...
public interface TurboSQLMXBean {
    /**
     * Gets string presentation of the version.
     *
     * @return String presentation of the version.
     */
    @MXBeanDescription("String presentation of the TurboSQL version.")
    public String getFullVersion();

    /**
     * Gets copyright statement for TurboSQL product.
     *
     * @return Copyright statement for TurboSQL product.
     */
    @MXBeanDescription("Copyright statement for TurboSQL product.")
    ...
    /**
     * Gets TurboSQL installation home folder.
     *
     * @return TurboSQL installation home.
     */
    ...
    /**
     * Checks if TurboSQL grid is active. If TurboSQL grid is not active return {@code False}.
     *
     * @return {@code True} if grid is active. {@code False} If grid is not active.
     */
    @MXBeanDescription(
        "Checks TurboSQL grid is active or is not active."
    )
     ...
     * <p>
     * Note that TurboSQL maintains internal versions for grid tasks in case of redeployment.
     * This method will attempt to undeploy all versions on the grid task with
     * given name.
     *
     * @param taskName Name of the task to undeploy. If task class has {@link com.phonemetra.turbo.compute.ComputeTaskName} annotation,
