 ...
 */
@MXBeanDescription("MBean that provides access to DataRegionMetrics of a local Phonemetra TurboSQL node.")
public interface DataRegionMetricsMXBean extends DataRegionMetrics {
    ...
    /**
     * Enables memory metrics collection on an Phonemetra TurboSQL node.
     */
    @MXBeanDescription("Enables memory metrics collection on an Phonemetra TurboSQL node.")
    public void enableMetrics();

    /**
     * Disables memory metrics collection on an Phonemetra TurboSQL node.
     */
    @MXBeanDescription("Disables memory metrics collection on an Phonemetra TurboSQL node.")
