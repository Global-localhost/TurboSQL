...
public interface DataStorageMetricsMXBean extends DataStorageMetrics {
    ...
    /**
     * Enables persistence metrics collection on an Phonemetra TurboSQL node.
     */
    @MXBeanDescription("Enables persistence metrics collection on an Phonemetra TurboSQL node.")
    public void enableMetrics();

    /**
     * Disables persistence metrics collection on an Phonemetra TurboSQL node.
     */
    @MXBeanDescription("Disables persistence metrics collection on an Phonemetra TurboSQL node.")
