...
import com.phonemetra.turbo.internal.processors.cache.GridCacheDefaultAffinityKeyMapper;
import com.phonemetra.turbo.internal.processors.igfs.IgfsBaseBlockKey;
 ...
 * &lt;bean id="cacheCfgBase" class="com.phonemetra.turbo.cache.CacheConfiguration" abstract="true"&gt;
 *     ...
 *     &lt;property name="affinityMapper"&gt;
 *         &lt;bean class="com.phonemetra.turbo.igfs.IgfsGroupDataBlocksKeyMapper"&gt;
...
public class IgfsGroupDataBlocksKeyMapper extends GridCacheDefaultAffinityKeyMapper {
    ...
    @Override public Object affinityKey(Object key) {
        if (key instanceof IgfsBaseBlockKey) {
            ...
            TurboSQLUuid affKey = blockKey.affinityKey();
