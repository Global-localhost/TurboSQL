...
package com.phonemetra.turbo.igfs;

import com.phonemetra.turbo.configuration.TurboSQLConfiguration;
import com.phonemetra.turbo.internal.util.typedef.internal.S;
import com.phonemetra.turbo.internal.util.typedef.internal.U;

import static com.phonemetra.turbo.igfs.IgfsIpcEndpointType.SHMEM;
import static com.phonemetra.turbo.igfs.IgfsIpcEndpointType.TCP;
...
public class IgfsIpcEndpointConfiguration {
     ...
     *
     * @see TurboSQLConfiguration#getWorkDirectory()
     */
    public static final String DFLT_TOKEN_DIR_PATH = "ipc/shmem";

    /** Default threads count. */
    public static final int DFLT_THREAD_CNT = TurboSQLConfiguration.AVAILABLE_PROC_CNT;
     ...
     * <p>
     * Note that this path is relative to {@code TURBOSQL_HOME/work} folder if {@code TURBOSQL_HOME} system or environment
