...
/**
 * IGFS task arguments. When you initiate new IGFS task execution using one of {@code TurboSQLFs.execute(...)} methods,
 * all passed parameters are encapsulated in a single {@code IgfsTaskArgs} object. Later on this object is
 * passed to {@link IgfsTask#createJob(com.phonemetra.turbo.igfs.IgfsPath, IgfsFileRange, IgfsTaskArgs)} method.
 * <p>
 * Task arguments encapsulates the following data:
 * <ul>
 *     <li>IGFS name</li>
 *     <li>File paths passed to {@code TurboSQLFs.execute()} method</li>
 ...
 *     <li>Maximum file range length for that task (see {@link com.phonemetra.turbo.configuration.FileSystemConfiguration#getMaximumTaskRangeLength()})</li>
 * </ul>
 */
