...
import com.phonemetra.turbo.internal.util.GridFixedSizeInputStream;
...
public abstract class IgfsInputStreamJobAdapter extends IgfsJobAdapter {
    /** {@inheritDoc} */
    @Override public final Object execute(TurboSQLFileSystem igfs, IgfsFileRange range, IgfsInputStream in)
     ...
     */
    public abstract Object execute(TurboSQLFileSystem igfs, IgfsRangeInputStream in) throws TurboSQLException, IOException;
}