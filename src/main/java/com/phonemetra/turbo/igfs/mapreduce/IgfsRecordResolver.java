 ...
 * <ul>
 *     <li>{@link com.phonemetra.turbo.igfs.mapreduce.records.IgfsFixedLengthRecordResolver}</li>
 *     <li>{@link com.phonemetra.turbo.igfs.mapreduce.records.IgfsByteDelimiterRecordResolver}</li>
 *     <li>{@link com.phonemetra.turbo.igfs.mapreduce.records.IgfsStringDelimiterRecordResolver}</li>
 *     <li>{@link com.phonemetra.turbo.igfs.mapreduce.records.IgfsNewLineRecordResolver}</li>
 * </ul>
 */
public interface IgfsRecordResolver extends Serializable {
     ...
     * @throws TurboSQLException If resolve failed.
     * @throws IOException If resolve failed.
     */
    @Nullable public IgfsFileRange resolveRecords(TurboSQLFileSystem fs, IgfsInputStream stream,
        IgfsFileRange suggestedRecord) throws TurboSQLException, IOException;
}