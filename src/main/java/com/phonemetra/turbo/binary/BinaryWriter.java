 ...
 * <p>
 * Note that TurboSQL never writes full strings for field or type names. Instead,
 * for performance reasons, TurboSQL writes integer hash codes for type and field names.
 ...
 * actually do collide, TurboSQL provides {@link BinaryIdMapper} which
