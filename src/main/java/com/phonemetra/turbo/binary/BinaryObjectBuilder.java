 ...
 * other fields.
 * <pre name=code class=java>
 * BinaryObjectBuilder builder = Ignition.turboSQL().binary().builder(person);
 *
 ...
 *
 * @see com.phonemetra.turbo.TurboSQLBinary#builder(String)
 * @see com.phonemetra.turbo.TurboSQLBinary#builder(BinaryObject)
 */
