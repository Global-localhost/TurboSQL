 ...
 * <ul>
 *     <li>{@link TurboSQL#atomicReference(String, Object, boolean)}</li>
 * </ul>
 * @see TurboSQL#atomicReference(String, Object, boolean)
 */
public interface TurboSQLAtomicReference<T> extends Closeable {
    /**
     ...
     */
    public T get() throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public void set(T val) throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public boolean compareAndSet(T expVal, T newVal) throws TurboSQLException;
