...
/**
 * Updates cache with batch of entries. Usually it is enough to configure {@link TurboSQLDataStreamer#allowOverwrite(boolean)}
 ...
 * {@link TurboSQLDataStreamer#receiver(StreamReceiver)} method.
 */
public interface StreamReceiver<K, V> extends Serializable {
     ...
     * @throws com.phonemetra.turbo.TurboSQLException If failed.
     */
    public void receive(TurboSQLCache<K, V> cache, Collection<Map.Entry<K, V>> entries) throws TurboSQLException;
}