 ...
 * convert different message formats into TurboSQL stream key-value tuples
 * and feed the tuples into the provided {@link com.phonemetra.turbo.TurboSQLDataStreamer}.
 * <p>
...
public abstract class StreamAdapter<T, K, V> {
    ...
    /** Streamer. */
    private TurboSQLDataStreamer<K, V> stmr;
     ...
     */
    protected StreamAdapter(TurboSQLDataStreamer<K, V> stmr, StreamSingleTupleExtractor<T, K, V> extractor) {
        this.stmr = stmr;
     ...
     */
    protected StreamAdapter(TurboSQLDataStreamer<K, V> stmr, StreamMultipleTupleExtractor<T, K, V> extractor) {
        this.stmr = stmr;
     ...
     */
    public TurboSQLDataStreamer<K, V> getStreamer() {
        return stmr;
    }

    /**
     * @param stmr TurboSQL data streamer.
     */
    public void setStreamer(TurboSQLDataStreamer<K, V> stmr) {
        this.stmr = stmr;
    }
    ...
    /**
     * @return Provided {@link TurboSQL} instance.
     */
    public TurboSQL getTurboSQL() {
        return turboSQL;
    }

    /**
     * @param turboSQL {@link TurboSQL} instance.
     */
    public void setTurboSQL(TurboSQL turboSQL) {
