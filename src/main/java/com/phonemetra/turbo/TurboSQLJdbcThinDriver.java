...
import com.phonemetra.turbo.internal.jdbc.thin.JdbcThinConnection;
import com.phonemetra.turbo.internal.jdbc.thin.JdbcThinUtils;
 ...
 * JDBC driver is located in main TurboSQL JAR in {@code TURBOSQL_HOME/libs} folder.
 * <h1 class="header">Configuration</h1>
 *
 * <p>
 * JDBC connection URL has the following pattern:
 * {@code jdbc:turboSQL://<hostname>:<port>/}<br>
 * Note the following:
 * <ul>
 *     <li>Hostname is required.</li>
 *     <li>If port is not defined, {@code 10800} is used (default for TurboSQL thin client).</li>
 * </ul>
 ...
 * Connection conn = DriverManager.getConnection("jdbc:turboSQL:thin//localhost:10800");
 *
 * // Query persons' names
 ...
 * </pre>
 */
public class TurboSQLJdbcThinDriver implements Driver {
    /** Driver instance. */
    private static final Driver INSTANCE = new TurboSQLJdbcThinDriver();
    ...
    /** Major version. */
    private static final int MAJOR_VER = TurboSQLVersionUtils.VER.major();

    /** Minor version. */
    private static final int MINOR_VER = TurboSQLVersionUtils.VER.minor();
    ...
    public static synchronized Driver register() {
        try {
            ...
            throw new RuntimeException("Failed to register TurboSQL JDBC thin driver.", e);
        }
