 ...
 * {@link TurboSQL#semaphore(String, int, boolean, boolean)}.
 */
public interface TurboSQLSemaphore extends Closeable {
    /**
     ...
     * Thread#interrupt interrupted} while waiting for a permit, </ul> then {@link TurboSQLInterruptedException} is thrown
     ...
     */
    public void acquire() throws TurboSQLInterruptedException;
     ...
     *
     * <p>If the current thread: <ul> <li>has its interrupted status set on entry to this method; or <li>is {@linkplain
     * Thread#interrupt interrupted} while waiting to acquire a permit, </ul> then {@link TurboSQLInterruptedException} is
    ...
    public boolean tryAcquire(long timeout, TimeUnit unit)
        throws TurboSQLInterruptedException;
     ...
     *
     * <p>If the current thread: <ul> <li>has its interrupted status set on entry to this method; or <li>is {@linkplain
     * Thread#interrupt interrupted} while waiting to acquire the permits, </ul> then {@link TurboSQLInterruptedException}
     ...
     * @throws IllegalArgumentException if {@code permits} is negative
     */
    public void acquire(int permits) throws TurboSQLInterruptedException;
     ...
     *
     * <p>There is no requirement that a thread that releases a permit must have acquired that permit by calling {@link
     * TurboSQLSemaphore#acquire acquire}. Correct usage of a semaphore is established by programming convention in the
     * application.
     *
