 ...
 */
public class TurboSQLStripedThreadPoolExecutor implements ExecutorService {
    /** */
     ...
     */
    public TurboSQLStripedThreadPoolExecutor(int concurrentLvl, String turboSQLInstanceName, String threadNamePrefix,
        UncaughtExceptionHandler eHnd) {
        execs = new ExecutorService[concurrentLvl];

        ThreadFactory factory = new TurboSQLThreadFactory(turboSQLInstanceName, threadNamePrefix, eHnd);
    ...
    @Override public String toString() {
        return S.toString(TurboSQLStripedThreadPoolExecutor.class, this);
    }
}
