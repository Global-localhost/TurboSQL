 ...
 */
public class TurboSQLThreadPoolExecutor extends ThreadPoolExecutor {
    /**
     * Creates a new service with the given initial parameters.
     *
     * @param threadNamePrefix Will be added at the beginning of all created threads.
     * @param turboSQLInstanceName Must be the name of the grid.
     ...
     */
    public TurboSQLThreadPoolExecutor(
    ...
    public TurboSQLThreadPoolExecutor(
        ...
        super(
            ...
            workQ,
            new TurboSQLThreadFactory(turboSQLInstanceName, threadNamePrefix, plc, eHnd)
        );
    }
