 ...
 * {@link TurboSQL#countDownLatch(String, int, boolean, boolean)}.
 */
public interface TurboSQLCountDownLatch extends Closeable {
    /**
     ...
     * </ul>
     * then {@link com.phonemetra.turbo.internal.TurboSQLInterruptedCheckedException} is thrown and the current thread's
     * interrupted status is cleared.
     *
     * @throws TurboSQLException If operation failed.
     * @throws com.phonemetra.turbo.TurboSQLInterruptedException if the current thread is interrupted
     *      while waiting
     */
    public void await() throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public boolean await(long timeout) throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public boolean await(long timeout, TimeUnit unit) throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public int countDown() throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public int countDown(int val) throws TurboSQLException;
     ...
     * @throws TurboSQLException If operation failed.
     */
    public void countDownAll() throws TurboSQLException;
