...
package com.phonemetra.turbo.util;
...
/**
 * Implementation of {@code TurboSQLPredicate<ClusterNode>} based on
 * {@link TurboSQLConfiguration#getUserAttributes() user attributes}.
 * This filter can be used in methods like {@link ClusterGroup#forPredicate(TurboSQLPredicate)},
 * {@link CacheConfiguration#setNodeFilter(TurboSQLPredicate)},
 * {@link ServiceConfiguration#setNodeFilter(TurboSQLPredicate)}, etc.
 * <p>
 ...
 *     &lt;bean class=&quot;com.phonemetra.turbo.util.ClusterAttributeNodeFilter&quot;&gt;
 ...
 */
public class AttributeNodeFilter implements TurboSQLPredicate<ClusterNode> {
    /** */
