...
public class GridJobExecuteRequest implements ExecutorAwareMessage {
    ...
    @GridToStringInclude
    @GridDirectMap(keyType = UUID.class, valueType = TurboSQLUuid.class)
    private Map<UUID, TurboSQLUuid> ldrParticipants;
    ...
    /** */
    @GridDirectTransient
    private TurboSQLPredicate<ClusterNode> topPred;
    ...
    public GridJobExecuteRequest(
            ...
            Map<UUID, TurboSQLUuid> ldrParticipants,
            boolean forceLocDep,
            boolean sesFullSup,
            boolean internal,
            UUID subjId,
     ...
     */
    public TurboSQLUuid getClassLoaderId() {
        return clsLdrId;
    }
     ...
     */
    public Map<UUID, TurboSQLUuid> getLoaderParticipants() {
     ...
     */
    public TurboSQLPredicate<ClusterNode> getTopologyPredicate() {
        return topPred;
    }
    ...
    @Override public boolean writeTo(ByteBuffer buf, MessageWriter writer) {
        ...
        switch (writer.state()) {
            case 0:
                if (!writer.writeTurboSQLUuid("clsLdrId", clsLdrId))
                    return false;
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        switch (reader.state()) {
            case 0:
                clsLdrId = reader.readTurboSQLUuid("clsLdrId");
