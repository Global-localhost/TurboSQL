...
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetadataInfo;
...
public class JdbcDatabaseMetadata implements DatabaseMetaData {
    /** Driver name. */
    public static final String DRIVER_NAME = "Phonemetra TurboSQL JDBC Driver";
    ...
    JdbcDatabaseMetadata(JdbcConnection conn) {
        ...
        meta = new JdbcMetadataInfo(conn.turboSQL().context());
    }
     ...
     */
    private static class UpdateMetadataTask implements TurboSQLCallable<Collection<GridCacheSqlMetadata>> {
        /** Serial version uid. */
         ...
         */
        public UpdateMetadataTask(String cacheName, TurboSQL turboSQL) {
        ...
        @Override public Collection<GridCacheSqlMetadata> call() throws Exception {
            ...
            return ((TurboSQLCacheProxy)cache).context().queries().sqlMetadataV2();
        }
    }
