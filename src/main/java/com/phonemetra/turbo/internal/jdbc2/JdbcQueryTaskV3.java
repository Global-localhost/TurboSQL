...
class JdbcQueryTaskV3 extends JdbcQueryTaskV2 {
     ...
     */
    public JdbcQueryTaskV3(TurboSQL turboSQL, String cacheName, String schemaName, String sql, Boolean isQry, boolean loc,
    ...
    public static JdbcQueryTask createTask(TurboSQL turboSQL, String cacheName, String schemaName, String sql,
        ...
        if (updateMeta || skipReducerOnUpdate)
            return new JdbcQueryTaskV3(turboSQL, cacheName, schemaName, sql, isQry, loc, args, fetchSize,
                uuid, locQry, collocatedQry, distributedJoins, enforceJoinOrder, lazy, updateMeta, skipReducerOnUpdate);
        else
            return JdbcQueryTaskV2.createTask(turboSQL, cacheName, schemaName, sql, isQry, loc, args, fetchSize,
