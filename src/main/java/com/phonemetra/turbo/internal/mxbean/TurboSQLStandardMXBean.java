...
package com.phonemetra.turbo.internal.mxbean;
 ...
 */
public class TurboSQLStandardMXBean extends StandardMBean {
    /**
     ...
     *    specified interface.
     */
    public <T> TurboSQLStandardMXBean(T implementation, Class<T> mbeanInterface)
