...
public class GridJobCancelRequest implements Message {
     ...
     */
    public GridJobCancelRequest(TurboSQLUuid sesId) {
        assert sesId != null;
     ...
     * @param jobId Job ID.
     */
    public GridJobCancelRequest(@Nullable TurboSQLUuid sesId, @Nullable TurboSQLUuid jobId) {
     ...
     */
    public GridJobCancelRequest(@Nullable TurboSQLUuid sesId, @Nullable TurboSQLUuid jobId, boolean sys) {
        assert sesId != null || jobId != null;
     ...
     */
    @Nullable public TurboSQLUuid sessionId() {
        return sesId;
    }
     ...
     */
    @Nullable public TurboSQLUuid jobId() {
        return jobId;
    }
