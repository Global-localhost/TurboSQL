...
package com.phonemetra.turbo.internal.sql.optimizer.affinity;
...
public class PartitionParameterNode extends PartitionSingleNode {
    ...
    /** {@inheritDoc} */
    @Override public Integer applySingle(PartitionClientContext cliCtx, Object... args) throws TurboSQLCheckedException {
        assert args != null;
