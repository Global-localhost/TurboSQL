...
import com.phonemetra.turbo.internal.sql.command.SqlQualifiedName;
import com.phonemetra.turbo.internal.util.typedef.F;

import static com.phonemetra.turbo.internal.sql.SqlKeyword.EXISTS;
import static com.phonemetra.turbo.internal.sql.SqlKeyword.IF;
import static com.phonemetra.turbo.internal.sql.SqlKeyword.NOT;
...
public class SqlParserUtils {
    ...
    public static SqlParseException error(SqlLexerToken token, String msg) {
        return error0(token, TurboSQLQueryErrorCode.PARSING, msg);
    }
    ...
    public static SqlParseException errorUnsupported(SqlLexerToken token) {
        return error0(token, TurboSQLQueryErrorCode.UNSUPPORTED_OPERATION,
