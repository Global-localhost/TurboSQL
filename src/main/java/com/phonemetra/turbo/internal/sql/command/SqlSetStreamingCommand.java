...
import static com.phonemetra.turbo.internal.sql.SqlParserUtils.parseBoolean;
...
public class SqlSetStreamingCommand implements SqlCommand {
    ...
    private static final int DFLT_STREAM_BATCH_SIZE = TurboSQLDataStreamer.DFLT_PER_NODE_BUFFER_SIZE * 4;
