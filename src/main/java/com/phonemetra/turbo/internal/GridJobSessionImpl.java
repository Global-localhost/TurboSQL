...
public class GridJobSessionImpl implements GridTaskSessionInternal {
    ...
    /** Job ID. */
    private final TurboSQLUuid jobId;
     ...
     * @param jobId Job ID.
     */
    public GridJobSessionImpl(GridKernalContext ctx, GridTaskSessionImpl ses, TurboSQLUuid jobId) {
        assert ctx != null;
        assert ses != null;
        assert jobId != null;
    ...
    @Override public TurboSQLFuture<?> mapFuture() {
        return new TurboSQLFinishedFutureImpl<>(null);
    }
