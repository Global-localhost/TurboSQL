...
public class VisorClientConnectorConfiguration extends VisorDataTransferObject {
    ...
    /** If to use SSL context factory from TurboSQL configuration. */
    private boolean useTurboSQLSslCtxFactory;
    ...
    public VisorClientConnectorConfiguration(ClientConnectorConfiguration cfg) {
        ...
        useTurboSQLSslCtxFactory = cfg.isUseTurboSQLSslContextFactory();
    ...
    /**
     * @return If to use SSL context factory from TurboSQL configuration.
     */
    public boolean isUseTurboSQLSslContextFactory() {
        return useTurboSQLSslCtxFactory;
    }
    ...
    @Override protected void writeExternalData(ObjectOutput out) throws IOException {
        ...
        out.writeBoolean(useTurboSQLSslCtxFactory);
    ...
    @Override protected void readExternalData(byte protoVer, ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if (protoVer > V1) {
            ...
            useTurboSQLSslCtxFactory = in.readBoolean();
