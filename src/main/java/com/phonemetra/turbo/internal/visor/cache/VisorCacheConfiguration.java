...
import com.phonemetra.turbo.configuration.DiskPageCompression;
...
import com.phonemetra.turbo.internal.visor.query.VisorQueryConfiguration;
import com.phonemetra.turbo.internal.visor.query.VisorQueryEntity;
...
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.compactIterable;
...
public class VisorCacheConfiguration extends VisorDataTransferObject {
    ...
    private TurboSQLUuid dynamicDeploymentId;
     ...
     */
    public VisorCacheConfiguration(TurboSQLEx turboSQL, CacheConfiguration ccfg, TurboSQLUuid dynamicDeploymentId) {
        name = ccfg.getName();
        ...
        sys = turboSQL.context().cache().systemCache(ccfg.getName());
        ...
        storeCfg = new VisorCacheStoreConfiguration(turboSQL, ccfg);
     ...
     */
    public TurboSQLUuid getDynamicDeploymentId() {
