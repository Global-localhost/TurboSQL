...
/**
 * Base class for lightweight counterpart for various {@link com.phonemetra.turbo.events.Event}.
 */
public class VisorGridEvent extends VisorDataTransferObject {
     ...
     */
    public VisorGridEvent(int typeId, TurboSQLUuid id, String name, UUID nid, long ts, @Nullable String msg,
        String shortDisplay) {
        this.typeId = typeId;
        this.id = id;
        this.name = name;
