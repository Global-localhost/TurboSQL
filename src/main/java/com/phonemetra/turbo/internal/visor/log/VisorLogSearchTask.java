...
import com.phonemetra.turbo.internal.util.io.GridReversedLinesFileReader;
...
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.decode;
...
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.resolveSymbolicLink;
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.textFile;
...
public class VisorLogSearchTask extends VisorMultiNodeTask<VisorLogSearchTaskArg, VisorLogSearchTaskResult,
    ...
    private static class VisorLogSearchJob extends VisorJob<VisorLogSearchTaskArg, Collection<VisorLogSearchResult>> {
        ...
        @Override protected Collection<VisorLogSearchResult> run(VisorLogSearchTaskArg arg) {
            try {
                File folder = resolveTurboSQLPath(arg.getFolder());
                ...
                UUID uuid = turboSQL.localNode().id();
