...
import static com.phonemetra.turbo.events.EventType.EVTS_JOB_EXECUTION;
import static com.phonemetra.turbo.events.EventType.EVTS_TASK_EXECUTION;
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.concat;
...
public class VisorNodeEventsCollectorTaskArg extends VisorDataTransferObject {
    ...
    private TurboSQLUuid taskSesId;
    ...
    public VisorNodeEventsCollectorTaskArg(@Nullable String keyOrder, @Nullable int[] typeArg,
        ...
        @Nullable String taskName, @Nullable TurboSQLUuid taskSesId) {
    ...
    public static VisorNodeEventsCollectorTaskArg createTasksArg(@Nullable Long timeArg, @Nullable String taskName,
        @Nullable TurboSQLUuid taskSesId) {
     ...
     */
    public TurboSQLUuid getTaskSessionId() {
        return taskSesId;
    }
