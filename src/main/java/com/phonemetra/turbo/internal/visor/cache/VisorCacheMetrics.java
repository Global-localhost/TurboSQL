...
import com.phonemetra.turbo.internal.visor.query.VisorQueryMetrics;
...
public class VisorCacheMetrics extends VisorDataTransferObject {
     ...
     */
    public VisorCacheMetrics(TurboSQLEx turboSQL, String cacheName) {
        GridCacheProcessor cacheProcessor = turboSQL.context().cache();

        TurboSQLCache<Object, Object> c = cacheProcessor.jcache(cacheName);
