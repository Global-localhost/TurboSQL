...
import com.phonemetra.turbo.configuration.HadoopConfiguration;
...
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.compactArray;
...
public class VisorGridConfiguration extends VisorDataTransferObject {
     ...
     * @param turboSQL Grid.
     */
    public VisorGridConfiguration(TurboSQLEx turboSQL) {
        assert turboSQL != null;

        TurboSQLConfiguration c = turboSQL.configuration();

        basic = new VisorBasicConfiguration(turboSQL, c);
        ...
        sysProps = TurboSQLSystemProperties.snapshot();
