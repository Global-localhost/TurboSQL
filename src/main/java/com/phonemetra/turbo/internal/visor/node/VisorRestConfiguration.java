...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_JETTY_HOST;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_JETTY_PORT;
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.compactClass;
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.intValue;
...
public class VisorRestConfiguration extends VisorDataTransferObject {
     ...
     */
    public VisorRestConfiguration(TurboSQLConfiguration c) {
        assert c != null;
