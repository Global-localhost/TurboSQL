...
import com.phonemetra.turbo.cache.store.jdbc.CacheAbstractJdbcStore;
...
public class VisorCacheStoreConfiguration extends VisorDataTransferObject {
     ...
     */
    public VisorCacheStoreConfiguration(TurboSQLEx turboSQL, CacheConfiguration ccfg) {
        TurboSQLCacheProxy<Object, Object> c = turboSQL.context().cache().jcache(ccfg.getName());
