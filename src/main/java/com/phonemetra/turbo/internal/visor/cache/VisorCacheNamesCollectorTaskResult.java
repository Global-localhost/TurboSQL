...
public class VisorCacheNamesCollectorTaskResult extends VisorDataTransferObject {
    ...
    private Map<String, TurboSQLUuid> caches;
     ...
     */
    public VisorCacheNamesCollectorTaskResult(Map<String, TurboSQLUuid> caches, Set<String> groups) {
        this.caches = caches;
        this.groups = groups;
    }
     ...
     */
    public Map<String, TurboSQLUuid> getCaches() {
        return caches;
    }
