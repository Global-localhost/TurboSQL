...
public class VisorCacheLoadTaskArg extends VisorDataTransferObject {
    ...
    /** Optional user arguments to be passed into CacheStore.loadCache(TurboSQLBiInClosure, Object...) method. */
     ...
     * @param ldrArgs Optional user arguments to be passed into CacheStore.loadCache(TurboSQLBiInClosure, Object...) method.
     */
    ...
    /**
     * @return Optional user arguments to be passed into CacheStore.loadCache(TurboSQLBiInClosure, Object...) method.
     */
