...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_QUIET;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_SUCCESS_FILE;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_UPDATE_NOTIFIER;
import static com.phonemetra.turbo.internal.visor.util.VisorTaskUtils.boolValue;
...
public class VisorBasicConfiguration extends VisorDataTransferObject {
    ...
    /** TURBOSQL_HOME determined at startup. */
    ...
    /** TurboSQL work folder. */
    private String turboSQLWorkDir;
     ...
     */
    public VisorBasicConfiguration(TurboSQLEx turboSQL, TurboSQLConfiguration c) {
        turboSQLInstanceName = c.getTurboSQLInstanceName();
        ggHome = getProperty(TURBOSQL_HOME, c.getTurboSQLHome());
        ...
        jmxRemote = turboSQL.isJmxRemoteEnabled();
        restart = turboSQL.isRestartEnabled();
        ...
        turboSQLWorkDir = c.getWorkDirectory();
    ...
    /**
     * @return TurboSQL instance name.
     */
    @Nullable public String getTurboSQLInstanceName() {
        return turboSQLInstanceName;
    }

    /**
     * @return TURBOSQL_HOME determined at startup.
     */
    ...
    /**
     * @return TurboSQL work directory.
     */
    public String getWorkDirectory() {
        return turboSQLWorkDir;
    }
    ...
    @Override protected void writeExternalData(ObjectOutput out) throws IOException {
        ...
        U.writeString(out, turboSQLWorkDir);
    ...
    @Override protected void readExternalData(byte protoVer, ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        turboSQLWorkDir = U.readString(in);
