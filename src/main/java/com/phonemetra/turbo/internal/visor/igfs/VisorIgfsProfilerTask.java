...
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.DELIM_FIELD;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.HDR;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.TYPE_CLOSE_IN;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.TYPE_CLOSE_OUT;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.TYPE_OPEN_IN;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.TYPE_OPEN_OUT;
import static com.phonemetra.turbo.internal.igfs.common.IgfsLogger.TYPE_RANDOM_READ;
...
public class VisorIgfsProfilerTask extends VisorOneNodeTask<VisorIgfsProfilerTaskArg, List<VisorIgfsProfilerEntry>> {
    ...
    private static class VisorIgfsProfilerJob extends VisorJob<VisorIgfsProfilerTaskArg, List<VisorIgfsProfilerEntry>> {
        ...
        @Override protected List<VisorIgfsProfilerEntry> run(VisorIgfsProfilerTaskArg arg) {
            ...
            try {
                Path logsDir = resolveIgfsProfilerLogsDir(turboSQL.fileSystem(name));
                ...
                throw new TurboSQLException("Failed to parse profiler logs for IGFS: " + name, e);
            }
                ...
                for (Path p : dirStream) {
                    if (matcher.matches(p.getFileName())) {
                        try {
                            ...
                            turboSQL.log().warning("Failed to parse IGFS profiler log file: " + p, e);
                        }
                    }
                }
            }
