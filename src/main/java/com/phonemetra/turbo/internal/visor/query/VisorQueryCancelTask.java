...
public class VisorQueryCancelTask extends VisorOneNodeTask<VisorQueryCancelTaskArg, Void> {
    ...
    /** {@inheritDoc} */
    @Nullable @Override protected Void reduce0(List<ComputeJobResult> results) throws TurboSQLException {
        return null;
    }
    ...
    private static class VisorCancelQueriesJob extends VisorJob<VisorQueryCancelTaskArg, Void> {
        ...
        /** {@inheritDoc} */
        @Override protected Void run(@Nullable VisorQueryCancelTaskArg arg) throws TurboSQLException {
            turboSQL.context().query().cancelQueries(Collections.singleton(arg.getQueryId()));
