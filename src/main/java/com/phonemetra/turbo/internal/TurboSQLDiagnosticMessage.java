...
import com.phonemetra.turbo.internal.managers.communication.GridIoMessageFactory;
...
import com.phonemetra.turbo.internal.processors.cache.GridCacheMapEntry;
...
import com.phonemetra.turbo.internal.processors.cache.distributed.dht.GridDhtTopologyFuture;
import com.phonemetra.turbo.internal.processors.cache.distributed.dht.preloader.GridDhtPartitionsExchangeFuture;
 ...
 *
 */
public class TurboSQLDiagnosticMessage implements Message {
    /** */
     ...
     */
    public TurboSQLDiagnosticMessage() {
        // No-op.
    }
     ...
     */
    public static TurboSQLDiagnosticMessage createRequest(Marshaller marsh,
        TurboSQLClosure<GridKernalContext, TurboSQLDiagnosticInfo> c,
        long futId)
        throws TurboSQLCheckedException
    {
        byte[] cBytes = U.marshal(marsh, c);

        TurboSQLDiagnosticMessage msg = new TurboSQLDiagnosticMessage();
     ...
     */
    public static TurboSQLDiagnosticMessage createResponse(byte[] resBytes, long futId) {
        TurboSQLDiagnosticMessage msg = new TurboSQLDiagnosticMessage();
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        return reader.afterMessageRead(TurboSQLDiagnosticMessage.class);
    }
     ...
     *
     */
    public abstract static class DiagnosticBaseClosure implements TurboSQLBiInClosure<StringBuilder, GridKernalContext> {
        /**
    ...
    public static final class TxInfoClosure extends DiagnosticBaseClosure {
        ...
        @Override public void apply(StringBuilder sb, GridKernalContext ctx) {
            ...
            for (TurboSQLInternalTx tx : ctx.cache().context().tm().activeTransactions()) {
     ...
     */
    public static TurboSQLInternalFuture<String> dumpCommunicationInfo(GridKernalContext ctx, UUID nodeId) {
    ...
    @Override public String toString() {
        return S.toString(TurboSQLDiagnosticMessage.class, this);
    }
}
