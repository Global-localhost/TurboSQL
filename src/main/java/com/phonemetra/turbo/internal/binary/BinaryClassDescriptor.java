...
import static com.phonemetra.turbo.internal.processors.query.QueryUtils.isGeometryClass;
...
public class BinaryClassDescriptor {
    ...
    BinaryClassDescriptor(
        ...
        if (useOptMarshaller && userType && !U.isTurboSQL(cls) && !U.isJdk(cls) && !QueryUtils.isGeometryClass(cls)) {
