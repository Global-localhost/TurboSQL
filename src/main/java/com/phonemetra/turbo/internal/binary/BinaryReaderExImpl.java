...
import com.phonemetra.turbo.binary.BinaryCollectionFactory;
import com.phonemetra.turbo.binary.BinaryInvalidTypeException;
import com.phonemetra.turbo.binary.BinaryMapFactory;
...
import com.phonemetra.turbo.binary.BinaryReader;
...
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BINARY_ENUM;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BINARY_OBJ;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BOOLEAN;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BOOLEAN_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BYTE;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.BYTE_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.CHAR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.CHAR_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.CLASS;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.COL;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DATE;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DATE_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DECIMAL;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DECIMAL_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DFLT_HDR_LEN;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DOUBLE;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.DOUBLE_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.ENUM;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.ENUM_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.FLOAT;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.FLOAT_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.HANDLE;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.INT;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.INT_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.LONG;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.LONG_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.MAP;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.NULL;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.OBJ;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.OBJ_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.OPTM_MARSH;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.PROXY;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.SHORT;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.SHORT_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.STRING;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.STRING_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.TIME;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.TIMESTAMP;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.TIMESTAMP_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.TIME_ARR;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.UNREGISTERED_TYPE_ID;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.UUID;
import static com.phonemetra.turbo.internal.binary.GridBinaryMarshaller.UUID_ARR;
...
public class BinaryReaderExImpl implements BinaryReader, BinaryRawReaderEx, BinaryReaderHandlesHolder, ObjectInput {
    ...
    @Nullable Object deserialize() throws BinaryObjectException {
        String newName = ctx.configuration().getTurboSQLInstanceName();
        String oldName = TurboSQLUtils.setCurrentTurboSQLName(newName);

        try {
            return deserialize0();
        }
        finally {
            TurboSQLUtils.restoreOldTurboSQLName(oldName, newName);
        }
    }
