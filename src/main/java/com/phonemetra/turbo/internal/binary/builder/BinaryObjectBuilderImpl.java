...
package com.phonemetra.turbo.internal.binary.builder;
...
import com.phonemetra.turbo.internal.binary.BinaryObjectImpl;
...
import com.phonemetra.turbo.internal.binary.BinaryFieldMetadata;
import com.phonemetra.turbo.internal.binary.BinarySchema;
import com.phonemetra.turbo.internal.binary.BinarySchemaRegistry;
import com.phonemetra.turbo.internal.binary.BinaryObjectOffheapImpl;
...
public class BinaryObjectBuilderImpl implements BinaryObjectBuilder {
    ...
    @Override public BinaryObject build() {
        try (BinaryWriterExImpl writer = new BinaryWriterExImpl(ctx)) {
            ...
            if (curThread instanceof TurboSQLThread)
                writer.failIfUnregistered(((TurboSQLThread)curThread).isForbiddenToRequestBinaryMetadata());
    ...
    void serializeTo(BinaryWriterExImpl writer, BinaryBuilderSerializer serializer) {
        try {
            ...
            if (reader != null && BinaryUtils.hasSchema(flags)) {
                ...
                TurboSQLBiTuple<Integer, Integer> footer = BinaryUtils.footerAbsolute(reader, start);
     ...
     */
    private TurboSQLBiTuple<Integer, Integer> fieldPositionAndLength(int footerPos, int footerEnd, int rawPos,
    ...
    private void ensureReadCacheInit() {
        ...
        if (readCache == null) {
            ...
            while (footerPos + fieldIdLen < footerEnd) {
                ...
                TurboSQLBiTuple<Integer, Integer> posAndLen =
