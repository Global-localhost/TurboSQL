...
import com.phonemetra.turbo.internal.binary.builder.BinaryObjectBuilderImpl;
...
public abstract class BinaryObjectExImpl implements BinaryObjectEx {
     ...
     * @return Field value.
     * @throws com.phonemetra.turbo.binary.BinaryObjectException In case of any other error.
     */
    ...
    @Override public String toString() {
        try {
            ...
            throw new TurboSQLException("Failed to create string representation of binary object.", e);
        }
    }
    ...
    private String toString(BinaryReaderHandles ctx, IdentityHashMap<BinaryObject, Integer> handles) {
        ...
        TurboSQLThread.onForbidBinaryMetadataRequestSectionEntered();
        ...
        try {
            ...
            TurboSQLThread.onForbidBinaryMetadataRequestSectionLeft();
        }
    ...
    private void appendValue(Object val, SB buf, BinaryReaderHandles ctx,
        ...
        else if (val instanceof TurboSQLUuid)
            buf.a(val);
    ...
    public boolean hasCircularReferences() {
        try {
            ...
            throw new TurboSQLException("Failed to check binary object for circular references", e);
        }
    }
