...
import com.phonemetra.turbo.internal.binary.streams.BinaryOffheapInputStream;
...
public class BinaryObjectOffheapImpl extends BinaryObjectExImpl implements Externalizable, CacheObject {
    ...
    /** {@inheritDoc} */
    @Override public byte[] valueBytes(CacheObjectValueContext ctx) throws TurboSQLCheckedException {
        throw new UnsupportedOperationException();
    }
