...
import com.phonemetra.turbo.marshaller.AbstractNodeNameAwareMarshaller;
import org.jetbrains.annotations.Nullable;
import sun.misc.Unsafe;

/**
 * Implementation of {@link com.phonemetra.turbo.marshaller.Marshaller} that lets to serialize and deserialize all objects
...
public class BinaryMarshaller extends AbstractNodeNameAwareMarshaller {
     ...
     */
    private void setBinaryContext(BinaryContext ctx, TurboSQLConfiguration cfg) {
    ...
    /** {@inheritDoc} */
    @Override protected byte[] marshal0(@Nullable Object obj) throws TurboSQLCheckedException {
        return impl.marshal(obj, false);
    }

    /** {@inheritDoc} */
    @Override protected void marshal0(@Nullable Object obj, OutputStream out) throws TurboSQLCheckedException {
    ...
    /** {@inheritDoc} */
    @Override protected <T> T unmarshal0(byte[] bytes, @Nullable ClassLoader clsLdr) throws TurboSQLCheckedException {
        return impl.deserialize(bytes, clsLdr);
    }

    /** {@inheritDoc} */
    @Override protected <T> T unmarshal0(InputStream in, @Nullable ClassLoader clsLdr) throws TurboSQLCheckedException {
