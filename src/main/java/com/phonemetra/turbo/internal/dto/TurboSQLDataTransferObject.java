...
package com.phonemetra.turbo.internal.dto;
 ...
 */
public abstract class TurboSQLDataTransferObject implements Externalizable {
    /** */
    ...
    @Override public void writeExternal(ObjectOutput out) throws IOException {
        ...
        try (TurboSQLDataTransferObjectOutput dtout = new TurboSQLDataTransferObjectOutput(out)) {
    ...
    @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if ((hdr & MAGIC) != MAGIC)
            throw new IOException("Unexpected TurboSQLDataTransferObject header " +
                "[actual=" + Integer.toHexString(hdr) + ", expected=" + Integer.toHexString(MAGIC) + "]");

        byte ver = (byte)(hdr & 0xFF);

        try (TurboSQLDataTransferObjectInput dtin = new TurboSQLDataTransferObjectInput(in)) {
