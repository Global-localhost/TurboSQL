...
public enum TurboSQLFeatures {
     ...
     */
    TurboSQLFeatures(int featureId) {
     ...
     */
    public static boolean allNodesSupports(Iterable<ClusterNode> nodes, TurboSQLFeatures feature) {
    ...
    public static byte[] allFeatures() {
        ...
        for (TurboSQLFeatures value : TurboSQLFeatures.values()) {
