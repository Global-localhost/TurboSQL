 ...
 * <p>
 * You can get an instance of {@code ClusterNodeLocalMapImpl} by calling {@link TurboSQLCluster#nodeLocalMap()} method.
 */
public class ClusterNodeLocalMapImpl<K, V> extends ConcurrentHashMap<K, V> implements ConcurrentMap<K, V>,
    ...
    @Override public void writeExternal(ObjectOutput out) throws IOException {
        U.writeString(out, ctx.turboSQLInstanceName());
    }
    ...
    protected Object readResolve() throws ObjectStreamException {
        try {
            return IgnitionEx.localTurboSQL().cluster().nodeLocalMap();
        }
