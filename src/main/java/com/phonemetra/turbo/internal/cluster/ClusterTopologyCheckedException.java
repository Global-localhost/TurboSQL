 ...
 */
public class ClusterTopologyCheckedException extends TurboSQLCheckedException {
    /** */
    private static final long serialVersionUID = 0L;

    /** Next topology version to wait. */
    private transient TurboSQLInternalFuture<?> readyFut;
     ...
     */
    public TurboSQLInternalFuture<?> retryReadyFuture() {
        return readyFut;
    }
     ...
     */
    public void retryReadyFuture(TurboSQLInternalFuture<?> readyFut) {
