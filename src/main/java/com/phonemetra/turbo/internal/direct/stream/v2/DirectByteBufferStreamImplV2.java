...
package com.phonemetra.turbo.internal.direct.stream.v2;
...
import static com.phonemetra.turbo.internal.util.GridUnsafe.BIG_ENDIAN;
import static com.phonemetra.turbo.internal.util.GridUnsafe.BYTE_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.CHAR_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.DOUBLE_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.FLOAT_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.INT_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.LONG_ARR_OFF;
import static com.phonemetra.turbo.internal.util.GridUnsafe.SHORT_ARR_OFF;
...
public class DirectByteBufferStreamImplV2 implements DirectByteBufferStream {
    ...
    private static final ArrayCreator<byte[]> BYTE_ARR_CREATOR = new ArrayCreator<byte[]>() {
        @Override public byte[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid byte array length: " + len);
    ...
    private static final ArrayCreator<short[]> SHORT_ARR_CREATOR = new ArrayCreator<short[]>() {
        @Override public short[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid short array length: " + len);
    ...
    private static final ArrayCreator<int[]> INT_ARR_CREATOR = new ArrayCreator<int[]>() {
        @Override public int[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid int array length: " + len);
    ...
    private static final ArrayCreator<long[]> LONG_ARR_CREATOR = new ArrayCreator<long[]>() {
        @Override public long[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid long array length: " + len);
    ...
    private static final ArrayCreator<float[]> FLOAT_ARR_CREATOR = new ArrayCreator<float[]>() {
        @Override public float[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid float array length: " + len);
    ...
    private static final ArrayCreator<double[]> DOUBLE_ARR_CREATOR = new ArrayCreator<double[]>() {
        @Override public double[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid double array length: " + len);
    ...
    private static final ArrayCreator<char[]> CHAR_ARR_CREATOR = new ArrayCreator<char[]>() {
        @Override public char[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid char array length: " + len);
    ...
    private static final ArrayCreator<boolean[]> BOOLEAN_ARR_CREATOR = new ArrayCreator<boolean[]>() {
        @Override public boolean[] create(int len) {
            if (len < 0)
                throw new TurboSQLException("Read invalid boolean array length: " + len);
    ...
    @Override public TurboSQLUuid readTurboSQLUuid() {
        ...
        TurboSQLUuid val = new TurboSQLUuid(new UUID(uuidMost, uuidLeast), uuidLocId);
