...
package com.phonemetra.turbo.internal.direct;
...
import com.phonemetra.turbo.internal.direct.state.DirectMessageState;
import com.phonemetra.turbo.internal.direct.state.DirectMessageStateItem;
import com.phonemetra.turbo.internal.direct.stream.DirectByteBufferStream;
import com.phonemetra.turbo.internal.direct.stream.v1.DirectByteBufferStreamImplV1;
import com.phonemetra.turbo.internal.direct.stream.v2.DirectByteBufferStreamImplV2;
import com.phonemetra.turbo.internal.direct.stream.v3.DirectByteBufferStreamImplV3;
...
public class DirectMessageWriter implements MessageWriter {
    ...
    public DirectMessageWriter(final byte protoVer) {
        state = new DirectMessageState<>(StateItem.class, new TurboSQLOutClosure<StateItem>() {
    ...
    /** {@inheritDoc} */
    @Override public boolean writeTurboSQLUuid(String name, TurboSQLUuid val) {
        DirectByteBufferStream stream = state.item().stream;

        stream.writeTurboSQLUuid(val);
