...
package com.phonemetra.turbo.internal.direct.state;
...
public class DirectMessageState<T extends DirectMessageStateItem> {
    ...
    /** Item factory. */
    @GridToStringExclude
    private final TurboSQLOutClosure<T> factory;
     ...
     */
    public DirectMessageState(Class<T> cls, TurboSQLOutClosure<T> factory) {
