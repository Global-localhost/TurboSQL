...
public class IoStatisticsManager {
    ...
    private IoStatisticsHolder register(IoStatisticsType type, String name, Object param) {
        if (statByType.isEmpty())
            throw new TurboSQLIllegalStateException("IO Statistics manager has been stopped and can'be used");
        ...
        switch (type) {
            ...
            default:
                throw new TurboSQLException("Gathering IO statistics for " + type + "doesn't support");
        }
