 ...
 */
public final class TurboSQLNodeAttributes {
    /** Prefix for internally reserved attribute names. */
    public static final String ATTR_PREFIX = "com.phonemetra.turbo";
    ...
    /** TurboSQL security compatibility mode. */
     ...
     * Enforces singleton.
     */
    private TurboSQLNodeAttributes() {
        /* No-op. */
    }
}
