...
import com.phonemetra.turbo.internal.processors.cache.GridCacheSharedManager;
import com.phonemetra.turbo.internal.processors.cache.StoredCacheData;
import com.phonemetra.turbo.internal.processors.cache.persistence.AllocatedPageTracker;
import com.phonemetra.turbo.internal.processors.cluster.TurboSQLChangeGlobalStateSupport;

/**
 *
 */
public interface TurboSQLPageStoreManager extends GridCacheSharedManager, TurboSQLChangeGlobalStateSupport {
    /**
     ...
     */
    public void finishRecover() throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to handle cache start callback.
     */
     ...
     */
    public void initializeForMetastorage() throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to handle cache destroy callback.
     */
    public void shutdownForCacheGroup(CacheGroupContext grp, boolean destroy) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to handle partition create callback.
     */
    public void onPartitionCreated(int grpId, int partId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to handle partition destroy callback.
     */
    public void onPartitionDestroyed(int grpId, int partId, int tag) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to read the page.
     */
    public void read(int grpId, long pageId, ByteBuffer pageBuf) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public boolean exists(int grpId, int partId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public void readHeader(int grpId, int partId, ByteBuffer buf) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed to write page.
     */
    public void write(int grpId, long pageId, ByteBuffer pageBuf, int tag) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public long pageOffset(int grpId, long pageId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If IO error occurred while running sync.
     */
    public void sync(int grpId, int partId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public void ensure(int grpId, int partId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If IO exception occurred while allocating a page ID.
     */
    public long allocatePage(int grpId, int partId, byte flags) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public int pages(int grpId, int partId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public Map<String, StoredCacheData> readCacheConfigurations() throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public void storeCacheData(StoredCacheData cacheData, boolean overwrite) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public void removeCacheData(StoredCacheData cacheData) throws TurboSQLCheckedException;
     ...
     */
    public void cleanupPersistentSpace(CacheConfiguration cacheConfiguration) throws TurboSQLCheckedException;

    /**
     * Cleanup persistent space for all caches except metastore.
     */
    public void cleanupPersistentSpace() throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public boolean checkAndInitCacheWorkDir(CacheConfiguration cacheCfg) throws TurboSQLCheckedException;
}
