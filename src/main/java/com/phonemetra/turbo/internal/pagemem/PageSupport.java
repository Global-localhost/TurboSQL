...
package com.phonemetra.turbo.internal.pagemem;
...
public interface PageSupport {
     ...
     */
    public long acquirePage(int grpId, long pageId) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public long acquirePage(int grpId, long pageId, IoStatisticsHolder statHolder) throws TurboSQLCheckedException;
