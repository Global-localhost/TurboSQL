...
import com.phonemetra.turbo.internal.pagemem.FullPageId;
import com.phonemetra.turbo.internal.pagemem.PageMemory;
import com.phonemetra.turbo.internal.pagemem.wal.record.WALRecord;
import com.phonemetra.turbo.internal.pagemem.wal.record.WalRecordCacheGroupAware;
...
public abstract class PageDeltaRecord extends WALRecord implements WalRecordCacheGroupAware {
     ...
     */
    public abstract void applyDelta(PageMemory pageMem, long pageAddr) throws TurboSQLCheckedException;
