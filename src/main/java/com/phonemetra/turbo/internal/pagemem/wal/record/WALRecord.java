...
import com.phonemetra.turbo.configuration.WALMode;
...
import static com.phonemetra.turbo.internal.pagemem.wal.record.WALRecord.RecordPurpose.*;
...
public abstract class WALRecord {
    ...
    public enum RecordPurpose {
        ...
        INTERNAL,
        /**
         * Physical records are needed for correct recovering physical state of {@link com.phonemetra.turbo.internal.pagemem.PageMemory}.
         * {@link com.phonemetra.turbo.internal.processors.cache.persistence.GridCacheDatabaseSharedManager#restoreBinaryMemory(com.phonemetra.turbo.lang.TurboSQLPredicate, com.phonemetra.turbo.lang.TurboSQLBiPredicate)}.
         */
        PHYSICAL,
        /**
         * Logical records are needed to replay logical updates since last checkpoint.
         * {@link GridCacheDatabaseSharedManager#applyLogicalUpdates(com.phonemetra.turbo.internal.processors.cache.persistence.GridCacheDatabaseSharedManager.CheckpointStatus, com.phonemetra.turbo.lang.TurboSQLPredicate, com.phonemetra.turbo.lang.TurboSQLBiPredicate, boolean)}
         */
        LOGICAL,
        /**
