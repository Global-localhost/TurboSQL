    ...
    @Override public KeyCacheObject key() {
        try {
            if (key == null) {
                ...
                if (cacheCtx == null)
                    throw new TurboSQLException("Failed to find cache context for the given cache ID: " + cacheId);

                TurboSQLCacheObjectProcessor co = cctx.kernalContext().cacheObjects();
