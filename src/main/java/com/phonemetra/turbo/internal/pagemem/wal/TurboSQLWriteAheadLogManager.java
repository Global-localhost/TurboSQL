...
package com.phonemetra.turbo.internal.pagemem.wal;

import com.phonemetra.turbo.TurboSQLCheckedException;
import com.phonemetra.turbo.TurboSQLException;
import com.phonemetra.turbo.internal.pagemem.wal.record.RolloverType;
import com.phonemetra.turbo.internal.pagemem.wal.record.WALRecord;
 ...
 *
 */
public interface TurboSQLWriteAheadLogManager extends GridCacheSharedManager, TurboSQLChangeGlobalStateSupport {
    /**
     ...
     *
     * @throws TurboSQLCheckedException If fails.
     */
    public void resumeLogging(WALPointer lastWrittenPtr) throws TurboSQLCheckedException;
     ...
     *      written to the log.
     * @throws TurboSQLCheckedException If failed to construct log entry.
     * @throws StorageException If IO error occurred while writing log entry.
     */
    public WALPointer log(WALRecord entry) throws TurboSQLCheckedException, StorageException;
    ...
    public WALPointer log(WALRecord entry, RolloverType rolloverType)
        throws TurboSQLCheckedException, StorageException;
     ...
     * @throws TurboSQLCheckedException If failed to write.
     ...
     */
    public void flush(WALPointer ptr, boolean explicitFsync) throws TurboSQLCheckedException, StorageException;
     ...
     * @return WAL record.
     * @throws TurboSQLCheckedException If failed to read.
     * @throws StorageException If IO error occurred while reading WAL entries.
     */
    public WALRecord read(WALPointer ptr) throws TurboSQLCheckedException, StorageException;
     ...
     * @throws TurboSQLException If failed to start iteration.
     * @throws StorageException If IO error occurred while reading WAL entries.
     */
    public WALIterator replay(WALPointer start) throws TurboSQLCheckedException, StorageException;
    ...
    public WALIterator replay(
        WALPointer start,
        @Nullable TurboSQLBiPredicate<WALRecord.RecordType, WALPointer> recordDeserializeFilter
    ) throws TurboSQLCheckedException, StorageException;
     ...
     *
     * @param start WAL pointer.
     * @throws TurboSQLException If failed to release.
     */
    public void release(WALPointer start) throws TurboSQLCheckedException;
