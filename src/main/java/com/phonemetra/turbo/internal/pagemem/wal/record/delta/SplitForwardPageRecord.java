...
public class SplitForwardPageRecord extends PageDeltaRecord {
    ...
    public SplitForwardPageRecord(
        ...
        throw new TurboSQLException("Split forward page record should not be used directly (see GG-11640). " +
    ...
    @Override public void applyDelta(PageMemory pageMem, long pageAddr) throws TurboSQLCheckedException {
        throw new TurboSQLCheckedException("Split forward page record should not be logged.");
    }
