...
public class GridJobContextImpl implements ComputeJobContext, Externalizable {
    ...
    /** */
    private static final AtomicReference<TurboSQLLogger> logRef = new AtomicReference<>();

    /** Logger. */
    private static TurboSQLLogger log;
     ...
     * @param jobId Job ID.
     */
    public GridJobContextImpl(@Nullable GridKernalContext ctx, TurboSQLUuid jobId) {
        assert jobId != null;
     ...
     */
    public GridJobContextImpl(GridKernalContext ctx, TurboSQLUuid jobId,
