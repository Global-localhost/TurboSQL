...
/**
 * Interface for all main internal TurboSQL components (managers and processors).
 */
public interface GridComponent {
     ...
     * @throws TurboSQLCheckedException Thrown in case of any errors.
     */
    public void onKernalStart(boolean active) throws TurboSQLCheckedException;
    ...
    /** */
    @Nullable public TurboSQLNodeValidationResult validateNode(ClusterNode node, JoiningNodeDiscoveryData discoData);
     ...
     */
    public void onDisconnected(TurboSQLFuture<?> reconnectFut) throws TurboSQLCheckedException;
     ...
     */
    @Nullable public TurboSQLInternalFuture<?> onReconnected(boolean clusterRestarted) throws TurboSQLCheckedException;
}
