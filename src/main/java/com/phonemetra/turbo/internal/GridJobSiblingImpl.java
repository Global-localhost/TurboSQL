...
import static com.phonemetra.turbo.internal.GridTopic.TOPIC_JOB;
import static com.phonemetra.turbo.internal.GridTopic.TOPIC_JOB_CANCEL;
import static com.phonemetra.turbo.internal.GridTopic.TOPIC_TASK;
...
public class GridJobSiblingImpl implements ComputeJobSibling, Externalizable {
     ...
     */
    public GridJobSiblingImpl(TurboSQLUuid sesId, TurboSQLUuid jobId, UUID nodeId, GridKernalContext ctx) {
        assert sesId != null;
        assert jobId != null;
        assert nodeId != null;
        assert ctx != null;
    ...
    /** {@inheritDoc} */
    @Override public TurboSQLUuid getJobId() {
        return jobId;
    }
        ...
        for (ClusterNode node : nodes) {
            if (!ctx.localNodeId().equals(node.id())) {
                try {
                    ...
                    TurboSQLLogger log = ctx.log(GridJobSiblingImpl.class);
