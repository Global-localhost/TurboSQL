...
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.AFFINITY;
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.OPEN_CREATE;
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.OPEN_READ;
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.READ_BLOCK;
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.SET_TIMES;
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.WRITE_BLOCK;
...
public class IgfsMarshaller {
     ...
     */
    public void marshall(IgfsMessage msg, byte[] hdr, ObjectOutput out) throws TurboSQLCheckedException {
        assert hdr != null;
        ...
        try {
            ...
            throw new TurboSQLCheckedException("Failed to send message to IGFS data node (is data node up and running?)", e);
        }
    }
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    public IgfsMessage unmarshall(IgfsIpcCommand cmd, byte[] hdr, ObjectInput in) throws TurboSQLCheckedException {
        assert hdr != null;
        assert hdr.length == HEADER_SIZE;
        ...
        try {
            ...
            throw new TurboSQLCheckedException("Failed to unmarshal client message: " + cmd, e);
        }
    }
