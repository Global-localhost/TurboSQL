...
package com.phonemetra.turbo.internal.igfs.common;
...
import com.phonemetra.turbo.igfs.IgfsCorruptedFileException;
import com.phonemetra.turbo.igfs.IgfsDirectoryNotEmptyException;
import com.phonemetra.turbo.igfs.IgfsException;
import com.phonemetra.turbo.igfs.IgfsFile;
import com.phonemetra.turbo.igfs.IgfsInvalidHdfsVersionException;
import com.phonemetra.turbo.igfs.IgfsParentNotDirectoryException;
...
import com.phonemetra.turbo.internal.processors.igfs.IgfsFileImpl;
import com.phonemetra.turbo.internal.processors.igfs.IgfsHandshakeResponse;
import com.phonemetra.turbo.internal.processors.igfs.IgfsInputStreamDescriptor;
import com.phonemetra.turbo.internal.processors.igfs.IgfsModeResolver;
import com.phonemetra.turbo.internal.processors.igfs.IgfsStatus;
...
import static com.phonemetra.turbo.internal.igfs.common.IgfsIpcCommand.CONTROL_RESPONSE;
...
public class IgfsControlResponse extends IgfsMessage {
     ...
     * @param err Error.
     * @throws TurboSQLCheckedException Based on error code.
     */
    public static void throwError(Integer errCode, String err) throws TurboSQLCheckedException {
        assert err != null;
        assert errCode != -1;
     ...
     * @throws TurboSQLCheckedException Based on error code.
     */
    public void throwError() throws TurboSQLCheckedException {
     ...
     */
    public void error(TurboSQLCheckedException e) {
        err = e.getMessage();
        errCode = errorCode(e);
    }
     ...
     * @return Error code.
     */
    private int errorCode(TurboSQLCheckedException e) {
     ...
     * @return Error code.
     */
    private int errorCode(TurboSQLCheckedException e, boolean checkIo) {
