 ...
 */
public class TurboSQLNeedReconnectException extends TurboSQLCheckedException {
    /** */
     ...
     * @param cause Cause.
     */
    public TurboSQLNeedReconnectException(ClusterNode node, @Nullable Throwable cause) {
