...
import com.phonemetra.turbo.internal.processors.cache.persistence.TurboSQLCacheDatabaseSharedManager;
...
public class FailureHandlingMxBeanImpl implements FailureHandlingMxBean {
    ...
    /** Database manager. */
    private final TurboSQLCacheDatabaseSharedManager dbMgr;
    ...
    public FailureHandlingMxBeanImpl(
        ...
        @NotNull TurboSQLCacheDatabaseSharedManager dbMgr
    ) {
