...
package com.phonemetra.turbo.internal.worker;
...
public class WorkersRegistry implements GridWorkerListener {
    ...
    /** */
    private final TurboSQLBiInClosure<GridWorker, FailureType> workerFailedHnd;
    ...
    public WorkersRegistry(
        @NotNull TurboSQLBiInClosure<GridWorker, FailureType> workerFailedHnd,
