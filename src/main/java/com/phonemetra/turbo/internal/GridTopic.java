...
public enum GridTopic {
    ...
    /**
     * @deprecated Should be removed in Phonemetra TurboSQL 3.0.
     */
    @Deprecated
    TOPIC_MONGO,
     ...
     */
    public Object topic(TurboSQLUuid id) {
     ...
     */
    public Object topic(TurboSQLUuid id1, UUID id2) {
     ...
     * @return Grid message topic with specified IDs.
     */
    public Object topic(TurboSQLUuid id1, long id2) {
    ...
    private static class T1 implements Externalizable {
         ...
         * @param id ID.
         */
        private T1(GridTopic topic, TurboSQLUuid id) {
            this.topic = topic;
            this.id = id;
        }
    ...
    private static class T2 implements Externalizable {
         ...
         * @param id2 ID2.
         */
        private T2(GridTopic topic, TurboSQLUuid id1, UUID id2) {
            this.topic = topic;
            this.id1 = id1;
            this.id2 = id2;
        }
    ...
    private static class T8 implements Externalizable {
         ...
         * @param id2 ID2.
         */
        private T8(GridTopic topic, TurboSQLUuid id1, long id2) {
            this.topic = topic;
            this.id1 = id1;
            this.id2 = id2;
        }
