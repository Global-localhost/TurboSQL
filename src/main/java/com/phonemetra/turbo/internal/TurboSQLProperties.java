...
/**
 * TurboSQL properties holder.
 */
public class TurboSQLProperties {
    /** Properties file path. */
    private static final String FILE_PATH = "turboSQL.properties";
    ...
    public static void readProperties(String path, Properties props, boolean throwExc) {
        try (InputStream is = TurboSQLVersionUtils.class.getClassLoader().getResourceAsStream(path)) {
            if (is == null) {
                if (throwExc)
