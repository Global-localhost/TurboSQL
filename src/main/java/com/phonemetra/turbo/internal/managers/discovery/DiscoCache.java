...
public class DiscoCache {
    ...
    /** Minimum {@link TurboSQLProductVersion} across all nodes including client nodes. */
    private final TurboSQLProductVersion minNodeVer;

    /** Minimum {@link TurboSQLProductVersion} across alive server nodes. */
    private final TurboSQLProductVersion minSrvNodeVer;
    ...
    DiscoCache(
        ...
        TurboSQLProductVersion minNodeVer,
        TurboSQLProductVersion minSrvNodeVer
    ) {
        this.topVer = topVer;
        this.state = state;
        this.loc = loc;
     ...
     */
    public TurboSQLProductVersion minimumServerNodeVersion() {
