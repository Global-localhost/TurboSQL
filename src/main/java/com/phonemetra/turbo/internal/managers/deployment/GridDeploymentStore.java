...
public interface GridDeploymentStore {
     ...
     *
     * @throws TurboSQLCheckedException If callback execution failed.
     */
    public void onKernalStart() throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException Id deployment failed.
     */
    public GridDeployment explicitDeploy(Class<?> cls, ClassLoader clsLdr) throws TurboSQLCheckedException;
     ...
     */
    public void addParticipants(Map<UUID, TurboSQLUuid> allParticipants,
