...
public class DiscoveryLocalJoinData {
    ...
    /** */
    private final TurboSQLInternalFuture<Boolean> transitionWaitFut;
    ...
    public DiscoveryLocalJoinData(DiscoveryEvent evt,
        ...
        @Nullable TurboSQLInternalFuture<Boolean> transitionWaitFut,
        boolean active) {
     ...
     */
    @Nullable public TurboSQLInternalFuture<Boolean> transitionWaitFuture() {
