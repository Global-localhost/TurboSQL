...
public class GridDeploymentRequest implements Message {
     ...
     */
    GridDeploymentRequest(Object resTopic, TurboSQLUuid ldrId, String rsrcName, boolean isUndeploy) {
    ...
    @Override public boolean writeTo(ByteBuffer buf, MessageWriter writer) {
        ...
        switch (writer.state()) {
            ...
            case 1:
                if (!writer.writeTurboSQLUuid("ldrId", ldrId))
                    return false;
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        switch (reader.state()) {
            ...
            case 1:
                ldrId = reader.readTurboSQLUuid("ldrId");
