...
import com.phonemetra.turbo.events.CheckpointEvent;
import com.phonemetra.turbo.internal.GridKernalContext;
import com.phonemetra.turbo.internal.GridTaskSessionImpl;
import com.phonemetra.turbo.internal.GridTaskSessionInternal;
...
import static com.phonemetra.turbo.events.EventType.EVT_CHECKPOINT_LOADED;
import static com.phonemetra.turbo.events.EventType.EVT_CHECKPOINT_REMOVED;
import static com.phonemetra.turbo.events.EventType.EVT_CHECKPOINT_SAVED;
import static com.phonemetra.turbo.internal.GridTopic.TOPIC_CHECKPOINT;
...
public class GridCheckpointManager extends GridManagerAdapter<CheckpointSpi> {
    ...
    /** */
    private final ConcurrentMap<TurboSQLUuid, CheckpointSet> keyMap;

    /** */
    private final Collection<TurboSQLUuid> closedSess;
     ...
     * @return Session IDs.
     */
    public Collection<TurboSQLUuid> sessionIds() {
        return enabled() ? new ArrayList<>(keyMap.keySet()) : Collections.<TurboSQLUuid>emptyList();
    }
        ...
        throws TurboSQLCheckedException
    {
        ...
        try {
            ...
            throw new TurboSQLCheckedException(S.toString("Failed to save checkpoint",
                "key", key, true,
                "val", state, true,
                "scope", scope, false,
     ...
     * @throws TurboSQLCheckedException Thrown in case of any errors.
     */
    @Nullable public Serializable loadCheckpoint(GridTaskSessionInternal ses, String key) throws TurboSQLCheckedException {
        if (!enabled())
            return null;
        ...
        try {
            ...
            throw new TurboSQLCheckedException(S.INCLUDE_SENSITIVE ?
    ...
    @Override public void printMemoryStats() {
        X.println(">>>");
        X.println(">>> Checkpoint manager memory stats [turboSQLInstanceName=" + ctx.turboSQLInstanceName() + ']');
    ...
    private class CheckpointRequestListener implements GridMessageListener {
        ...
        @Override public void onMessage(UUID nodeId, Object msg, byte plc) {
            ...
            TurboSQLUuid sesId = req.getSessionId();
