...
import com.phonemetra.turbo.internal.util.lang.GridMetadataAwareAdapter;
...
public class GridDeployment extends GridMetadataAwareAdapter implements GridDeploymentInfo {
    ...
    /** Class loader ID. */
    private final TurboSQLUuid clsLdrId;
     ...
     */
    GridDeployment(DeploymentMode depMode, ClassLoader clsLdr, TurboSQLUuid clsLdrId, String userVer,
     ...
     */
    @Override public TurboSQLUuid classLoaderId() {
        return clsLdrId;
    }
     ...
     */
    @Nullable public <T> T newInstance(Class<T> cls) throws TurboSQLCheckedException {
        assert cls != null;
     ...
     * @throws TurboSQLCheckedException If failed to find.
     */
    @Nullable public Object annotatedValue(Object target, Class<? extends Annotation> annCls) throws TurboSQLCheckedException {
     ...
     * @throws TurboSQLCheckedException If failed to find.
     */
    private TurboSQLBiTuple<Object, Boolean> annotatedValue(Object target, Class<? extends Annotation> annCls,
        @Nullable Set<Object> visited, boolean annFound) throws TurboSQLCheckedException {
        assert target != null;
        ...
        for (Class<?> cls = target.getClass(); !cls.equals(Object.class); cls = cls.getSuperclass()) {
            ...
            for (Field f : fieldsWithAnnotation(cls, annCls)) {
                ...
                try {
                    ...
                    throw new TurboSQLCheckedException("Failed to get annotated field value [cls=" + cls.getName() +
                ...
                if (needsRecursion(f)) {
                    if (fieldVal != null) {
                        ...
                        // Recursion.
                        TurboSQLBiTuple<Object, Boolean> tup = annotatedValue(fieldVal, annCls, visited, annFound);
                    ...
                    if (annFound)
                        throw new TurboSQLCheckedException("Multiple annotations have been found [cls=" + cls.getName() +
            ...
            for (Method m : methodsWithAnnotation(cls, annCls)) {
                ...
                try {
                    ...
                    throw new TurboSQLCheckedException("Failed to get annotated method value [cls=" + cls.getName() +
                        ", ann=" + annCls.getSimpleName(), e);
                }
