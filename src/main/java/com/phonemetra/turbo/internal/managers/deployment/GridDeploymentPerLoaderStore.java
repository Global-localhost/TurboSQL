...
/**
 * Deployment storage for {@link com.phonemetra.turbo.configuration.DeploymentMode#PRIVATE} and
 * {@link com.phonemetra.turbo.configuration.DeploymentMode#ISOLATED} modes.
 */
public class GridDeploymentPerLoaderStore extends GridDeploymentStoreAdapter {
    /** Cache keyed by class loader ID. */
    private Map<TurboSQLUuid, IsolatedDeployment> cache = new HashMap<>();
    ...
    /** {@inheritDoc} */
    @Override public GridDeployment getDeployment(TurboSQLUuid ldrId) {
        synchronized (mux) {
    ...
    private class IsolatedDeployment extends GridDeployment {
         ...
         */
        IsolatedDeployment(DeploymentMode depMode, ClassLoader clsLdr, TurboSQLUuid clsLdrId,
