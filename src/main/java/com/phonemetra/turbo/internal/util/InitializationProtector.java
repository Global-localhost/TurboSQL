...
import com.phonemetra.turbo.internal.util.lang.TurboSQLThrowableRunner;
...
public class InitializationProtector {
     ...
     * @throws TurboSQLCheckedException if initialization was failed.
     */
    public <T> T protect(Object protectedKey, Supplier<T> initializedVal,
        TurboSQLThrowableRunner initializationCode) throws TurboSQLCheckedException {
     ...
     * @throws TurboSQLCheckedException if initialization was failed.
     */
    public void protect(Object protectedKey, TurboSQLThrowableRunner initializationCode) throws TurboSQLCheckedException {
