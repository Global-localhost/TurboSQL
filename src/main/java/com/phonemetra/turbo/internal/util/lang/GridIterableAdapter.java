...
public class GridIterableAdapter<T> implements GridIterable<T> {
    ...
    /** {@inheritDoc} */
    @Override public boolean hasNextX() throws TurboSQLCheckedException {
        return hasNext();
    }
    ...
    /** {@inheritDoc} */
    @Override public T nextX() throws TurboSQLCheckedException {
        return next();
    }
    ...
    /** {@inheritDoc} */
    @Override public void removeX() throws TurboSQLCheckedException {
        remove();
    }
