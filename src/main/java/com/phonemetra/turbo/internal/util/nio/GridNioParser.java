...
public interface GridNioParser {
     ...
     * @throws TurboSQLCheckedException If any user-specific error occurred.
     */
    @Nullable public Object decode(GridNioSession ses, ByteBuffer buf) throws IOException, TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If any user-specific error occurred while encoding data.
     */
    public ByteBuffer encode(GridNioSession ses, Object msg) throws IOException, TurboSQLCheckedException;
}