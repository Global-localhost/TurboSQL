 ...
 * Host data.
 */
public class TurboSQLRemoteStartSpecification {
    /** Hostname. */
    ...
    /** TurboSQL installation folder. */
    private String turboSQLHome;
     ...
     * @param turboSQLHome TurboSQL installation folder.
     * @param cfg Configuration path.
     * @param script Script path.
     */
    public TurboSQLRemoteStartSpecification(@Nullable String host, int port, @Nullable String uname,
        @Nullable String passwd, @Nullable File key, int nodes, @Nullable String turboSQLHome,
        @Nullable String cfg, @Nullable String script) {
        this(host, port, uname, passwd, key, nodes, turboSQLHome, cfg, script, null);
    }
    ...
    public TurboSQLRemoteStartSpecification(@Nullable String host, int port, @Nullable String uname,
        @Nullable String passwd, @Nullable File key, int nodes, @Nullable String turboSQLHome,
        @Nullable String cfg, @Nullable String script, @Nullable TurboSQLLogger logger) {
        assert port > 0;
        assert nodes > 0;
        ...
        this.key = key;
        this.nodes = nodes;
        this.turboSQLHome = !F.isEmpty(turboSQLHome) ? turboSQLHome : null;
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TurboSQLRemoteStartSpecification)) return false;

        TurboSQLRemoteStartSpecification that = (TurboSQLRemoteStartSpecification)o;
        ...
        return (host == null ? that.host == null : host.equals(that.host)) &&
            ...
            (turboSQLHome == null ? that.turboSQLHome == null : turboSQLHome.equals(that.turboSQLHome)) &&
    ...
    @Override public int hashCode() {
        ...
        res = 31 * res + (turboSQLHome == null ? 0 : turboSQLHome.hashCode());
    ...
    /**
     * @return TurboSQL installation folder.
     */
    public String turboSQLHome() {
        return turboSQLHome;
    }
    ...
    public void fixPaths(char separator) {
        if (turboSQLHome != null)
            turboSQLHome = turboSQLHome.replace('\\', separator).replace('/', separator);
