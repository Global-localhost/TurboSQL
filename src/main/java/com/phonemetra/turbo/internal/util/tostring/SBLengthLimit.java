...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_TO_STRING_MAX_LENGTH;
...
class SBLengthLimit {
    /** */
    private static final int MAX_TO_STR_LEN = TurboSQLSystemProperties.getInteger(IGNITE_TO_STRING_MAX_LENGTH, 10_000);
