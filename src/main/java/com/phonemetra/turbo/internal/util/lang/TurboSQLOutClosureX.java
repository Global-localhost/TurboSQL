 ...
 * wraps {@link TurboSQLCheckedException} into {@link GridClosureException} instance.
 */
public abstract class TurboSQLOutClosureX<T> implements TurboSQLOutClosure<T> {
    /** */
    ...
    /**
     * Out-closure body that can throw {@link TurboSQLCheckedException}.
     *
     * @return Element.
     * @throws TurboSQLCheckedException Thrown in case of any error condition inside of the closure.
     */
    public abstract T applyx() throws TurboSQLCheckedException;
}