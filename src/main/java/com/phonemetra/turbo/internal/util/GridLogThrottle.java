...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_LOG_THROTTLE_CAPACITY;
...
public class GridLogThrottle {
    ...
    /** Throttle capacity. */
    private static final int throttleCap = TurboSQLSystemProperties.getInteger(IGNITE_LOG_THROTTLE_CAPACITY, 128);

    /** Errors. */
    private static volatile ConcurrentMap<TurboSQLBiTuple<Class<? extends Throwable>, String>, Long> errors =
     ...
     * @param msg Message.
     */
    public static void error(@Nullable TurboSQLLogger log, @Nullable Throwable e, String msg) {
     ...
     */
    public static void error(@Nullable TurboSQLLogger log, @Nullable Throwable e, String msg, boolean byMsg) {
        assert !F.isEmpty(msg);
     ...
     * @param msg Message.
     */
    public static void warn(@Nullable TurboSQLLogger log, String msg) {
        assert !F.isEmpty(msg);
     ...
     * @param byMsg Errors group by message, not by tuple(error, msg).
     */
    public static void warn(@Nullable TurboSQLLogger log, @Nullable Throwable e, String msg, boolean quite, boolean byMsg) {
        assert !F.isEmpty(msg);
     ...
     */
    public static void warn(@Nullable TurboSQLLogger log, String msg, boolean quiet) {
        assert !F.isEmpty(msg);
     ...
     */
    public static void info(@Nullable TurboSQLLogger log, String msg, boolean quiet) {
        assert !F.isEmpty(msg);
     ...
     * @param msg Message.
     */
    public static void info(@Nullable TurboSQLLogger log, String msg) {
        assert !F.isEmpty(msg);
    ...
    private static void log(@Nullable TurboSQLLogger log,
        ...
        TurboSQLBiTuple<Class<? extends Throwable>, String> tup =
     ...
     */
    private static boolean replace(TurboSQLBiTuple<Class<? extends Throwable>, String> t, @Nullable Long oldStamp,
        Long newStamp) {
    ...
    private enum LogLevel {
        /** Error level. */
        ERROR {
            @Override public void doLog(TurboSQLLogger log, String msg, Throwable e, boolean quiet) {
                if (e != null)
                    U.error(log, msg, e);
                else
                    U.error(log, msg);
         ...
         */
        public abstract void doLog(TurboSQLLogger log, String msg, Throwable e, boolean quiet);
    }
}
