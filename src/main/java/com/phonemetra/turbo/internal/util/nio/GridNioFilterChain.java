...
public class GridNioFilterChain<T> extends GridNioFilterAdapter {
     ...
     */
    public GridNioFilterChain(TurboSQLLogger log, GridNioServerListener<T> lsnr, GridNioFilter head,
     ...
     * @param e TurboSQLCheckedException instance.
     */
    @Override public void onExceptionCaught(GridNioSession ses, TurboSQLCheckedException e) {
        try {
