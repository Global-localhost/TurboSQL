 ...
 * via {@link #evictionListener(com.phonemetra.turbo.lang.TurboSQLBiInClosure)} method, then listener
...
public class GridBoundedConcurrentOrderedMap<K, V> extends ConcurrentSkipListMap<K, V> {
    ...
    /** Listener. */
    private volatile TurboSQLBiInClosure<K, V> lsnr;
     ...
     */
    public void evictionListener(TurboSQLBiInClosure<K, V> lsnr) {
        this.lsnr = lsnr;
    }
     ...
     */
    public TurboSQLBiInClosure<K, V> evictionListener() {
        return lsnr;
    }
    ...
    private void onPut() {
        ...
        TurboSQLBiInClosure<K, V> lsnr = this.lsnr;
