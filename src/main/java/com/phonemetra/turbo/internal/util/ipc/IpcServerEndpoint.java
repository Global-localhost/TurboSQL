...
public interface IpcServerEndpoint extends Closeable {
     ...
     * @throws TurboSQLCheckedException If accept failed and the endpoint is not usable anymore.
     */
    public IpcEndpoint accept() throws TurboSQLCheckedException;

    /**
     * Starts configured endpoint implementation.
     *
     * @throws TurboSQLCheckedException If failed to start server endpoint.
     */
