 ...
 *
 * <p>When testing code that uses this class, use {@link #createUnstarted(TurboSQLTicker)} or {@link
 * #createStarted(TurboSQLTicker)} to supply a fake or mock ticker. This allows you to simulate any valid
...
public final class TurboSQLStopwatch {
    /** Ticker. */
    private final TurboSQLTicker ticker;
    /** Is running. */
     ...
     */
    public static TurboSQLStopwatch createUnstarted() {
        return new TurboSQLStopwatch();
    }

    /**
     * Creates (but does not start) a new stopwatch, using the specified time source.
     */
    public static TurboSQLStopwatch createUnstarted(TurboSQLTicker ticker) {
        return new TurboSQLStopwatch(ticker);
    }

    /**
     * Creates (and starts) a new stopwatch using {@link System#nanoTime} as its time source.
     */
    public static TurboSQLStopwatch createStarted() {
        return new TurboSQLStopwatch().start();
    }

    /**
     * Creates (and starts) a new stopwatch, using the specified time source.
     */
    public static TurboSQLStopwatch createStarted(TurboSQLTicker ticker) {
        return new TurboSQLStopwatch(ticker).start();
    }
     ...
     */
    TurboSQLStopwatch() {
        this.ticker = TurboSQLTicker.systemTicker();
    }

    /**
     * @param ticker Ticker.
     */
    TurboSQLStopwatch(@NotNull TurboSQLTicker ticker) {
        this.ticker = ticker;
    }
     ...
     */
    public TurboSQLStopwatch start() {
     ...
     * @return this {@code Stopwatch} instance
     */
    public TurboSQLStopwatch reset() {
        elapsedNanos = 0;
