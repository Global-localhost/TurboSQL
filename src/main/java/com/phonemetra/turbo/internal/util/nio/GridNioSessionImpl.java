...
import static com.phonemetra.turbo.internal.util.nio.GridNioSessionMetaKey.MAX_KEYS_CNT;
...
public class GridNioSessionImpl implements GridNioSession {
    ...
    /** {@inheritDoc} */
    @Override public void sendNoFuture(Object msg, TurboSQLInClosure<TurboSQLException> ackC)
