 ...
 * Native library is loaded with: {@link IpcSharedMemoryNativeLoader#load(com.phonemetra.turbo.TurboSQLLogger)}.
 */
public class IpcSharedMemoryUtils {
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    static native long attach(int shmemId, boolean debug) throws TurboSQLCheckedException;
    ...
    static native long readSharedMemory(long shMemPtr, byte dest[], long dOff, long size, long timeout)
        throws TurboSQLCheckedException, IpcSharedMemoryOperationTimedoutException;
     ...
     */
    static TurboSQLCheckedException linkError(UnsatisfiedLinkError e) {
        return new TurboSQLCheckedException("Linkage error due to possible native library, libturboSQLshmem.so, " +
