...
import com.phonemetra.turbo.internal.util.typedef.PX2;
 ...
 * @see PX2
 */
public abstract class TurboSQLPredicate2X<E1, E2> implements TurboSQLBiPredicate<E1, E2> {
    /** */
     ...
     */
    public abstract boolean applyx(E1 e1, E2 e2) throws TurboSQLCheckedException;
}