 ...
 * readability. For more information see {@link com.phonemetra.turbo.lang.TurboSQLPredicate} and {@link javax.cache.Cache.Entry}.
 * @see com.phonemetra.turbo.lang.TurboSQLPredicate
 * @see GridFunc
 */
public interface PCE<K, V> extends TurboSQLPredicate<Cache.Entry<K, V>> { /* No-op. */ }