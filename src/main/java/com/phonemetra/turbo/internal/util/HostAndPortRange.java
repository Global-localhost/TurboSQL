...
public class HostAndPortRange implements Serializable {
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    private static int parsePort(String portStr, String addrStr, String errMsgPrefix) throws TurboSQLCheckedException {
        try {
     ...
     * @return Exception.
     */
    private static TurboSQLCheckedException createParseError(String addrStr, String errMsgPrefix, String errMsg) {
        return new TurboSQLCheckedException(errMsgPrefix + " (" + errMsg + "): " + addrStr);
    }
