...
import com.phonemetra.turbo.internal.util.worker.GridWorkerPool;
...
public class GridNioAsyncNotifyFilter extends GridNioFilterAdapter {
     ...
     * @param log Logger.
     */
    public GridNioAsyncNotifyFilter(String turboSQLInstanceName, Executor exec, TurboSQLLogger log) {
    ...
    /** {@inheritDoc} */
    @Override public void onSessionOpened(final GridNioSession ses) throws TurboSQLCheckedException {
        workerPool.execute(new GridWorker(turboSQLInstanceName, "session-opened-notify", log) {
    ...
    /** {@inheritDoc} */
    @Override public void onSessionClosed(final GridNioSession ses) throws TurboSQLCheckedException {
        workerPool.execute(new GridWorker(turboSQLInstanceName, "session-closed-notify", log) {
            @Override protected void body() {
                try {
    ...
    /** {@inheritDoc} */
    @Override public void onMessageReceived(final GridNioSession ses, final Object msg) throws TurboSQLCheckedException {
        workerPool.execute(new GridWorker(turboSQLInstanceName, "message-received-notify", log) {
            @Override protected void body() {
                try {
    ...
    /** {@inheritDoc} */
    @Override public GridNioFuture<Boolean> onSessionClose(GridNioSession ses) throws TurboSQLCheckedException {
     ...
     * @param ex Exception.
     */
    private void handleException(GridNioSession ses, TurboSQLCheckedException ex) {
        try {
            proceedExceptionCaught(ses, ex);
        }
        catch (TurboSQLCheckedException e) {
