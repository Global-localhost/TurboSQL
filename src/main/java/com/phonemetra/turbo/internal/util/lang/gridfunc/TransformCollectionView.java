...
import com.phonemetra.turbo.internal.util.GridSerializableCollection;
...
public class TransformCollectionView<T1, T2> extends GridSerializableCollection<T1> {
    ...
    /** */
    private final TurboSQLClosure<? super T2, T1> clos;

    /** */
    private final TurboSQLPredicate<? super T2>[] preds;
    ...
    public TransformCollectionView(Collection<? extends T2> col,
        TurboSQLClosure<? super T2, T1> clos, TurboSQLPredicate<? super T2>... preds) {
        this.col = col;
        this.clos = clos;
        this.preds = preds;
    }
