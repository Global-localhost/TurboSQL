...
public class OffheapReadWriteLock {
     ...
     */
    public static final int SPIN_CNT = TurboSQLSystemProperties.getInteger("IGNITE_OFFHEAP_RWLOCK_SPIN_COUNT", 32);

    /** */
    public static final boolean USE_RANDOM_RW_POLICY = TurboSQLSystemProperties.getBoolean("IGNITE_OFFHEAP_RANDOM_RW_POLICY", false);
