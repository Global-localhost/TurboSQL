...
public interface GridNioFilter {
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedSessionOpened(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedSessionClosed(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedExceptionCaught(GridNioSession ses, TurboSQLCheckedException e) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedMessageReceived(GridNioSession ses, Object msg) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public GridNioFuture<Boolean> proceedSessionClose(GridNioSession ses) throws TurboSQLCheckedException;

    /**
     * Invoked when a new session was created.
     *
     * @param ses Opened session.
     * @throws TurboSQLCheckedException If GridNioException occurred while handling event.
     */
    public void onSessionOpened(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If GridNioException occurred while handling event.
     */
    public void onSessionClosed(GridNioSession ses) throws TurboSQLCheckedException;

    /**
     * Invoked when exception is caught in filter processing.
     *
     * @param ses Session that caused TurboSQLCheckedException.
     * @param ex GridNioException instance.
     * @throws TurboSQLCheckedException If TurboSQLCheckedException occurred while handling event.
     */
    public void onExceptionCaught(GridNioSession ses, TurboSQLCheckedException ex) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If TurboSQLCheckedException occurred while handling event.
     */
    public void onMessageReceived(GridNioSession ses, Object msg) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If TurboSQLCheckedException occurred while handling event.
     */
    public GridNioFuture<Boolean> onSessionClose(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void onSessionIdleTimeout(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedSessionIdleTimeout(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void onSessionWriteTimeout(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public void proceedSessionWriteTimeout(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public GridNioFuture<?> proceedPauseReads(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public GridNioFuture<?> onPauseReads(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public GridNioFuture<?> proceedResumeReads(GridNioSession ses) throws TurboSQLCheckedException;
     ...
     * @throws TurboSQLCheckedException If filter is not in chain or GridNioException occurred in the underlying filter.
     */
    public GridNioFuture<?> onResumeReads(GridNioSession ses) throws TurboSQLCheckedException;
}
