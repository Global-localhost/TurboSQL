...
import com.phonemetra.turbo.internal.util.GridSerializableMap;
import com.phonemetra.turbo.internal.util.GridSerializableSet;
...
public class TransformMapView2<K, V, V1> extends GridSerializableMap<K, V1> {
    ...
    /** */
    private final TurboSQLBiClosure<K, V, V1> clos;

    /** */
    private final TurboSQLPredicate<? super K>[] preds;

    /** Entry predicate. */
    private TurboSQLPredicate<Entry<K, V>> entryPred;
    ...
    public TransformMapView2(Map<K, V> map, TurboSQLBiClosure<K, V, V1> clos,
        TurboSQLPredicate<? super K>... preds) {
        this.map = map;
        this.clos = clos;
        this.preds = preds;
