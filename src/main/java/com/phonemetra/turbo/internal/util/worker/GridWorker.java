...
package com.phonemetra.turbo.internal.util.worker;
...
public abstract class GridWorker implements Runnable {
     ...
     *
     * @param turboSQLInstanceName Name of the TurboSQL instance this runnable is used in.
     ...
     * @param log Grid logger to be used.
     */
    protected GridWorker(@Nullable String turboSQLInstanceName, String name, TurboSQLLogger log) {
        this(turboSQLInstanceName, name, log, null);
    }
    ...
    @Override public final void run() {
        ...
        // not to kill any threads from the underlying thread pool.
            ...
            if (!X.hasCause(e, InterruptedException.class) && !X.hasCause(e, TurboSQLInterruptedCheckedException.class) && !X.hasCause(e, TurboSQLInterruptedException.class))
     ...
     */
    protected abstract void body() throws InterruptedException, TurboSQLInterruptedCheckedException;
    ...
    /**
     * Gets name of the TurboSQL instance this runnable belongs to.
     *
     * @return Name of the TurboSQL instance this runnable belongs to.
     */
    public String turboSQLInstanceName() {
