...
import com.phonemetra.turbo.internal.util.typedef.CIX2;
 ...
 * @see CIX2
 */
public abstract class TurboSQLInClosure2X<E1, E2> implements TurboSQLBiInClosure<E1, E2> {
    /** */
     ...
     */
    public abstract void applyx(E1 e1, E2 e2) throws TurboSQLCheckedException;
}