...
public class TimeBag {
    ...
    /** Global stopwatch. */
    private final TurboSQLStopwatch globalStopwatch = TurboSQLStopwatch.createStarted();
    ...
    private final ThreadLocal<TurboSQLStopwatch> tlStopwatch = ThreadLocal.withInitial(TurboSQLStopwatch::createUnstarted);
    ...
    public void finishLocalStage(String description) {
        ...
        try {
            ...
            TurboSQLStopwatch localStopWatch = tlStopwatch.get();
