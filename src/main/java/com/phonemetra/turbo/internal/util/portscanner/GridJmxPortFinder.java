...
package com.phonemetra.turbo.internal.util.portscanner;
...
public class GridJmxPortFinder {
    ...
    public static void main(String[] args) {
        ...
        int jmxPort = TurboSQLSystemProperties.getInteger(IGNITE_JMX_PORT, -1);
        ...
        try {
            File file = new File(System.getProperty("java.io.tmpdir"), "turboSQL.lastport.tmp");
