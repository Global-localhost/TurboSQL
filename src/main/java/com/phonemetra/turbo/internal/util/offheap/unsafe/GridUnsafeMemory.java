...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_OFFHEAP_SAFE_RELEASE;
import static com.phonemetra.turbo.internal.util.offheap.GridOffHeapEvent.ALLOCATE;
import static com.phonemetra.turbo.internal.util.offheap.GridOffHeapEvent.RELEASE;
...
public class GridUnsafeMemory {
    ...
    private static final boolean SAFE_RELEASE = TurboSQLSystemProperties.getBoolean(IGNITE_OFFHEAP_SAFE_RELEASE);
     ...
     */
    public TurboSQLBiTuple<byte[], Byte> get(long ptr) {
        assert ptr != 0;
        ...
        return new TurboSQLBiTuple<>(bytes, type);
    }
