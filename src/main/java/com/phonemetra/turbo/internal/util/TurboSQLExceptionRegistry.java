...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_EXCEPTION_REGISTRY_MAX_SIZE;

/**
 * Utility to collect suppressed errors within internal code.
 */
public class TurboSQLExceptionRegistry {
    /** */
    public static final int DEFAULT_QUEUE_SIZE = 1000;

    /** */
    private static final TurboSQLExceptionRegistry instance = new TurboSQLExceptionRegistry();

    /** */
    private int maxSize = TurboSQLSystemProperties.getInteger(IGNITE_EXCEPTION_REGISTRY_MAX_SIZE, DEFAULT_QUEUE_SIZE);
     ...
     */
    public static TurboSQLExceptionRegistry get() {
        return instance;
    }
     ...
     *
     */
    private TurboSQLExceptionRegistry() {
        // No-op.
    }
     ...
     * @param log Logger.
     */
    public void printErrors(TurboSQLLogger log) {
        int size = q.size();
