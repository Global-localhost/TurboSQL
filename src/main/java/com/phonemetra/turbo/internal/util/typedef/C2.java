...
/**
 * Defines {@code alias} for {@link com.phonemetra.turbo.lang.TurboSQLBiClosure} by extending it. Since Java doesn't provide type aliases
 * (like Scala, for example) we resort to these types of measures. This is intended to provide for more
 * concise code in cases when readability won't be sacrificed. For more information see {@link com.phonemetra.turbo.lang.TurboSQLBiClosure}.
 ...
 * @see GridFunc
 * @see com.phonemetra.turbo.lang.TurboSQLBiClosure
 */
public interface C2<E1, E2, R> extends TurboSQLBiClosure<E1, E2, R> { /* No-op. */ }