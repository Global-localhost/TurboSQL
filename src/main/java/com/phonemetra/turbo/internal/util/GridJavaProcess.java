...
public final class GridJavaProcess {
     ...
     */
    public static GridJavaProcess exec(Class cls, String params, @Nullable TurboSQLLogger log,
        @Nullable TurboSQLInClosure<String> printC, @Nullable GridAbsClosure procKilledC) throws Exception {
     ...
     */
    public static GridJavaProcess exec(Class cls, String params, @Nullable TurboSQLLogger log,
        @Nullable TurboSQLInClosure<String> printC, @Nullable GridAbsClosure procKilledC,
     ...
     * @throws Exception If any problem occurred.
     */
    public static GridJavaProcess exec(String clsName, String params, @Nullable TurboSQLLogger log,
        @Nullable TurboSQLInClosure<String> printC, @Nullable GridAbsClosure procKilledC,
    ...
    private class ProcessStreamGrabber extends Thread {
        ...
        /** Closure to be called when process termination is detected. */
        private final TurboSQLInClosure<String> printC;
         ...
         * @param printC Optional closure to be called each time wrapped process prints line to system.out or system.err.
         */
        ProcessStreamGrabber(InputStream streamToGrab, @Nullable TurboSQLInClosure<String> printC) {
