...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_REFLECTION_CACHE_SIZE;
...
public class GridReflectionCache implements Externalizable {
    ...
    /** Field predicate. */
    private TurboSQLPredicate<Field> fp;

    /** Method predicate. */
    private TurboSQLPredicate<Method> mp;
     ...
     */
    public GridReflectionCache(@Nullable TurboSQLPredicate<Field> fp, @Nullable TurboSQLPredicate<Method> mp) {
        this.fp = fp;
        this.mp = mp;
    }
     ...
     */
    @Nullable public Object firstFieldValue(Object o) throws TurboSQLCheckedException {
        assert o != null;
        ...
        if (f != null) {
            try {
                ...
                throw new TurboSQLCheckedException("Failed to access field for object [field=" + f + ", obj=" + o + ']', e);
            }
        }
     ...
     * @throws TurboSQLCheckedException If failed.
     */
    @Nullable public Object firstMethodValue(Object o) throws TurboSQLCheckedException {
        assert o != null;
        ...
        if (m != null) {
            try {
                ...
                throw new TurboSQLCheckedException("Failed to invoke method for object [mtd=" + m + ", obj=" + o + ']', e);
            }
        }
    ...
    @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        fp = (TurboSQLPredicate<Field>)in.readObject();
        mp = (TurboSQLPredicate<Method>)in.readObject();
    }
}