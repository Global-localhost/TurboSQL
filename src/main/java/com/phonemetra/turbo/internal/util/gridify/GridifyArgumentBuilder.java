...
import com.phonemetra.turbo.compute.gridify.aop.GridifyArgumentAdapter;
...
public final class GridifyArgumentBuilder {
     ...
     */
    public GridifyRangeArgument createTaskArgument(GridifyRangeArgument arg, Collection<?> input) throws TurboSQLCheckedException {
        ...
        if (paramValue == null)
            throw new TurboSQLCheckedException("Failed to create task argument for type: " + paramCls.getName());
    ...
    /**
     * Create {@link com.phonemetra.turbo.compute.gridify.GridifyArgument} for job.
     *
     * @param arg Task argument contains all necessary data for method invoke.
     ...
     */
    public GridifyArgument createJobArgument(GridifyRangeArgument arg, Collection<?> input) throws TurboSQLException {
        ...
        if (paramValue == null)
            throw new TurboSQLException("Failed to create job argument for type: " + paramCls.getName());
