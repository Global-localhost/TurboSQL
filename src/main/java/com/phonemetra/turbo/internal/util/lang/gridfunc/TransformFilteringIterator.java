...
public class TransformFilteringIterator<T2, T1> extends GridIteratorAdapter<T2> {
    ...
    /** */
    private final TurboSQLClosure<? super T1, T2> clos;

    /** */
    private final boolean readOnly;

    /** */
    private final TurboSQLPredicate<? super T1>[] preds;
     ...
     */
    public TransformFilteringIterator(Iterator<? extends T1> iter, TurboSQLClosure<? super T1, T2> clos,
        boolean readOnly,
        TurboSQLPredicate<? super T1>... preds) {
        this.clos = clos;
        ...
        if (GridFunc.isEmpty(preds))
            ...
            if (!moved)
                ...
                while (iter.hasNext()) {
                    ...
                    for (TurboSQLPredicate<? super T1> r : preds)
