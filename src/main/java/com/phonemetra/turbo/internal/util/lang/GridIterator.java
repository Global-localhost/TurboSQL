...
import com.phonemetra.turbo.internal.util.GridSerializableIterator;
...
public interface GridIterator<T> extends Iterable<T>, GridSerializableIterator<T> {
     ...
     * @throws TurboSQLCheckedException If no more elements can be returned due
     *      to some failure, like a network error for example.
     * @see Iterator#hasNext()
     */
    public boolean hasNextX() throws TurboSQLCheckedException;
     ...
     * @see Iterator#next()
     */
    public T nextX() throws TurboSQLCheckedException;
     ...
     */
    public void removeX() throws TurboSQLCheckedException;
}