...
import static com.phonemetra.turbo.internal.util.TurboSQLUtils.jdkVersion;
import static com.phonemetra.turbo.internal.util.TurboSQLUtils.majorJavaVersion;
...
public abstract class GridUnsafe {
    ...
    private static final long PER_BYTE_THRESHOLD =
        TurboSQLSystemProperties.getLong(TurboSQLSystemProperties.IGNITE_MEMORY_PER_BYTE_COPY_THRESHOLD, 0L);
    ...
    private static boolean unaligned() {
        ...
        if (!res)
            res = TurboSQLSystemProperties.getBoolean(TurboSQLSystemProperties.IGNITE_MEMORY_UNALIGNED_ACCESS, false);
