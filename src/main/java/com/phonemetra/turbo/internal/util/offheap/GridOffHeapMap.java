...
public interface GridOffHeapMap {
     ...
     */
    @Nullable public TurboSQLBiTuple<Long, Integer> valuePointer(int hash, byte[] keyBytes);
     ...
     * @return {@code True} if value was removed.
     */
    public boolean removex(int hash, byte[] keyBytes, TurboSQLBiPredicate<Long, Integer> p);
