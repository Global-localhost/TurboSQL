...
import com.phonemetra.turbo.internal.util.offheap.GridOffHeapPartitionedMap;
...
public class GridUnsafePartitionedMap implements GridOffHeapPartitionedMap {
    ...
    /** {@inheritDoc} */
    @Override public TurboSQLBiTuple<Long, Integer> valuePointer(int p, int hash, byte[] keyBytes) {
    ...
    @Override public boolean removex(int part,
        int hash,
        byte[] keyBytes,
        TurboSQLBiPredicate<Long, Integer> p) {
    ...
    @Override public GridCloseableIterator<TurboSQLBiTuple<byte[], byte[]>> iterator() {
        return new PartitionedMapCloseableIterator<TurboSQLBiTuple<byte[], byte[]>>() {
            @Override protected void advance() throws TurboSQLCheckedException {
                curIt = null;
    ...
    /** {@inheritDoc} */
    @Override public GridCloseableIterator<TurboSQLBiTuple<byte[], byte[]>> iterator(int p) {
    ...
    private abstract class PartitionedMapCloseableIterator<T> extends GridCloseableIteratorAdapter<T> {
         ...
         */
        abstract void advance() throws TurboSQLCheckedException;
