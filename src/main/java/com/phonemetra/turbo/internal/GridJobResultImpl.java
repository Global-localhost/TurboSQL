...
public class GridJobResultImpl implements ComputeJobResult {
     ...
     */
    public GridJobResultImpl(ComputeJob job, TurboSQLUuid jobId, ClusterNode node, GridJobSiblingImpl sib) {
        assert jobId != null;
        assert node != null;
        assert sib != null;
    ...
    /** {@inheritDoc} */
    @Override public synchronized TurboSQLException getException() {
        return ex;
    }
