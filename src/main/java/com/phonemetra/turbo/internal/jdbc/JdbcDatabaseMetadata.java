...
public class JdbcDatabaseMetadata implements DatabaseMetaData {
    ...
    private static final String TASK_NAME =
        "com.phonemetra.turbo.internal.processors.cache.query.jdbc.GridCacheQueryJdbcMetadataTask";
    ...
    private void updateMetaData() throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Failed to get meta data from TurboSQL.", e);
        }
    }
