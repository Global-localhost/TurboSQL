...
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcBatchExecuteResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcBulkLoadAckResult;
...
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcQueryExecuteMultipleStatementsResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcQueryExecuteRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcQueryExecuteResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcResultInfo;
...
import com.phonemetra.turbo.internal.sql.SqlKeyword;
import com.phonemetra.turbo.internal.sql.SqlParseException;
import com.phonemetra.turbo.internal.sql.SqlParser;
...
public class JdbcThinStatement implements Statement {
    ...
    void checkStatementBatchEmpty() throws SQLException {
        if (conn.isStream() && !F.isEmpty(batch))
            throw new TurboSQLSQLException("Statement has non-empty batch (call executeBatch() or clearBatch() " +
                "before enabling streaming).", TurboSQLQueryErrorCode.UNSUPPORTED_OPERATION).toJdbcException();
    }
    ...
    @Override public int[] executeBatch() throws SQLException {
        ...
        try {
            ...
            if (res.errorCode() != ClientListenerResponse.STATUS_SUCCESS) {
                throw new BatchUpdateException(res.errorMessage(), TurboSQLQueryErrorCode.codeToSqlState(res.errorCode()),
