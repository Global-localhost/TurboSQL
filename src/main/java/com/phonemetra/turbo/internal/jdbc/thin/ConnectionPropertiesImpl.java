...
import com.phonemetra.turbo.internal.processors.query.NestedTxMode;
...
public class ConnectionPropertiesImpl implements ConnectionProperties, Serializable {
    ...
    public static final String PROP_PREFIX = "turboSQL.jdbc.";
    ...
    /** Executes update queries on turboSQL server nodes flag. */
    private BooleanProperty skipReducerOnUpdate = new BooleanProperty(
        "skipReducerOnUpdate", "Enable execution update queries on turboSQL server nodes", false, false);
    ...
    /** SSL: Use SSL connection to TurboSQL node. */
