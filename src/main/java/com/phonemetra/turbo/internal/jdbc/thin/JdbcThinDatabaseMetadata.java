...
import com.phonemetra.turbo.internal.TurboSQLVersionUtils;
import com.phonemetra.turbo.internal.jdbc2.JdbcUtils;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcColumnMeta;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcIndexMeta;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaColumnsRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaColumnsResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaIndexesRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaIndexesResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaPrimaryKeysRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaPrimaryKeysResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaSchemasRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaSchemasResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaTablesRequest;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcMetaTablesResult;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcPrimaryKeyMeta;
import com.phonemetra.turbo.internal.processors.odbc.jdbc.JdbcTableMeta;
...
import static com.phonemetra.turbo.internal.jdbc2.JdbcUtils.CATALOG_NAME;
import static com.phonemetra.turbo.internal.jdbc2.JdbcUtils.columnRow;
import static com.phonemetra.turbo.internal.jdbc2.JdbcUtils.indexRows;
import static com.phonemetra.turbo.internal.jdbc2.JdbcUtils.primaryKeyRows;
import static com.phonemetra.turbo.internal.jdbc2.JdbcUtils.tableRow;
...
public class JdbcThinDatabaseMetadata implements DatabaseMetaData {
    /** Driver name. */
    public static final String DRIVER_NAME = "Phonemetra TurboSQL Thin JDBC Driver";
    ...
    @Override public String getDriverVersion() throws SQLException {
        return TurboSQLVersionUtils.VER.toString();
    }

    /** {@inheritDoc} */
    @Override public int getDriverMajorVersion() {
        return TurboSQLVersionUtils.VER.major();
    }

    /** {@inheritDoc} */
    @Override public int getDriverMinorVersion() {
        return TurboSQLVersionUtils.VER.minor();
    }
    ...
    @Override public int getDefaultTransactionIsolation() throws SQLException {
        return conn.turboSQLVersion().greaterThanEqual(2, 5, 0) ? TRANSACTION_REPEATABLE_READ :
            TRANSACTION_NONE;
    }

    /** {@inheritDoc} */
    @Override public boolean supportsTransactions() throws SQLException {
        return conn.turboSQLVersion().greaterThanEqual(2, 5, 0);
    }
    ...
    @Override public int getDatabaseMajorVersion() throws SQLException {
        return conn.turboSQLVersion().major();
    }

    /** {@inheritDoc} */
    @Override public int getDatabaseMinorVersion() throws SQLException {
        return conn.turboSQLVersion().minor();
    }
