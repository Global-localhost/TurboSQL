...
import com.phonemetra.turbo.internal.client.GridClientFutureTimeoutException;
...
import static com.phonemetra.turbo.TurboSQLJdbcDriver.PROP_HOST;
import static com.phonemetra.turbo.TurboSQLJdbcDriver.PROP_NODE_ID;
import static com.phonemetra.turbo.TurboSQLJdbcDriver.PROP_PORT;
...
public class JdbcConnection implements Connection {
    ...
    private static final String VALID_TASK_NAME =
        "com.phonemetra.turbo.internal.processors.cache.query.jdbc.GridCacheQueryJdbcValidationTask";
    ...
    public JdbcConnection(String url, Properties props) throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Failed to start TurboSQL client.", e);
        }
