...
package com.phonemetra.turbo.internal.client;
...
import com.phonemetra.turbo.internal.client.balancer.GridClientRoundRobinBalancer;
...
import com.phonemetra.turbo.internal.client.ssl.GridSslBasicContextFactory;
...
import com.phonemetra.turbo.plugin.security.SecurityCredentialsBasicProvider;
import com.phonemetra.turbo.plugin.security.SecurityCredentialsProvider;
...
public class GridClientConfiguration {
     ...
     * the grid. Once connection is established, TurboSQL will get
     ...
     * <ul>
     *     <li>{@link GridClientOptimizedMarshaller} (default) - TurboSQL's optimized marshaller.</li>
     *     <li>{@code GridClientBinaryMarshaller} - Marshaller that supports binary objects.</li>
     *     <li>{@link com.phonemetra.turbo.internal.client.marshaller.jdk.GridClientJdkMarshaller} - JDK marshaller (not recommended).</li>
     * </ul>
     *
