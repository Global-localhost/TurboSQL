...
package com.phonemetra.turbo.internal.client.balancer;
...
public abstract class GridClientBalancerAdapter implements GridClientLoadBalancer {
    ...
    private static final TurboSQLPredicate<GridClientNode> CONNECTABLE =
        new TurboSQLPredicate<GridClientNode>() {
