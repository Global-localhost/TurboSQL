...
package com.phonemetra.turbo.internal.client.marshaller.optimized;
...
import com.phonemetra.turbo.internal.MarshallerContextImpl;
...
public class GridClientOptimizedMarshaller implements GridClientMarshaller {
     ...
     * @throws TurboSQLException If this marshaller is not supported on the current JVM.
