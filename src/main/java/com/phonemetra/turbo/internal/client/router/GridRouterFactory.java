...
package com.phonemetra.turbo.internal.client.router;
...
import com.phonemetra.turbo.internal.client.router.impl.GridTcpRouterImpl;
 ...
 * {@code TURBOSQL_HOME/bin/turboSQLrouter.sh} or {@code TURBOSQL_HOME/bin/turboSQLrouter.bat}.
 * They both accept path to a configuration file as first command line argument.
 * See {@code TURBOSQL_HOME/config/router/default-router.xml} for configuration example.
 *
 * @see GridTcpRouter
 */
public final class GridRouterFactory {
     ...
     * @throws TurboSQLCheckedException If router start failed.
     */
    public static GridTcpRouter startTcpRouter(GridTcpRouterConfiguration cfg) throws TurboSQLCheckedException {
        ...
        try {
            ...
            throw new TurboSQLCheckedException("Failed to start router: " + e, e);
        }
