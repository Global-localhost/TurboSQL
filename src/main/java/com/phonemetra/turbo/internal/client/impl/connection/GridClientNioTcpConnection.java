...
package com.phonemetra.turbo.internal.client.impl.connection;
...
import com.phonemetra.turbo.internal.client.GridClientAuthenticationException;
import com.phonemetra.turbo.internal.client.GridClientCacheFlag;
import com.phonemetra.turbo.internal.client.GridClientCacheMode;
import com.phonemetra.turbo.internal.client.GridClientClosedException;
import com.phonemetra.turbo.internal.client.GridClientDataMetrics;
...
import com.phonemetra.turbo.internal.client.impl.GridClientFutureAdapter;
import com.phonemetra.turbo.internal.client.impl.GridClientFutureCallback;
import com.phonemetra.turbo.internal.client.impl.GridClientNodeImpl;
import com.phonemetra.turbo.internal.client.impl.GridClientNodeMetricsAdapter;
...
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientAuthenticationRequest;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientStateRequest;
...
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientNodeBean;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheBean;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientNodeMetricsBean;
...
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientTaskRequest;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientTaskResultBean;
import com.phonemetra.turbo.internal.processors.rest.client.message.GridClientTopologyRequest;
...
import com.phonemetra.turbo.internal.util.nio.GridNioFutureImpl;
...
import static com.phonemetra.turbo.internal.client.GridClientCacheFlag.KEEP_BINARIES;
import static com.phonemetra.turbo.internal.client.GridClientCacheFlag.encodeCacheFlags;
import static com.phonemetra.turbo.internal.client.impl.connection.GridClientConnectionCloseReason.CONN_IDLE;
import static com.phonemetra.turbo.internal.client.impl.connection.GridClientConnectionCloseReason.FAILED;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.APPEND;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.CAS;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.GET_ALL;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.METRICS;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.PREPEND;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.PUT_ALL;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.REPLACE;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.RMV;
import static com.phonemetra.turbo.internal.processors.rest.client.message.GridClientCacheRequest.GridCacheOperation.RMV_ALL;
...
public class GridClientNioTcpConnection extends GridClientConnection {
    ...
    private <R> GridClientFutureAdapter<R> makeRequest(GridClientMessage msg, final TcpClientFuture<R> fut,
        ...
        if (msg instanceof GridClientPingPacket) {
            ...
            if (routeMode) {
                sndFut.listen(new CI1<TurboSQLInternalFuture<?>>() {
                    @Override public void apply(TurboSQLInternalFuture<?> sndFut) {
                        try {
                            sndFut.get();
                        }
                        catch (Exception e) {
