...
import static com.phonemetra.turbo.internal.processors.platform.client.ClientConnectionContext.CURRENT_VER;
...
class TcpClientCache<K, V> implements ClientCache<K, V> {
    ...
    /** Indicates if cache works with TurboSQL Binary format. */
