...
package com.phonemetra.turbo.internal.client.marshaller.jdk;
...
import com.phonemetra.turbo.internal.util.io.GridByteArrayOutputStream;
...
public class GridClientJdkMarshaller implements GridClientMarshaller {
     ...
     */
    public GridClientJdkMarshaller(TurboSQLPredicate<String> clsFilter) {
    ...
    private static class ClientJdkInputStream extends ObjectInputStream {
         ...
         * @param clsFilter Class filter.
         */
        public ClientJdkInputStream(InputStream in, TurboSQLPredicate<String> clsFilter) throws IOException {
            super(in);
