...
import com.phonemetra.turbo.internal.client.router.GridTcpRouter;
import com.phonemetra.turbo.internal.client.router.GridTcpRouterConfiguration;
import com.phonemetra.turbo.internal.client.router.GridTcpRouterMBean;
...
public class GridTcpRouterImpl implements GridTcpRouter, GridTcpRouterMBean, LifecycleAware {
    ...
    @Override public void start() throws TurboSQLException {
        try {
            ...
            throw new TurboSQLException("Failed to initialise embedded client.", e);
        }
        ...
        try {
            ...
            throw new TurboSQLException("Failed to resolve grid address for configured host: " + cfg.getHost(), e);
        }
        ...
        try {
            ...
            throw new TurboSQLException("Failed to create SSL context.", e);
        }
        ...
        if (bindPort == 0)
            throw new TurboSQLException("Failed to bind TCP router server (possibly all ports in range " +
    ...
    private boolean startTcpServer(InetAddress hostAddr, int port, GridNioServerListener<GridClientMessage> lsnr,
        ...
        try {
            ...
            String turboSQLInstanceName = "router-" + id;
