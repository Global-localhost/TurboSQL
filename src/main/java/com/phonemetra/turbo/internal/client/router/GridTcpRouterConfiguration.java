...
public class GridTcpRouterConfiguration {
    ...
    public static final Collection<String> DFLT_SERVERS =
        Collections.singleton("127.0.0.1:" + TurboSQLConfiguration.DFLT_TCP_PORT);
    ...
    public static final int DFLT_TCP_PORT = TurboSQLConfiguration.DFLT_TCP_PORT + 1;
     ...
     */
    public TurboSQLLogger getLogger() {
        return log;
    }
     ...
     * @return {@code this} for chaining.
     */
    public GridTcpRouterConfiguration setLogger(TurboSQLLogger log) {
        this.log = log;
