 ...
 * which can be configured by {@link TurboSQLConfiguration#setFailureHandler(FailureHandler)} method.
 */
public interface FailureHandler {
    /**
     * Handles failure occurred on {@code turboSQL} instance.
     ...
     */
    public boolean onFailure(TurboSQL turboSQL, FailureContext failureCtx);
}
