 ...
 * {@link com.phonemetra.turbo.configuration.TurboSQLConfiguration#COURTESY_LOGGER_NAME} category in log configuration.
 */
@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface TurboSQLSpiConsistencyChecked {
    /**
