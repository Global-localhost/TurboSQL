...
package com.phonemetra.turbo.spi.collision;
 ...
 * grid jobs should be executed on a destination grid node. TurboSQL comes with the following
 * ready implementations for collision resolution that cover most popular strategies:
 * <ul>
 *      <li>{@link com.phonemetra.turbo.spi.collision.fifoqueue.FifoQueueCollisionSpi}</li>
 *      <li>{@link com.phonemetra.turbo.spi.collision.priorityqueue.PriorityQueueCollisionSpi}</li>
 *      <li>{@link com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi}</li>
 * </ul>
 ...
 */
public interface CollisionSpi extends TurboSQLSpi {
    /**
     ...
     * <p>
     * TurboSQL uses this listener to enable job stealing from overloaded to underloaded nodes.
     ...
     * attribute in job context (see {@link com.phonemetra.turbo.compute.ComputeJobContext}) for a job that requires
