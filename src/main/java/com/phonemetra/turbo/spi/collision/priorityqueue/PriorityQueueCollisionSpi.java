...
package com.phonemetra.turbo.spi.collision.priorityqueue;
 ...
 *      returning from {@link com.phonemetra.turbo.compute.ComputeTask#map(List, Object)} method, task implementation should
 *      set a value into the task session keyed by this attribute key. See {@link com.phonemetra.turbo.compute.ComputeTaskSession}
 ...
 *      See {@link com.phonemetra.turbo.compute.ComputeJobContext} for more information about job context.
 * </li>
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.collision.priorityqueue.PriorityQueueCollisionSpi"&gt;
...
public class PriorityQueueCollisionSpi extends TurboSQLSpiAdapter implements CollisionSpi {
    /**
     ...
     * priorities from task context (see {@link com.phonemetra.turbo.compute.ComputeTaskSession#getAttribute(Object)}).
     * <p>
     ...
     * priorities from job context (see {@link com.phonemetra.turbo.compute.ComputeJobContext#getAttribute(Object)}).
     * <p>
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new PriorityQueueCollisionSpiMBeanImpl(this),
     ...
     */
    private class PriorityQueueCollisionSpiMBeanImpl extends TurboSQLSpiMBeanAdapter
        implements PriorityQueueCollisionSpiMBean {
        /** {@inheritDoc} */
        PriorityQueueCollisionSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
