...
package com.phonemetra.turbo.spi.collision.jobstealing;
 ...
 * {@link com.phonemetra.turbo.spi.failover.jobstealing.JobStealingFailoverSpi JobStealingFailoverSpi}.
 * Also note that job metrics update should be enabled in order for this SPI
 * to work properly (i.e. {@link com.phonemetra.turbo.configuration.TurboSQLConfiguration#getMetricsUpdateFrequency() TurboSQLConfiguration#getMetricsUpdateFrequency()}
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi"&gt;
...
@TurboSQLSpiConsistencyChecked(optional = true)
public class JobStealingCollisionSpi extends TurboSQLSpiAdapter implements CollisionSpi {
    ...
    /** Communication topic. */
    private static final String JOB_STEALING_COMM_TOPIC = "turboSQL.collision.job.stealing.topic";

    /** Job context attribute for storing thief node UUID (this attribute is used in job stealing failover SPI). */
    public static final String THIEF_NODE_ATTR = "turboSQL.collision.thief.node";

    /** Threshold of maximum jobs on waiting queue. */
    public static final String WAIT_JOBS_THRESHOLD_NODE_ATTR = "turboSQL.collision.wait.jobs.threshold";

    /** Threshold of maximum jobs executing concurrently. */
    public static final String ACTIVE_JOBS_THRESHOLD_NODE_ATTR = "turboSQL.collision.active.jobs.threshold";
     ...
     * execution.
     *
     * @see com.phonemetra.turbo.compute.ComputeJobContext
     */
    public static final String STEALING_ATTEMPT_COUNT_ATTR = "turboSQL.stealing.attempt.count";

    /** Maximum stealing attempts attribute name. */
    public static final String MAX_STEALING_ATTEMPT_ATTR = "turboSQL.stealing.max.attempts";

    /** Stealing request expiration time attribute name. */
    public static final String MSG_EXPIRE_TIME_ATTR = "turboSQL.stealing.msg.expire.time";

    /** Stealing priority attribute name. */
    public static final String STEALING_PRIORITY_ATTR = "turboSQL.stealing.priority";
     ...
     * have these attributes set (see {@link com.phonemetra.turbo.cluster.ClusterNode#attribute(String)} and
     * {@link com.phonemetra.turbo.configuration.TurboSQLConfiguration#getUserAttributes()} methods).
     *
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new JobStealingCollisionSpiMBeanImpl(this),
     ...
     */
    private class JobStealingCollisionSpiMBeanImpl extends TurboSQLSpiMBeanAdapter
        implements JobStealingCollisionSpiMBean {
        /** {@inheritDoc} */
        JobStealingCollisionSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
