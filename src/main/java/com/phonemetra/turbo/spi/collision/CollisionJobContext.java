...
public interface CollisionJobContext {
    ...
    /**
     * Cancels the job. If job was active (executing) method {@link com.phonemetra.turbo.compute.ComputeJob#cancel()} will
     * be called on the job. If job was in wait state, then it will be {@code rejected}
     * prior to execution and {@link com.phonemetra.turbo.compute.ComputeJob#cancel()} will not be called.
     * <p>
