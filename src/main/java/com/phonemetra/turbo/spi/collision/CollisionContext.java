 ...
 * (see {@link com.phonemetra.turbo.compute.ComputeJobContinuation}), then collection of held jobs will
...
public interface CollisionContext {
     ...
     * {@code held} state by calling {@link com.phonemetra.turbo.compute.ComputeJobContinuation#holdcc()} method at
     * which point job will release all resources and will get suspended. If
     * {@link com.phonemetra.turbo.compute.ComputeJobContinuation job continuations} are not used, then this list
