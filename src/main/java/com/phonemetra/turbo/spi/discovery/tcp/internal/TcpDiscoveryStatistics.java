...
import com.phonemetra.turbo.internal.util.GridBoundedLinkedHashMap;
...
/**
 * Statistics for {@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}.
 */
public class TcpDiscoveryStatistics {
    ...
    private final Map<TurboSQLUuid, Long> msgsRcvTs = new GridBoundedLinkedHashMap<>(1024);

    /** Messages processing start timestamps. */
    private final Map<TurboSQLUuid, Long> msgsProcStartTs = new GridBoundedLinkedHashMap<>(1024);

    /** Ring messages sent timestamps. */
    private final Map<TurboSQLUuid, Long> ringMsgsSndTs = new GridBoundedLinkedHashMap<>(1024);
