...
public interface DiscoverySpiNodeAuthenticator {
     ...
     * @throws TurboSQLException If authentication process failed
     *      (invalid credentials should not lead to this exception).
     */
    public SecurityContext authenticateNode(ClusterNode node, SecurityCredentials cred) throws TurboSQLException;
