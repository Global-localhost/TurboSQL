...
import com.phonemetra.turbo.internal.managers.discovery.CustomMessageWrapper;
import com.phonemetra.turbo.internal.managers.discovery.DiscoveryServerOnlyCustomMessage;
import com.phonemetra.turbo.internal.processors.failure.FailureProcessor;
import com.phonemetra.turbo.internal.processors.security.SecurityContext;
import com.phonemetra.turbo.internal.processors.security.SecurityUtils;
import com.phonemetra.turbo.internal.util.GridBoundedLinkedHashSet;
...
import com.phonemetra.turbo.internal.util.worker.GridWorkerListener;
...
import com.phonemetra.turbo.plugin.security.SecurityCredentials;
import com.phonemetra.turbo.plugin.security.SecurityPermission;
import com.phonemetra.turbo.plugin.security.SecurityPermissionSet;
...
import com.phonemetra.turbo.spi.TurboSQLSpiOperationTimeoutHelper;
import com.phonemetra.turbo.spi.TurboSQLSpiThread;
import com.phonemetra.turbo.spi.discovery.DiscoverySpiCustomMessage;
import com.phonemetra.turbo.spi.discovery.DiscoverySpiListener;
import com.phonemetra.turbo.spi.discovery.TurboSQLDiscoveryThread;
import com.phonemetra.turbo.spi.discovery.tcp.internal.DiscoveryDataPacket;
import com.phonemetra.turbo.spi.discovery.tcp.internal.FutureTask;
import com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoveryNode;
import com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoveryNodesRing;
import com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryAbstractMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryAuthFailedMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryCheckFailedMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryClientAckResponse;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryClientMetricsUpdateMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryClientPingRequest;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryClientPingResponse;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryClientReconnectMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryConnectionCheckMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryCustomEventMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryDiscardMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryDummyWakeupMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryDuplicateIdMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryHandshakeRequest;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryHandshakeResponse;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryJoinRequestMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryLoopbackProblemMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryMetricsUpdateMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryNodeAddFinishedMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryNodeAddedMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryNodeFailedMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryNodeLeftMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryPingRequest;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryPingResponse;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryRedirectToClient;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryRingLatencyCheckMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryServerOnlyCustomEventMessage;
import com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryStatusCheckMessage;
...
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_DISCOVERY_CLIENT_RECONNECT_HISTORY_SIZE;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_EVENT_DRIVEN_SERVICE_PROCESSOR_ENABLED;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_NODE_IDS_HISTORY_SIZE;
import static com.phonemetra.turbo.TurboSQLSystemProperties.IGNITE_OPTIMIZED_MARSHALLER_USE_DEFAULT_SUID;
import static com.phonemetra.turbo.TurboSQLSystemProperties.getInteger;
...
import static com.phonemetra.turbo.events.EventType.EVT_NODE_SEGMENTED;
import static com.phonemetra.turbo.failure.FailureType.CRITICAL_ERROR;
...
import static com.phonemetra.turbo.spi.TurboSQLPortProtocol.TCP;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.AUTH_FAILED;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.CHECK_FAILED;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.CONNECTED;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.CONNECTING;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.DISCONNECTED;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.DISCONNECTING;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.DUPLICATE_ID;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.LEFT;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.LOOPBACK_PROBLEM;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.RING_FAILED;
import static com.phonemetra.turbo.spi.discovery.tcp.internal.TcpDiscoverySpiState.STOPPING;
import static com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryStatusCheckMessage.STATUS_OK;
import static com.phonemetra.turbo.spi.discovery.tcp.messages.TcpDiscoveryStatusCheckMessage.STATUS_RECON;
...
class ServerImpl extends TcpDiscoveryImpl {
    ...
    /** */
    private TurboSQLThreadPoolExecutor utilityPool;
    ...
    private final ConcurrentMap<InetSocketAddress, GridPingFutureAdapter<TurboSQLBiTuple<UUID, Boolean>>> pingMap =
        new ConcurrentHashMap<>();

    /** Last listener future. */
    private TurboSQLFuture<?> lastCustomEvtLsnrFut;
    ...
    /** {@inheritDoc} */
    @Override public boolean allNodesSupport(TurboSQLFeatures feature) {
        // It is ok to see visible node without order here because attributes are available when node is created.
        return TurboSQLFeatures.allNodesSupports(upcast(ring.allNodes()), feature);
    }

    /** {@inheritDoc} */
    @Override public int boundPort() throws TurboSQLSpiException {
        if (tcpSrvr == null)
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        utilityPool = new TurboSQLThreadPoolExecutor("disco-pool",
            spi.turboSQL().name(),
            0,
            1,
            2000,
        ...
        if (debugMode) {
            if (!log.isInfoEnabled())
                throw new TurboSQLSpiException("Info log level should be enabled for TCP discovery to work " +
                    "in debug mode.");
        ...
        if (spi.ipFinder.isShared())
            ...
            if (F.isEmpty(spi.ipFinder.getRegisteredAddresses()))
                throw new TurboSQLSpiException("Non-shared IP finder must have IP addresses specified in " +
    ...
    /** {@inheritDoc} */
    @Override public void onContextInitialized0(TurboSQLSpiContext spiCtx) throws TurboSQLSpiException {
     ...
     */
    private void spiStop0(boolean disconnect) throws TurboSQLSpiException {
        ...
        TurboSQLUtils.shutdownNow(ServerImpl.class, utilityPool, log);
    ...
    private boolean pingNode(TcpDiscoveryNode node) {
        ...
        for (InetSocketAddress addr : spi.getNodeAddresses(node, U.sameMacs(locNode, node))) {
            try {
                ...
                TurboSQLBiTuple<UUID, Boolean> t = pingNode(addr, node.id(), clientNodeId);
     ...
     */
    @Nullable private TurboSQLBiTuple<UUID, Boolean> pingNode(InetSocketAddress addr, @Nullable UUID nodeId,
        @Nullable UUID clientNodeId) throws TurboSQLCheckedException {
        assert addr != null;

        UUID locNodeId = getLocalNodeId();

        TurboSQLSpiOperationTimeoutHelper timeoutHelper = new TurboSQLSpiOperationTimeoutHelper(spi,
            clientNodeId == null);
        ...
        GridPingFutureAdapter<TurboSQLBiTuple<UUID, Boolean>> fut = new GridPingFutureAdapter<>(nodeId);

        GridPingFutureAdapter<TurboSQLBiTuple<UUID, Boolean>> oldFut = pingMap.putIfAbsent(addr, fut);
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        TurboSQLBiTuple<UUID, Boolean> t = F.t(res.creatorNodeId(), res.clientExists());
                        ...
                        if (nodeId != null && !nodeAlive(nodeId)) {
                            ...
                            fut.onDone((TurboSQLBiTuple<UUID, Boolean>)null);
    ...
    /** {@inheritDoc} */
    @Override public void disconnect() throws TurboSQLSpiException {
        spiStop0(true);
    }
    ...
    @Override public void sendCustomEvent(DiscoverySpiCustomMessage evt) {
        try {
            ...
            throw new TurboSQLSpiException("Failed to marshal custom event: " + evt, e);
        }
    }
     ...
     *
     * @throws TurboSQLSpiException If any error occurs.
     */
    private void joinTopology() throws TurboSQLSpiException {
        synchronized (mux) {
        ...
        SecurityCredentials locCred = (SecurityCredentials)locNode.getAttributes()
            .get(TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS);
        ...
        while (true) {
            if (!sendJoinRequestMessage(discoveryData)) {
                ...
                FutureTask<Void> fut = msgWorker.addTask(new FutureTask<Void>() {
                    @Override protected Void body() {
                        ...
                        locNode.attributes().remove(TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS);
                ...
                try {
                    ...
                    throw new TurboSQLSpiException(e);
                }
            ...
            synchronized (mux) {
                ...
                if (spiState == CONNECTED)
                    ...
                    throw new TurboSQLSpiException("Unable to connect to next nodes in a ring, it seems local node is " +
                    ...
                    throw new TurboSQLSpiException("Failed to add node to topology because " + firstNode +
    ...
    private void localAuthentication(SecurityCredentials locCred){
        ...
        try {
            ...
            if (subj == null)
                throw new TurboSQLSpiException("Authentication failed for local node: " + locNode.id());

            Map<String, Object> attrs = new HashMap<>(locNode.attributes());

            attrs.put(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT_V2, U.marshal(spi.marshaller(), subj));
            attrs.put(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT, marshalWithSecurityVersion(subj, 1));

            locNode.setAttributes(attrs);

        }
        catch (TurboSQLException | TurboSQLCheckedException e) {
            throw new TurboSQLSpiException("Failed to authenticate local node (will shutdown local node).", e);
        }
    }

    /**
     * Tries to send join request message to a random node presenting in topology.
     * Address is provided by {@link com.phonemetra.turbo.spi.discovery.tcp.ipfinder.TcpDiscoveryIpFinder} and message is
     ...
     * @throws TurboSQLSpiException If any error occurs.
     */
    private boolean sendJoinRequestMessage(DiscoveryDataPacket discoveryData) throws TurboSQLSpiException {
        ...
        while (true) {
            ...
            for (InetSocketAddress addr : addrs) {
                try {
                    TurboSQLSpiOperationTimeoutHelper timeoutHelper = new TurboSQLSpiOperationTimeoutHelper(spi, true);
                ...
                if (joinImpossible)
                    throw new TurboSQLSpiException("Impossible to continue join, " +
            ...
            if (retry) {
                ...
                TurboSQLCheckedException e = null;

                if (!errs.isEmpty()) {
                    e = new TurboSQLCheckedException("Multiple connection attempts failed.");
                ...
                catch (TurboSQLInterruptedCheckedException ex) {
                    throw new TurboSQLSpiException("Thread has been interrupted.", ex);
                }
            }
            else
                break;
            ...
            try {
                ...
                if (X.hasCause(e, SSLException.class)) {
                    if (--sslConnectAttempts == 0)
                        throw new TurboSQLException("Unable to establish secure connection. " +
     ...
     * @throws TurboSQLSpiException If marshalling failed.
     */
    private void marshalCredentials(TcpDiscoveryNode node, SecurityCredentials cred) throws TurboSQLSpiException {
        try {
            // Use security-unsafe getter.
            Map<String, Object> attrs = new HashMap<>(node.getAttributes());

            attrs.put(TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS, spi.marshaller().marshal(cred));

            node.setAttributes(attrs);
        }
        catch (TurboSQLCheckedException e) {
            throw new TurboSQLSpiException("Failed to marshal node security credentials: " + node.id(), e);
        }
    }
     ...
     * @throws TurboSQLSpiException If unmarshal fails.
     */
    private SecurityCredentials unmarshalCredentials(TcpDiscoveryNode node) throws TurboSQLSpiException {
        try {
            byte[] credBytes = (byte[])node.getAttributes().get(TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS);
            ...
            throw new TurboSQLSpiException("Failed to unmarshal node security credentials: " + node.id(), e);
        }
    }
     ...
     *
     * @param type Discovery event type. See {@link com.phonemetra.turbo.events.DiscoveryEvent} for more details.
    ...
    private void prepareNodeAddedMessage(
        ...
        @Nullable TurboSQLUuid discardCustomMsgId
        ) {
    ...
    /** {@inheritDoc} */
    @Override public void reconnect() throws TurboSQLSpiException {
        throw new UnsupportedOperationException("Reconnect is not supported for server.");
    }

    /** {@inheritDoc} */
    @Override protected Collection<TurboSQLSpiThread> threads() {
        Collection<TurboSQLSpiThread> threads;
        ...
        for (ClientMessageWorker wrk : clientMsgWorkers.values()) {
            ...
            assert t instanceof TurboSQLSpiThread;

            threads.add((TurboSQLSpiThread)t);
        }
        ...
        if (tcpSrvr0 != null) {
            ...
            if (tcpSrvThread != null) {
                assert tcpSrvThread instanceof TurboSQLSpiThread;

                threads.add((TurboSQLSpiThread)tcpSrvThread);
            }
        }
        ...
        if (msgWorkerThread != null) {
            assert msgWorkerThread instanceof TurboSQLSpiThread;

            threads.add((TurboSQLSpiThread)msgWorkerThread);
        }

        threads.add(statsPrinter);

        threads.removeAll(Collections.<TurboSQLSpiThread>singleton(null));
    ...
    /** {@inheritDoc} */
    @Override public void dumpDebugInfo(TurboSQLLogger log) {
        if (!debugMode) {
    ...
    /** {@inheritDoc} */
    @Override public void dumpRingStructure(TurboSQLLogger log) {
     ...
     * if and only if {@link com.phonemetra.turbo.spi.discovery.tcp.ipfinder.TcpDiscoveryIpFinder#isShared()} is {@code true}.
     */
    private class IpFinderCleaner extends TurboSQLSpiThread {
        /**
         * Constructor.
         */
        private IpFinderCleaner() {
            super(spi.turboSQL().name(), "tcp-disco-ip-finder-cleaner", log);
     ...
     */
    private byte[] marshalWithSecurityVersion(Object obj, int ver) throws TurboSQLCheckedException {
        try {
     ...
     */
    private <T> T unmarshalWithSecurityVersion(byte[] bytes, int ver) throws TurboSQLCheckedException {
        try {
            if (ver > 0)
                SecurityUtils.serializeVersion(ver);

            return spi.marshaller().unmarshal(bytes, U.resolveClassLoader(spi.turboSQL().configuration()));
        }
        finally {
            SecurityUtils.restoreDefaultSerializeVersion();
        }
    ...
    private static WorkersRegistry getWorkerRegistry(TcpDiscoverySpi spi) {
        return spi.turboSQL() instanceof TurboSQLEx ? ((TurboSQLEx)spi.turboSQL()).context().workersRegistry() : null;
    }
    ...
    private class EnsuredMessageHistory {
         ...
         */
        @Nullable Collection<TcpDiscoveryAbstractMessage> messages(@Nullable TurboSQLUuid lastMsgId,
    ...
    private static class PendingMessages implements Iterable<TcpDiscoveryAbstractMessage> {
        ...
        private Set<TurboSQLUuid> procCustomMsgs = new GridBoundedLinkedHashSet<>(MAX * 2);

        /** Discarded message ID. */
        private TurboSQLUuid discardId;

        /** Discarded custom message ID. */
        private TurboSQLUuid customDiscardId;
        ...
        void reset(
            ...
            @Nullable TurboSQLUuid discardId,
            @Nullable TurboSQLUuid customDiscardId
        ) {
            this.msgs.clear();
         ...
         */
        void discard(TurboSQLUuid id, boolean custom) {
         ...
         */
        private boolean hasPendingMessage(boolean custom, TurboSQLUuid id) {
    ...
    private class RingMessageWorker extends MessageWorker<TcpDiscoveryAbstractMessage> {
         ...
         * @param log Logger.
         */
        private RingMessageWorker(TurboSQLLogger log) {
        ...
        @Override protected void body() throws InterruptedException {
            ...
            try {
                ...
                if (!spi.isNodeStopping0() && spiStateCopy() != DISCONNECTING) {
                    final TurboSQL turboSQL = spi.turboSQL();
                ...
                // Must be processed by TurboSQLSpiThread as well.
                throw e;
            }
            finally {
                if (spi.turboSQL() instanceof TurboSQLEx) {
                    if (err == null && !spi.isNodeStopping0()&& spiStateCopy() != DISCONNECTING)
                        err = new IllegalStateException("Worker " + name() + " is terminated unexpectedly.");

                    FailureProcessor failure = ((TurboSQLEx)spi.turboSQL()).context().failure();
                        ...
                        if (clientMsgWorker.clientNodeId.equals(node.id())) {
                            try {
                                msg0 = U.unmarshal(spi.marshaller(), msgBytes,
                                    U.resolveClassLoader(spi.turboSQL().configuration()));
        ...
        private void sendMessageAcrossRing(TcpDiscoveryAbstractMessage msg) {
            ...
            for (TurboSQLInClosure<TcpDiscoveryAbstractMessage> msgLsnr : spi.sndMsgLsnrs)
                msgLsnr.apply(msg);
            ...
            ringLoop: while (true) {
                ...
                addr: for (InetSocketAddress addr : spi.getNodeAddresses(next, sameHost)) {
                    ...
                    TurboSQLSpiOperationTimeoutHelper timeoutHelper = null;

                    while (true) {
                        if (sock == null) {
                            if (timeoutHelper == null)
                                timeoutHelper = new TurboSQLSpiOperationTimeoutHelper(spi, true);
        ...
        private void processJoinRequestMessage(final TcpDiscoveryJoinRequestMessage msg) {
            ...
            if (isLocalNodeCoordinator()) {
                ...
                TurboSQLNodeValidationResult err;
                ...
                if (err != null) {
                    final TurboSQLNodeValidationResult err0 = err;
        ...
        private boolean isDiscoDataPaketCompressed(TcpDiscoveryNode node) {
            return TurboSQLFeatures.nodeSupports(node, TurboSQLFeatures.DATA_PACKET_COMPRESSION) &&
                allNodesSupport(TurboSQLFeatures.DATA_PACKET_COMPRESSION);
        }
         ...
         * @param msg Message.
         * @throws TurboSQLSpiException Last failure if all attempts failed.
         */
        private void trySendMessageDirectly(TcpDiscoveryNode node, TcpDiscoveryAbstractMessage msg)
            ...
            if (node.clientRouterNodeId() != null) {
                ...
                if (routerNode == null)
                    throw new TurboSQLSpiException("Router node for client does not exist: " + node);

                if (routerNode.clientRouterNodeId() != null)
                    throw new TurboSQLSpiException("Router node is a client node: " + node);

                if (routerNode.id().equals(getLocalNodeId())) {
                    ClientMessageWorker worker = clientMsgWorkers.get(node.id());

                    if (worker == null)
                        throw new TurboSQLSpiException("Client node already disconnected: " + node);
                ...
                if (!isLocalNodeCoordinator() && spi.nodeAuth != null && spi.nodeAuth.isGlobalNodeAuthentication()) {
                    ...
                    try {
                        ...
                        if (cred == null) {
                            ...
                            byte[] subjBytes = node.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT);
                            byte[] subjBytesV2 = node.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT_V2);
                ...
                if (topChanged) {
                    ...
                    if (dataPacket.hasJoiningNodeData()) {
                        if (spiState == CONNECTED) {
                            ...
                            spi.onExchange(dataPacket, U.resolveClassLoader(spi.turboSQL().configuration()));
                    ...
                    if (spiState == CONNECTING && locNode.internalOrder() != node.internalOrder()) {
                        ...
                        if (top != null && !top.isEmpty()) {
                            ...
                            if (spi.nodeAuth != null && spi.nodeAuth.isGlobalNodeAuthentication()) {
                                ...
                                try {
                                    byte[] rmSubj = node.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT);
                                    byte[] locSubj = locNode.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT);

                                    byte[] rmSubjV2 = node.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT_V2);
                                    byte[] locSubjV2 = locNode.attribute(TurboSQLNodeAttributes.ATTR_SECURITY_SUBJECT_V2);
        ...
        private void processNodeAddFinishedMessage(TcpDiscoveryNodeAddFinishedMessage msg) {
            ...
            if (msg.verified() && locNodeId.equals(nodeId) && state == CONNECTING) {
                ...
                if (gridDiscoveryData != null)
                    spi.onExchange(gridDiscoveryData, U.resolveClassLoader(spi.turboSQL().configuration()));
        ...
        private void processNodeLeftMessage(TcpDiscoveryNodeLeftMessage msg) {
            ...
            if (msg.verified() && !locNodeId.equals(leavingNodeId)) {
                ...
                if (msg.client()) {
                    ...
                    catch (TurboSQLCheckedException | IOException e) {
                        if (log.isDebugEnabled())
                                ...
                                if (!aliveCheck && isLocalNodeCoordinator()) {
                                    ...
                                    if (!failedNode) {
                                        U.warn(log, "Failing client node due to not receiving metrics updates " +
                                            ...
                                            "'TurboSQLConfiguration.clientFailureDetectionTimeout' " +
        ...
        private void processCustomMessage(TcpDiscoveryCustomEventMessage msg, boolean waitForNotification) {
            if (isLocalNodeCoordinator()) {
                ...
                if (!msg.verified()) {
                    ...
                    try {
                        msgObj = msg.message(spi.marshaller(), U.resolveClassLoader(spi.turboSQL().configuration()));
                    }
                    catch (Throwable e) {
        ...
        private void notifyDiscoveryListener(TcpDiscoveryCustomEventMessage msg, boolean waitForNotification) {
            ...
            if (lsnr != null && (spiState == CONNECTED || spiState == DISCONNECTING)) {
                ...
                try {
                    ...
                    throw new TurboSQLException("Failed to unmarshal discovery custom message: " + msg, t);
                }

                TurboSQLFuture<?> fut = lsnr.onDiscovery(DiscoveryCustomEvent.EVT_DISCOVERY_CUSTOM_EVT,
                    msg.topologyVersion(),
                    node,
                    snapshot,
                    hist,
                ...
                if (msgObj.isMutable()) {
                    try {
                        ...
                        throw new TurboSQLException("Failed to marshal mutable discovery message: " + msgObj, t);
                    }
                }
            }
        }
    ...
    private class TcpServerThread extends TurboSQLSpiThread {
        /** */
         ...
         * @param log Logger.
         */
        private TcpServerThread(TcpServer worker, TurboSQLLogger log) {
            super(worker.turboSQLInstanceName(), worker.name(), log);
    ...
    private class TcpServer extends GridWorker {
         ...
         */
        TcpServer(TurboSQLLogger log) throws TurboSQLSpiException {
            super(spi.turboSQL().name(), "tcp-disco-srvr-[]", log, getWorkerRegistry(spi));
                ...
                try {
                    ...
                    if (log.isInfoEnabled()) {
                        log.info("Successfully bound to TCP port [port=" + port +
                            ...
                            ", locNodeId=" + spi.turboSQL().configuration().getNodeId() +
                            ']');
                    }
            ...
            throw new TurboSQLSpiException("Failed to bind TCP server socket (possibly all ports in range " +
     ...
     */
    private class SocketReader extends TurboSQLSpiThread {
        ...
        SocketReader(Socket sock) {
            super(spi.turboSQL().name(), "tcp-disco-sock-reader-[]", log);
        ...
        @Override protected void body() throws InterruptedException {
            ...
            try {
                ...
                try {
                    ...
                    for (TurboSQLInClosure<Socket> connLsnr : spi.incomeConnLsnrs)
                        connLsnr.apply(sock);
                    ...
                    if (msg instanceof TcpDiscoveryPingRequest) {
                        if (!spi.isNodeStopping0()) {
                            ...
                            TurboSQLSpiOperationTimeoutHelper timeoutHelper =
                                new TurboSQLSpiOperationTimeoutHelper(spi, true);
                    ...
                    res.setDiscoveryDataPacketCompression(allNodesSupport(TurboSQLFeatures.DATA_PACKET_COMPRESSION));
            ...
            for (InetSocketAddress addr : spi.getNodeAddresses(node, false)) {
                try {
                    if (!(addr.getAddress().isLoopbackAddress() && locNode.socketAddresses().contains(addr))) {
                        TurboSQLBiTuple<UUID, Boolean> t = pingNode(addr, node.id(), null);
     ...
     */
    private class StatisticsPrinter extends TurboSQLSpiThread {
        /**
         * Constructor.
         */
        StatisticsPrinter() {
            super(spi.turboSQL().name(), "tcp-disco-stats-printer", log);
    ...
    private class ClientMessageWorker extends MessageWorker<T2<TcpDiscoveryAbstractMessage, byte[]>> {
        ...
        /** */
        private TurboSQLProductVersion clientVer;
         ...
         * @param log Logger.
         */
        private ClientMessageWorker(Socket sock, UUID clientNodeId, TurboSQLLogger log) {
         ...
         */
        void clientVersion(TurboSQLProductVersion clientVer) {
            ...
            try {
                ...
                if (msg instanceof TcpDiscoveryClientAckResponse) {
                    if (clientVer == null) {
                        ...
                        if (node != null)
                            clientVer = TurboSQLUtils.productVersion(node);
         ...
         */
        public boolean ping(TurboSQLSpiOperationTimeoutHelper timeoutHelper) throws InterruptedException {
            if (spi.isNodeStopping0())
                return false;
            ...
            try {
            ...
            catch (TurboSQLInterruptedCheckedException ignored) {
                ...
                throw new TurboSQLSpiException("Internal error: ping future cannot be done with exception", e);
            }
        }
    ...
    private class MessageWorkerThreadWithCleanup<T> extends MessageWorkerThread<MessageWorker<T>> {
        ...
        /** {@inheritDoc} */
        private MessageWorkerThreadWithCleanup(MessageWorker<T> worker, TurboSQLLogger log) {
            super(worker, log);
        }
    ...
    /** */
    private class MessageWorkerDiscoveryThread extends MessageWorkerThread<GridWorker> implements TurboSQLDiscoveryThread {
        /** {@inheritDoc} */
        private MessageWorkerDiscoveryThread(GridWorker worker, TurboSQLLogger log) {
            super(worker, log);
        }
    }

    /**
     * Slightly modified {@link TurboSQLSpiThread} intended to use with message workers.
     */
    private class MessageWorkerThread<W extends GridWorker> extends TurboSQLSpiThread {
        /**
        ...
        /** {@inheritDoc} */
        private MessageWorkerThread(W worker, TurboSQLLogger log) {
            super(worker.turboSQLInstanceName(), worker.name(), log);
    ...
    private abstract class MessageWorker<T> extends GridWorker {
        ...
        protected MessageWorker(
            ...
            super(spi.turboSQL().name(), name, log, lsnr);
