...
public class TcpDiscoveryDiscardMessage extends TcpDiscoveryAbstractMessage {
    ...
    private final TurboSQLUuid msgId;
     ...
     */
    public TcpDiscoveryDiscardMessage(UUID creatorNodeId, TurboSQLUuid msgId, boolean customMsgDiscard) {
        super(creatorNodeId);
