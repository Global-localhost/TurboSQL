...
package com.phonemetra.turbo.spi.discovery.tcp.messages;
...
public class TcpDiscoveryNodeAddedMessage extends TcpDiscoveryAbstractMessage {
    ...
    private TurboSQLUuid discardMsgId;

    /** Discarded message ID. */
    private TurboSQLUuid discardCustomMsgId;
     ...
     */
    @Nullable public TurboSQLUuid discardedMessageId() {
        return discardMsgId;
    }
     ...
     * @return Discarded message ID.
     */
    @Nullable public TurboSQLUuid discardedCustomMessageId() {
    ...
    public void messages(
        ...
        @Nullable TurboSQLUuid discardMsgId,
