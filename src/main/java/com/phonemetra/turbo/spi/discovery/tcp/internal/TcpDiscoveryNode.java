...
import com.phonemetra.turbo.internal.managers.discovery.TurboSQLClusterNode;
 ...
 */
public class TcpDiscoveryNode extends GridMetadataAwareAdapter implements TurboSQLClusterNode,
    ...
    /** Version. */
    private TurboSQLProductVersion ver;
    ...
    @Override public <T> T attribute(String name) {
        ...
        if (TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS.equals(name))
            return null;
    ...
    @Override public Map<String, Object> attributes() {
        // Even though discovery SPI removes this attribute after authentication, keep this check for safety.
        return F.view(attrs, new TurboSQLPredicate<String>() {
            @Override public boolean apply(String s) {
                return !TurboSQLNodeAttributes.ATTR_SECURITY_CREDENTIALS.equals(s);
            }
        });
    }
     ...
     * @param ver Version.
     */
    public void version(TurboSQLProductVersion ver) {
        assert ver != null;
    ...
    @Override public boolean isClient() {
        if (!cacheCliInit) {
            Boolean clientModeAttr = ((ClusterNode) this).attribute(TurboSQLNodeAttributes.ATTR_CLIENT_MODE);
    ...
    @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        ver = (TurboSQLProductVersion)in.readObject();
