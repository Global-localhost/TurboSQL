 ...
 * <ul>
 * <li>
 * Every node gets an order number assigned to it which is provided via {@link com.phonemetra.turbo.cluster.ClusterNode#order()}
 ...
 * </li>
 * <li>
 * All {@link com.phonemetra.turbo.events.EventType#EVT_NODE_JOINED} events come in proper order. This means that all
