...
package com.phonemetra.turbo.spi.discovery;
 ...
 * <p>
 * The default discovery SPI is {@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}
 * with default configuration which allows all nodes in local network
 * (with enabled multicast) to discover each other.
 * <p>
 * TurboSQL provides the following {@code GridDeploymentSpi} implementation:
 * <ul>
 * <li>{@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}</li>
 * </ul>
 ...
 */
public interface DiscoverySpi extends TurboSQLSpi {
    /**
     * Gets consistent ID.
     *
     * @return Consistent ID of this TurboSQL instance or {@code null} if not applicable.
     * @throws TurboSQLSpiException If failed.
     */
    @Nullable public Serializable consistentId() throws TurboSQLSpiException;
     ...
     */
    public void setNodeAttributes(Map<String, Object> attrs, TurboSQLProductVersion ver);

    /**
     * Sets a listener for discovery events. Refer to
     * {@link com.phonemetra.turbo.events.DiscoveryEvent} for a set of all possible
     * discovery events.
     * <p>
     * TODO: This method should be removed from public API in Phonemetra TurboSQL 3.0
     *
    ...
    /**
     * Sets a handler for initial data exchange between TurboSQL nodes.
     *
     ...
     */
    public void disconnect() throws TurboSQLSpiException;
     ...
     * @throws TurboSQLException if failed to sent the event message.
     */
    public void sendCustomEvent(DiscoverySpiCustomMessage msg) throws TurboSQLException;
