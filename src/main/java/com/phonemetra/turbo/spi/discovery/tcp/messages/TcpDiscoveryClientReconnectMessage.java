...
public class TcpDiscoveryClientReconnectMessage extends TcpDiscoveryAbstractMessage {
    ...
    /** Last message ID. */
    private final TurboSQLUuid lastMsgId;
     ...
     */
    public TcpDiscoveryClientReconnectMessage(UUID creatorNodeId, UUID routerNodeId, TurboSQLUuid lastMsgId) {
        super(creatorNodeId);
     ...
     */
    public TurboSQLUuid lastMessageId() {
        return lastMsgId;
    }
