...
import com.phonemetra.turbo.internal.util.typedef.PN;
...
/**
 * Convenient way to represent topology for {@link com.phonemetra.turbo.spi.discovery.tcp.TcpDiscoverySpi}
 */
public class TcpDiscoveryNodesRing {
    /** Visible nodes filter. */
    public static final TurboSQLPredicate<TcpDiscoveryNode> VISIBLE_NODES = new P1<TcpDiscoveryNode>() {
    ...
    /** */
    private TurboSQLProductVersion minNodeVer;

    /**
     * @return Minimum node version.
     */
    public TurboSQLProductVersion minimumNodeVersion() {
     ...
     */
    private Collection<TcpDiscoveryNode> nodes(TurboSQLPredicate<? super TcpDiscoveryNode>... p) {
        rwLock.readLock().lock();
