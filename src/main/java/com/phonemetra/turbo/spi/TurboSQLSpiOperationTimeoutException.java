 ...
 *
 * For more information refer to {@link TurboSQLConfiguration#setFailureDetectionTimeout(long)} and
 * {@link TurboSQLSpiOperationTimeoutHelper}.
 */
public class TurboSQLSpiOperationTimeoutException extends TurboSQLCheckedException {
    /** */
     ...
     */
    public TurboSQLSpiOperationTimeoutException(String msg) {
        super(msg);
    }
}