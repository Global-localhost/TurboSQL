 ...
 */
public class TurboSQLSpiVersionCheckException extends TurboSQLSpiException {
    /** */
     ...
     */
    public TurboSQLSpiVersionCheckException(String msg) {
        super(msg);
    }
     ...
     */
    public TurboSQLSpiVersionCheckException(Throwable cause) {
     ...
     */
    public TurboSQLSpiVersionCheckException(String msg, Throwable cause) {
        super(msg, cause);
    }
}