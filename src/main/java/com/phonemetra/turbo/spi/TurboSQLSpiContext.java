 ...
 */
public interface TurboSQLSpiContext {
    /**
     * Gets a collection of remote grid nodes. Remote nodes are discovered via underlying
     * {@link com.phonemetra.turbo.spi.discovery.DiscoverySpi} implementation used. Unlike {@link #nodes()},
     * this method does not include local grid node.
     *
     * @return Collection of remote grid nodes.
     * @see #localNode()
     * @see #nodes()
     * @see com.phonemetra.turbo.spi.discovery.DiscoverySpi
     */
    public Collection<ClusterNode> remoteNodes();

    /**
     * Gets a collection of all grid nodes. Remote nodes are discovered via underlying
     * {@link com.phonemetra.turbo.spi.discovery.DiscoverySpi} implementation used. Unlike {@link #remoteNodes()},
    ...
    /**
     * Gets local grid node. Instance of local node is provided by underlying {@link com.phonemetra.turbo.spi.discovery.DiscoverySpi}
     * implementation used.
     *
     ...
     * underlying {@link com.phonemetra.turbo.spi.discovery.DiscoverySpi} implementation used.
     *
     ...
     * {@link com.phonemetra.turbo.spi.discovery.DiscoverySpi#pingNode(UUID)} implementation.
     * <p>
     ...
     * {@link com.phonemetra.turbo.spi.communication.CommunicationSpi} implementation used.
     *
     * @param node Node to send a message to.
     * @param msg Message to send.
     * @param topic Topic to send message to.
     * @throws TurboSQLSpiException If failed to send a message to remote node.
     */
    public void send(ClusterNode node, Serializable msg, String topic) throws TurboSQLSpiException;

    /**
     * Register an local message listener to receive messages sent by remote nodes. The underlying
     * communication mechanism is defined by {@link com.phonemetra.turbo.spi.communication.CommunicationSpi} implementation used.
     *
     * @param topic Topic to subscribe to.
     * @param p Message predicate.
     */
    public void addLocalMessageListener(@Nullable Object topic, TurboSQLBiPredicate<UUID, ?> p);
     ...
     * @param p Message predicate.
     */
    public void removeLocalMessageListener(@Nullable Object topic, TurboSQLBiPredicate<UUID, ?> p);
     ...
     * can send messages by calling {@link #send(com.phonemetra.turbo.cluster.ClusterNode, Serializable, String)} method.
     *
     * @param lsnr Message listener to register.
     * @param topic Topic to register listener for.
     *
     * @deprecated Use {@link #addLocalMessageListener(Object, TurboSQLBiPredicate)} instead.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link #removeLocalMessageListener(Object, TurboSQLBiPredicate)} instead.
     */
    @Deprecated
     ...
     */
    public void registerPort(int port, TurboSQLPortProtocol proto);
     ...
     * @param proto Protocol.
     */
    public void deregisterPort(int port, TurboSQLPortProtocol proto);
     ...
     */
    @Nullable public TurboSQLNodeValidationResult validateNode(ClusterNode node);

    /**
     * @param node Node.
     * @param discoData Disco data.
     */
    @Nullable public TurboSQLNodeValidationResult validateNode(ClusterNode node, DiscoveryDataBag discoData);

    /**
     * Gets collection of authenticated subjects together with their permissions.
     *
     * @return Collection of authenticated subjects.
     * @throws TurboSQLException If any exception occurs.
     */
    public Collection<SecuritySubject> authenticatedSubjects() throws TurboSQLException;
     ...
     * @throws TurboSQLException If any exception occurs.
     */
    public SecuritySubject authenticatedSubject(UUID subjId) throws TurboSQLException;
     ...
     */
    public void addTimeoutObject(TurboSQLSpiTimeoutObject c);

    /**
     * @param c Timeout object.
     */
    public void removeTimeoutObject(TurboSQLSpiTimeoutObject c);
