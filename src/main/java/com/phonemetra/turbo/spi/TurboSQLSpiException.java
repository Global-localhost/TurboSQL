 ...
 */
public class TurboSQLSpiException extends TurboSQLException {
    /** */
     ...
     */
    public TurboSQLSpiException(String msg) {
        super(msg);
    }
     ...
     */
    public TurboSQLSpiException(Throwable cause) {
     ...
     */
    public TurboSQLSpiException(String msg, Throwable cause) {
        super(msg, cause);
    }
}