...
package com.phonemetra.turbo.spi.deployment;
 ...
 * {@link com.phonemetra.turbo.configuration.TurboSQLConfiguration#isPeerClassLoadingEnabled()}), then it is usually
 ...
 * </strong>
 * <p>
 * TurboSQL provides following {@code GridDeploymentSpi} implementations out of the box:
 * <ul>
 * <li>{@link com.phonemetra.turbo.spi.deployment.local.LocalDeploymentSpi}</li>
 * <li>{@turboSQLlink com.phonemetra.turbo.spi.deployment.uri.UriDeploymentSpi}</li>
 * </ul>
 * <b>NOTE:</b> SPI methods should never be used directly. SPIs provide
 * internal view on the subsystem and is used internally by TurboSQL. In rare use cases when
 ...
 */
public interface DeploymentSpi extends TurboSQLSpi {
    /**
     ...
     * {@link com.phonemetra.turbo.compute.ComputeTaskName} annotations. The classes that have this annotation
     ...
     *      Currently the only alias in the system is {@link com.phonemetra.turbo.compute.ComputeTaskName} for
     *      task classes; in future, there may be others.
     * @return {@code True} if resource was registered.
     * @throws com.phonemetra.turbo.spi.TurboSQLSpiException If registration failed.
     */
    public boolean register(ClassLoader ldr, Class<?> rsrc) throws TurboSQLSpiException;

    /**
     * Unregisters all class loaders that have a class with given name or have
     * a class with give {@link com.phonemetra.turbo.compute.ComputeTaskName} value.
     *
     * @param rsrcName Either class name or {@link com.phonemetra.turbo.compute.ComputeTaskName} value for a class
