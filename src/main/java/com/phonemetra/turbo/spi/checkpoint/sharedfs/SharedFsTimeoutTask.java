...
/**
 * Implementation of {@link com.phonemetra.turbo.spi.TurboSQLSpiThread} that takes care about outdated files.
 ...
 */
class SharedFsTimeoutTask extends TurboSQLSpiThread {
     ...
     */
    SharedFsTimeoutTask(String turboSQLInstanceName, Marshaller marshaller, TurboSQLLogger log) {
        super(turboSQLInstanceName, "grid-sharedfs-timeout-worker", log);
