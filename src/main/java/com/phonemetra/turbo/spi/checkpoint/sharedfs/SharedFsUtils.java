...
final class SharedFsUtils {
     ...
     * @throws TurboSQLCheckedException Thrown if data could not be converted
     *    to {@link SharedFsCheckpointData} object.
     * @throws IOException Thrown if file read error occurred.
     */
    static SharedFsCheckpointData read(File file, Marshaller m, TurboSQLLogger log)
     ...
     * @param m Grid marshaller.
     * @param log Messages logger.
     * @throws TurboSQLCheckedException Thrown if data could not be marshalled.
     * @throws IOException Thrown if file write operation failed.
     */
    static void write(File file, SharedFsCheckpointData data, Marshaller m, TurboSQLLogger log)
        throws IOException, TurboSQLCheckedException {
        assert file != null;
        assert m != null;
        assert data != null;
