...
package com.phonemetra.turbo.spi.checkpoint;
 ...
 * <ul>
 * <li>{@link com.phonemetra.turbo.compute.ComputeTaskSession#loadCheckpoint(String)}</li>
 * <li>{@link com.phonemetra.turbo.compute.ComputeTaskSession#removeCheckpoint(String)}</li>
 * <li>{@link com.phonemetra.turbo.compute.ComputeTaskSession#saveCheckpoint(String, Object)}</li>
 * <li>{@link com.phonemetra.turbo.compute.ComputeTaskSession#saveCheckpoint(String, Object, com.phonemetra.turbo.compute.ComputeTaskSessionScope, long)}</li>
 * <li>{@link com.phonemetra.turbo.compute.ComputeTaskSession#saveCheckpoint(String, Object, com.phonemetra.turbo.compute.ComputeTaskSessionScope, long, boolean)}</li>
 * </ul>
 * <p>
 * TurboSQL provides the following {@code GridCheckpointSpi} implementations:
 * <ul>
 * <li>{@link com.phonemetra.turbo.spi.checkpoint.noop.NoopCheckpointSpi} - default</li>
 * <li>{@link com.phonemetra.turbo.spi.checkpoint.sharedfs.SharedFsCheckpointSpi}</li>
 * <li>{@turboSQLlink com.phonemetra.turbo.spi.checkpoint.s3.S3CheckpointSpi}</li>
 * <li>{@link com.phonemetra.turbo.spi.checkpoint.jdbc.JdbcCheckpointSpi}</li>
 * <li>{@link com.phonemetra.turbo.spi.checkpoint.cache.CacheCheckpointSpi}</li>
 * </ul>
 ...
 */
public interface CheckpointSpi extends TurboSQLSpi {
    /**
     ...
     *      key.
     * @throws com.phonemetra.turbo.spi.TurboSQLSpiException Thrown in case of any error while loading
     *      checkpoint data. Note that in case when given {@code key} is not
     *      found this method will return {@code null}.
     */
    @Nullable public byte[] loadCheckpoint(String key) throws TurboSQLSpiException;
     ...
     * @throws com.phonemetra.turbo.spi.TurboSQLSpiException Thrown in case of any error while saving
     *    checkpoint data.
     */
    public boolean saveCheckpoint(String key, byte[] state, long timeout, boolean overwrite) throws TurboSQLSpiException;
