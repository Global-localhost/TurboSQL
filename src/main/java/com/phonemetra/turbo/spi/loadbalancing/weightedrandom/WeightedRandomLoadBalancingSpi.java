...
package com.phonemetra.turbo.spi.loadbalancing.weightedrandom;
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.loadBalancing.weightedrandom.WeightedRandomLoadBalancingSpi"&gt;
...
public class WeightedRandomLoadBalancingSpi extends TurboSQLSpiAdapter implements LoadBalancingSpi {
    /** Random number generator. */
    private static final Random RAND = new Random();

    /**
     * Name of node attribute used to indicate load weight of a node
     * (value is {@code "turboSQL.node.weight.attr.name"}).
     *
     * @see com.phonemetra.turbo.cluster.ClusterNode#attributes()
     */
    public static final String NODE_WEIGHT_ATTR_NAME = "turboSQL.node.weight.attr.name";
    ...
    @Override public void spiStart(@Nullable String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new WeightedRandomLoadBalancingSpiMBeanImpl(this),
        ...
        getSpiContext().addLocalEventListener(evtLsnr = new GridLocalEventListener() {
            @Override public void onEvent(Event evt) {
                ...
                if (evt.type() == EVT_TASK_FINISHED ||
                    ...
                    TurboSQLUuid sesId = ((TaskEvent)evt).taskSessionId();
                ...
                // Here we set mapped property and later cache will be ignored
                    ...
                    TurboSQLUuid sesId = ((JobEvent)evt).taskSessionId();

                    TurboSQLBiTuple<Boolean, WeightedTopology> weightedTop = taskTops.get(sesId);
     ...
     */
    private class WeightedRandomLoadBalancingSpiMBeanImpl extends TurboSQLSpiMBeanAdapter
        implements WeightedRandomLoadBalancingSpiMBean {
        /** {@inheritDoc} */
        WeightedRandomLoadBalancingSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
