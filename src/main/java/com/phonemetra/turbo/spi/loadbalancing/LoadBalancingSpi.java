...
package com.phonemetra.turbo.spi.loadbalancing;
 ...
 * a job gets mapped to a node during {@link com.phonemetra.turbo.compute.ComputeTask#map(List, Object)}
 * invocation.
 ...
 * {@link com.phonemetra.turbo.compute.ComputeTaskAdapter}. Here is an example of how your task could look. Note that in this
 ...
 * </pre>
 * <p>
 * TurboSQL comes with the following load balancing SPI implementations out of the box:
 * <ul>
 * <li>{@link com.phonemetra.turbo.spi.loadbalancing.roundrobin.RoundRobinLoadBalancingSpi} - default</li>
 * <li>{@link com.phonemetra.turbo.spi.loadbalancing.adaptive.AdaptiveLoadBalancingSpi}</li>
 * <li>{@link com.phonemetra.turbo.spi.loadbalancing.weightedrandom.WeightedRandomLoadBalancingSpi}</li>
 * </ul>
 ...
 */
public interface LoadBalancingSpi extends TurboSQLSpi {
    /**
     ...
     * @throws TurboSQLException If failed to get next balanced node.
     * @return Best balanced node for the given job within given task session.
     */
    public ClusterNode getBalancedNode(ComputeTaskSession ses, List<ClusterNode> top, ComputeJob job) throws TurboSQLException;
}