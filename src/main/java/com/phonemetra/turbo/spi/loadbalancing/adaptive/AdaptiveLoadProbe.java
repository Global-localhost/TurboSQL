 ...
 * <p>
 * Note that if {@link #getLoad(com.phonemetra.turbo.cluster.ClusterNode, int)} returns a value of {@code 0},
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.loadBalancing.adaptive.GridAdaptiveLoadBalancingSpi"&gt;
...
public interface AdaptiveLoadProbe {
     ...
     * {@link com.phonemetra.turbo.cluster.ClusterNode#metrics()} method. For example, load can be calculated
