 ...
 * with turboSQL resources. Both, field and method based injection are supported.
...
public interface TurboSQLSpi {
     ...
     * @throws TurboSQLSpiException Throws in case of any error.
     */
    public Map<String, Object> getNodeAttributes() throws TurboSQLSpiException;

    /**
     * This method is called to start SPI. After this method returns
     * successfully kernel assumes that SPI is fully operational.
     *
     * @param turboSQLInstanceName Name of TurboSQL instance this SPI is being started for
     *    ({@code null} for default TurboSQL instance).
     * @throws TurboSQLSpiException Throws in case of any error during SPI start.
     */
    public void spiStart(@Nullable String turboSQLInstanceName) throws TurboSQLSpiException;
     ...
     * @throws TurboSQLSpiException If context initialization failed (grid will be stopped).
     */
    public void onContextInitialized(TurboSQLSpiContext spiCtx) throws TurboSQLSpiException;
     ...
     * <p>
     * If {@link TurboSQLSpiAdapter} is used for SPI implementation, then it will
     ...
     * </b>
     *
     * @throws TurboSQLSpiException Thrown in case of any error during SPI stop.
     */
    public void spiStop() throws TurboSQLSpiException;
     ...
     */
    public void onClientDisconnected(TurboSQLFuture<?> reconnectFut);
