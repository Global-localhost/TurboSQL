...
package com.phonemetra.turbo.spi.encryption;
...
/**
 * SPI provides encryption features for an TurboSQL.
 */
public interface EncryptionSpi extends TurboSQLSpi {
    /**
     ...
     * @throws TurboSQLException If key creation failed.
     */
    Serializable create() throws TurboSQLException;
