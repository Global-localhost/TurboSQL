...
package com.phonemetra.turbo.spi.failover.jobstealing;
...
import static com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi.THIEF_NODE_ATTR;

/**
 * Job stealing failover SPI needs to always be used in conjunction with
 * {@link com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi} SPI. When {@link com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi}
 ...
 * {@link com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi#THIEF_NODE_ATTR} job context attribute (see {@link com.phonemetra.turbo.compute.ComputeJobContext}).
 * Prior to rejecting a job,  {@link com.phonemetra.turbo.spi.collision.jobstealing.JobStealingCollisionSpi} will populate this
 ...
 * SPI behaves identically to {@link com.phonemetra.turbo.spi.failover.always.AlwaysFailoverSpi}, and tries to find the
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.failover.jobstealing.JobStealingFailoverSpi"&gt;
...
public class JobStealingFailoverSpi extends TurboSQLSpiAdapter implements FailoverSpi {
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new JobStealingFailoverSpiMBeanImpl(this), JobStealingFailoverSpiMBean.class);
     ...
     */
    private class JobStealingFailoverSpiMBeanImpl extends TurboSQLSpiMBeanAdapter implements JobStealingFailoverSpiMBean {
        /** {@inheritDoc} */
        public JobStealingFailoverSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
