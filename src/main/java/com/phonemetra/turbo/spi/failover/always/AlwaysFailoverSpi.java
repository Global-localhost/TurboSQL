...
package com.phonemetra.turbo.spi.failover.always;
...
import com.phonemetra.turbo.internal.managers.failover.GridFailoverContextImpl;
 ...
 *     &lt;bean class="com.phonemetra.turbo.spi.failover.always.AlwaysFailoverSpi"&gt;
...
public class AlwaysFailoverSpi extends TurboSQLSpiAdapter implements FailoverSpi {
     ...
     */
    public static final String AFFINITY_CALL_ATTEMPT = "turboSQL:failover:affinitycallattempt";
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new AlwaysFailoverSpiMBeanImpl(this), AlwaysFailoverSpiMBean.class);
    ...
    @Override public ClusterNode failover(FailoverContext ctx, List<ClusterNode> top) {
        ...
        if (ctx.partition() >= 0) {
            ...
            if (maxFailoverAttempts <= affCallAttempt) {
                ...
                try {
                    return ((TurboSQLEx)turboSQL).context().affinity().mapPartitionToNode(ctx.affinityCacheName(), ctx.partition(),
     ...
     */
    private class AlwaysFailoverSpiMBeanImpl extends TurboSQLSpiMBeanAdapter implements AlwaysFailoverSpiMBean {
        /** {@inheritDoc} */
        AlwaysFailoverSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
