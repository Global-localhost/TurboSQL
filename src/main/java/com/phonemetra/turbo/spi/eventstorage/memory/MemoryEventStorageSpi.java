...
package com.phonemetra.turbo.spi.eventstorage.memory;
...
import com.phonemetra.turbo.spi.eventstorage.EventStorageSpi;
import org.jsr166.ConcurrentLinkedDeque8;

import static com.phonemetra.turbo.events.EventType.EVT_NODE_METRICS_UPDATED;

/**
 * In-memory {@link com.phonemetra.turbo.spi.eventstorage.EventStorageSpi} implementation. All events are
 ...
 * <li>{@link #setFilter(com.phonemetra.turbo.lang.TurboSQLPredicate)} - Event filter that should be used for decision to accept event.</li>
 * </ul>
 ...
 *             &lt;bean class="com.phonemetra.turbo.spi.eventStorage.memory.MemoryEventStorageSpi"&gt;
 ...
 * @see com.phonemetra.turbo.spi.eventstorage.EventStorageSpi
 */
@TurboSQLSpiMultipleInstancesSupport(true)
public class MemoryEventStorageSpi extends TurboSQLSpiAdapter implements EventStorageSpi {
     ...
     */
    public TurboSQLPredicate<Event> getFilter() {
        return filter;
    }
    ...
    public MemoryEventStorageSpi setFilter(TurboSQLPredicate<Event> filter) {
        this.filter = filter;
    ...
    @Override public void spiStart(String turboSQLInstanceName) throws TurboSQLSpiException {
        ...
        registerMBean(turboSQLInstanceName, new MemoryEventStorageSpiMBeanImpl(this), MemoryEventStorageSpiMBean.class);
     ...
     */
    private class MemoryEventStorageSpiMBeanImpl extends TurboSQLSpiMBeanAdapter implements MemoryEventStorageSpiMBean {
        /** {@inheritDoc} */
        MemoryEventStorageSpiMBeanImpl(TurboSQLSpiAdapter spiAdapter) {
            super(spiAdapter);
        }
