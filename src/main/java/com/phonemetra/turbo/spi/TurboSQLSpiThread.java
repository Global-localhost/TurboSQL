 ...
 * This class adds necessary plumbing on top of the {@link TurboSQLThread} class:
 * <ul>
 *      <li>Proper exception handling in {@link #body()}</li>
 * </ul>
 */
public abstract class TurboSQLSpiThread extends TurboSQLThread {
    /** Default thread's group. */
    public static final ThreadGroup DFLT_GRP = new ThreadGroup("turboSQL-spi");
     ...
     *
     * @param turboSQLInstanceName Name of grid this thread is created in.
     * @param name Thread's name.
     * @param log Grid logger to use.
     */
    protected TurboSQLSpiThread(String turboSQLInstanceName, String name, TurboSQLLogger log) {
        super(turboSQLInstanceName, DFLT_GRP, createName(cntr.incrementAndGet(), name, turboSQLInstanceName));
    ...
    @Override public String toString() {
        return S.toString(TurboSQLSpiThread.class, this, "name", getName());
    }
}