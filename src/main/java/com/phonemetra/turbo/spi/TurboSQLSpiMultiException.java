 ...
 */
public class TurboSQLSpiMultiException extends TurboSQLSpiException {
    /** */
     ...
     */
    public TurboSQLSpiMultiException(String msg) {
        super(msg);
    }
     ...
     */
    public TurboSQLSpiMultiException(Throwable cause) {
     ...
     */
    public TurboSQLSpiMultiException(String msg, @Nullable Throwable cause) {
        super(msg, cause);
    }
     ...
     */
    public TurboSQLSpiMultiException(String msg, @Nullable Throwable cause, @Nullable Collection<Throwable> nestedCauses) {
        super(msg, cause);
