 ...
 *
 */
public class TurboSQLSpiOperationTimeoutHelper {
     ...
     */
    public TurboSQLSpiOperationTimeoutHelper(TurboSQLSpiAdapter adapter, boolean srvOp) {
     ...
     * @throws TurboSQLSpiOperationTimeoutException If failure detection timeout is reached for an operation that uses
     * this {@code TurboSQLSpiOperationTimeoutController}.
     */
    public long nextTimeoutChunk(long dfltTimeout) throws TurboSQLSpiOperationTimeoutException {
        ...
        if (lastOperStartTs == 0) {
            ...
            if (timeout <= 0)
                throw new TurboSQLSpiOperationTimeoutException("Network operation timed out. Increase " +
    ...
    public boolean checkFailureTimeoutReached(Exception e) {
        ...
        if (X.hasCause(e, TurboSQLSpiOperationTimeoutException.class, SocketTimeoutException.class, SocketException.class))
            return true;
