 ...
 */
public class TurboSQLNodeValidationResult {
    /** Offending node ID. */
     ...
     */
    public TurboSQLNodeValidationResult(UUID nodeId, String msg, String sndMsg) {
        this.nodeId = nodeId;
        this.msg = msg;
        this.sndMsg = sndMsg;
    }
    ...
    @Override public String toString() {
        return S.toString(TurboSQLNodeValidationResult.class, this);
    }
}
