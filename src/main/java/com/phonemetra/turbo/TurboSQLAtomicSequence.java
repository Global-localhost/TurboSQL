 ...
 * <ul>
 *     <li>{@link TurboSQL#atomicSequence(String, long, boolean)}</li>
 * </ul>
 * @see TurboSQL#atomicSequence(String, long, boolean)
 */
public interface TurboSQLAtomicSequence extends Closeable {
    /**
